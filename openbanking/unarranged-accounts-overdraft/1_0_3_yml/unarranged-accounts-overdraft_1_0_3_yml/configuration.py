...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host = "https://api.banco.com.br/open-banking/unarranged-accounts-overdraft/v1"
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("unarranged-accounts-overdraft_1_0_3_yml")
