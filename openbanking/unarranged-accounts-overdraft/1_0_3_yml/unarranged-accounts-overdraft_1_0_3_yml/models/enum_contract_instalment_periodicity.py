...
class EnumContractInstalmentPeriodicity(object):
    ...
    allowed enum values
    """
    SEM_PERIODICIDADE_REGULAR = "SEM_PERIODICIDADE_REGULAR"
    SEMANAL = "SEMANAL"
    QUINZENAL = "QUINZENAL"
    MENSAL = "MENSAL"
    BIMESTRAL = "BIMESTRAL"
    ...
    def __init__(self):  # noqa: E501
        """EnumContractInstalmentPeriodicity - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumContractInstalmentPeriodicity, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumContractInstalmentPeriodicity):
            return False
