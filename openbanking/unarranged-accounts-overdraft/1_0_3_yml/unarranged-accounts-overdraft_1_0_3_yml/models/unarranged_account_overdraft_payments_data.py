...
class UnarrangedAccountOverdraftPaymentsData(object):
    ...
    swagger_types = {
        ...
        'releases': 'list[UnarrangedAccountOverdraftReleases]'
    }
    ...
    def __init__(self, paid_instalments=None, contract_outstanding_balance=None, releases=None):  # noqa: E501
        """UnarrangedAccountOverdraftPaymentsData - a model defined in Swagger"""  # noqa: E501
    ...
    def paid_instalments(self):
        """Gets the paid_instalments of this UnarrangedAccountOverdraftPaymentsData.  # noqa: E501

        Quantidade total de parcelas pagas do contrato referente à Modalidade de Crédito informada.  # noqa: E501

        :return: The paid_instalments of this UnarrangedAccountOverdraftPaymentsData.  # noqa: E501
        :rtype: float
        """
    ...
    def paid_instalments(self, paid_instalments):
        """Sets the paid_instalments of this UnarrangedAccountOverdraftPaymentsData.

        Quantidade total de parcelas pagas do contrato referente à Modalidade de Crédito informada.  # noqa: E501

        :param paid_instalments: The paid_instalments of this UnarrangedAccountOverdraftPaymentsData.  # noqa: E501
        :type: float
        """
    ...
    def contract_outstanding_balance(self):
        """Gets the contract_outstanding_balance of this UnarrangedAccountOverdraftPaymentsData.  # noqa: E501

        Valor necessario para o cliente liquidar a dívida.  # noqa: E501

        :return: The contract_outstanding_balance of this UnarrangedAccountOverdraftPaymentsData.  # noqa: E501
        :rtype: float
        """
    ...
    def contract_outstanding_balance(self, contract_outstanding_balance):
        """Sets the contract_outstanding_balance of this UnarrangedAccountOverdraftPaymentsData.

        Valor necessario para o cliente liquidar a dívida.  # noqa: E501

        :param contract_outstanding_balance: The contract_outstanding_balance of this UnarrangedAccountOverdraftPaymentsData.  # noqa: E501
        :type: float
        """
    ...
    @property
    def releases(self):
        """Gets the releases of this UnarrangedAccountOverdraftPaymentsData.  # noqa: E501

        Lista dos pagamentos realizados no período  # noqa: E501

        :return: The releases of this UnarrangedAccountOverdraftPaymentsData.  # noqa: E501
        :rtype: list[UnarrangedAccountOverdraftReleases]
        """
        return self._releases

    @releases.setter
    def releases(self, releases):
        """Sets the releases of this UnarrangedAccountOverdraftPaymentsData.

        Lista dos pagamentos realizados no período  # noqa: E501

        :param releases: The releases of this UnarrangedAccountOverdraftPaymentsData.  # noqa: E501
        :type: list[UnarrangedAccountOverdraftReleases]
        """
        if releases is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UnarrangedAccountOverdraftPaymentsData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UnarrangedAccountOverdraftPaymentsData):
            return False
