...
**interest_rates** | [**list[UnarrangedAccountOverdraftContractInterestRate]**](UnarrangedAccountOverdraftContractInterestRate.md) | Objeto que traz o conjunto de informações necessárias para demonstrar a composição das taxas de juros remuneratórios da Modalidade de crédito.  | 
**contracted_fees** | [**list[UnarrangedAccountOverdraftContractedFee]**](UnarrangedAccountOverdraftContractedFee.md) | Lista que traz o conjunto de informações necessárias para demonstrar a composição das taxas de juros remuneratórios da Modalidade de crédito | 
