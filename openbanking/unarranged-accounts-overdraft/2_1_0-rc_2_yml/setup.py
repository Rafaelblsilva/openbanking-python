...
NAME = "unarranged-accounts-overdraft-2-1-0-rc-2-yml"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="API Unarranged-accounts-overdraft - Open Finance Brasil",
    author_email="gt-interfaces@openbankingbr.org",
    url="",
    keywords=["Swagger", "API Unarranged-accounts-overdraft - Open Finance Brasil"],
