...
import unarranged-accounts-overdraft_2_1_0-rc_1_yml.models
from unarranged-accounts-overdraft_2_1_0-rc_1_yml import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(unarranged-accounts-overdraft_2_1_0-rc_1_yml.models, klass)
