...
class EnumTypeNumberOfInstalments(object):
    ...
    MES = "MES"
    ANO = "ANO"
    SEM_PRAZO_TOTAL = "SEM_PRAZO_TOTAL"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """EnumTypeNumberOfInstalments - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumTypeNumberOfInstalments, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumTypeNumberOfInstalments):
            return False
