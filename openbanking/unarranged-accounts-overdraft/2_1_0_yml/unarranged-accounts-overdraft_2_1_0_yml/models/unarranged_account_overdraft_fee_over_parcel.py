...
class UnarrangedAccountOverdraftFeeOverParcel(object):
    ...
    def __init__(self, fee_name=None, fee_code=None, fee_amount=None):  # noqa: E501
        """UnarrangedAccountOverdraftFeeOverParcel - a model defined in Swagger"""  # noqa: E501
        self._fee_name = None
        self._fee_code = None
    ...
    @property
    def fee_name(self):
        """Gets the fee_name of this UnarrangedAccountOverdraftFeeOverParcel.  # noqa: E501

        Denominação da Tarifa pactuada.   # noqa: E501

        :return: The fee_name of this UnarrangedAccountOverdraftFeeOverParcel.  # noqa: E501
        :rtype: str
        """
    ...
    def fee_name(self, fee_name):
        """Sets the fee_name of this UnarrangedAccountOverdraftFeeOverParcel.

        Denominação da Tarifa pactuada.   # noqa: E501

        :param fee_name: The fee_name of this UnarrangedAccountOverdraftFeeOverParcel.  # noqa: E501
        :type: str
        """
        if fee_name is None:
    ...
    @property
    def fee_code(self):
        """Gets the fee_code of this UnarrangedAccountOverdraftFeeOverParcel.  # noqa: E501

        Sigla identificadora da tarifa pactuada.   # noqa: E501

        :return: The fee_code of this UnarrangedAccountOverdraftFeeOverParcel.  # noqa: E501
        :rtype: str
        """
    ...
    def fee_code(self, fee_code):
        """Sets the fee_code of this UnarrangedAccountOverdraftFeeOverParcel.

        Sigla identificadora da tarifa pactuada.   # noqa: E501

        :param fee_code: The fee_code of this UnarrangedAccountOverdraftFeeOverParcel.  # noqa: E501
        :type: str
        """
        if fee_code is None:
    ...
    @property
    def fee_amount(self):
        """Gets the fee_amount of this UnarrangedAccountOverdraftFeeOverParcel.  # noqa: E501
        ...
        :return: The fee_amount of this UnarrangedAccountOverdraftFeeOverParcel.  # noqa: E501
        :rtype: str
        """
    ...
    def fee_amount(self, fee_amount):
        """Sets the fee_amount of this UnarrangedAccountOverdraftFeeOverParcel.

        Valor monetário da tarifa pactuada no contrato.  Expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais.   # noqa: E501

        :param fee_amount: The fee_amount of this UnarrangedAccountOverdraftFeeOverParcel.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UnarrangedAccountOverdraftFeeOverParcel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UnarrangedAccountOverdraftFeeOverParcel):
            return False
