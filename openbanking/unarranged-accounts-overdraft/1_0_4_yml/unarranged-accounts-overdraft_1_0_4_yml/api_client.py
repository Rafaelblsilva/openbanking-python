...
import unarranged-accounts-overdraft_1_0_4_yml.models
from unarranged-accounts-overdraft_1_0_4_yml import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(unarranged-accounts-overdraft_1_0_4_yml.models, klass)
