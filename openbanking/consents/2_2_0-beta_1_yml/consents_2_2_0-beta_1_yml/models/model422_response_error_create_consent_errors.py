...
class Model422ResponseErrorCreateConsentErrors(object):
    ...
    def code(self):
        ...
        Códigos de erros previstos na durante o processo de extensão do consentimento:    • DEPENDE_MULTIPLA_ALCADA: Necessário aprovação de múltipla alçada.    • REFRESH_TOKEN_JWT: Refresh token não pode ser expandido.    • ESTADO_CONSENTIMENTO_INVALIDO: Estado inválido do consentimento.     # noqa: E501
    ...
    def code(self, code):
        ...
        allowed_values = ["DEPENDE_MULTIPLA_ALCADA", "REFRESH_TOKEN_JWT", "ESTADO_CONSENTIMENTO_INVALIDO"]  # noqa: E501
    ...
    def title(self):
        ...
        Título específico do erro reportado, de acordo com o código enviado:   • DEPENDE_MULTIPLA_ALCADA: Necessário aprovação de múltipla alçada.   • REFRESH_TOKEN_JWT: Refresh token não pode ser expandido.   • ESTADO_CONSENTIMENTO_INVALIDO: Estado inválido do consentimento.     # noqa: E501
