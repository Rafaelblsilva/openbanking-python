...
from consents_2_2_0-beta_1_yml.configuration import Configuration
import consents_2_2_0-beta_1_yml.models
from consents_2_2_0-beta_1_yml import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(consents_2_2_0-beta_1_yml.models, klass)
