...
from consents_2_0_0_yml.configuration import Configuration
import consents_2_0_0_yml.models
from consents_2_0_0_yml import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(consents_2_0_0_yml.models, klass)
