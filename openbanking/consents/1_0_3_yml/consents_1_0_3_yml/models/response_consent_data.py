...
class ResponseConsentData(object):
    ...
    def __init__(self, consent_id=None, creation_date_time=None, status=None, status_update_date_time=None, permissions=None, expiration_date_time=None, transaction_from_date_time=None, transaction_to_date_time=None):  # noqa: E501
        """ResponseConsentData - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def consent_id(self):
        """Gets the consent_id of this ResponseConsentData.  # noqa: E501
        ...
        :return: The consent_id of this ResponseConsentData.  # noqa: E501
        :rtype: str
        """
    ...
    def consent_id(self, consent_id):
        """Sets the consent_id of this ResponseConsentData.

        O consentId é o identificador único do consentimento e deverá ser um URN - Uniform Resource Name.   Um URN, conforme definido na [RFC8141](https://tools.ietf.org/html/rfc8141) é um Uniform Resource  Identifier - URI - que é atribuído sob o URI scheme \"urn\" e um namespace URN específico, com a intenção de que o URN  seja um identificador de recurso persistente e independente da localização.   Considerando a string urn:bancoex:C1DD33123 como exemplo para consentId temos: - o namespace(urn) - o identificador associado ao namespace da instituição transnmissora (bancoex)  - o identificador específico dentro do namespace (C1DD33123).   Informações mais detalhadas sobre a construção de namespaces devem ser consultadas na [RFC8141](https://tools.ietf.org/html/rfc8141).   # noqa: E501

        :param consent_id: The consent_id of this ResponseConsentData.  # noqa: E501
        :type: str
        """
    ...
    def creation_date_time(self):
        """Gets the creation_date_time of this ResponseConsentData.  # noqa: E501
        ...
        :return: The creation_date_time of this ResponseConsentData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def creation_date_time(self, creation_date_time):
        """Sets the creation_date_time of this ResponseConsentData.

        Data e hora em que o recurso foi criado. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).  # noqa: E501

        :param creation_date_time: The creation_date_time of this ResponseConsentData.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def status(self):
        """Gets the status of this ResponseConsentData.  # noqa: E501

        Estado atual do consentimento cadastrado.  # noqa: E501

        :return: The status of this ResponseConsentData.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ResponseConsentData.

        Estado atual do consentimento cadastrado.  # noqa: E501

        :param status: The status of this ResponseConsentData.  # noqa: E501
        :type: str
        """
        if status is None:
    ...
    def status_update_date_time(self):
        """Gets the status_update_date_time of this ResponseConsentData.  # noqa: E501
        ...
        :return: The status_update_date_time of this ResponseConsentData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def status_update_date_time(self, status_update_date_time):
        """Sets the status_update_date_time of this ResponseConsentData.

        Data e hora em que o recurso foi atualizado. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).  # noqa: E501

        :param status_update_date_time: The status_update_date_time of this ResponseConsentData.  # noqa: E501
        :type: datetime
        """
    ...
    def permissions(self):
        """Gets the permissions of this ResponseConsentData.  # noqa: E501

        Especifica os tipos de permissões de acesso às APIs no escopo do Open Banking Brasil - Fase 2, de acordo com os blocos de consentimento fornecidos pelo usuário e necessários ao acesso a cada endpoint das APIs.  # noqa: E501

        :return: The permissions of this ResponseConsentData.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def permissions(self, permissions):
        """Sets the permissions of this ResponseConsentData.

        Especifica os tipos de permissões de acesso às APIs no escopo do Open Banking Brasil - Fase 2, de acordo com os blocos de consentimento fornecidos pelo usuário e necessários ao acesso a cada endpoint das APIs.  # noqa: E501

        :param permissions: The permissions of this ResponseConsentData.  # noqa: E501
        :type: list[str]
        """
    ...
    def expiration_date_time(self):
        """Gets the expiration_date_time of this ResponseConsentData.  # noqa: E501
        ...
        :return: The expiration_date_time of this ResponseConsentData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def expiration_date_time(self, expiration_date_time):
        """Sets the expiration_date_time of this ResponseConsentData.

        Data e hora de expiração da permissão. De preenchimento obrigatório, reflete a data limite de validade do consentimento. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).  # noqa: E501

        :param expiration_date_time: The expiration_date_time of this ResponseConsentData.  # noqa: E501
        :type: datetime
        """
    ...
    def transaction_from_date_time(self):
        """Gets the transaction_from_date_time of this ResponseConsentData.  # noqa: E501

        Data e hora da transação inicial. Se não for preenchido, a transação terá a data aberta e a data será retornada com a primeira transação disponível. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).  # noqa: E501

        :return: The transaction_from_date_time of this ResponseConsentData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def transaction_from_date_time(self, transaction_from_date_time):
        """Sets the transaction_from_date_time of this ResponseConsentData.

        Data e hora da transação inicial. Se não for preenchido, a transação terá a data aberta e a data será retornada com a primeira transação disponível. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).  # noqa: E501

        :param transaction_from_date_time: The transaction_from_date_time of this ResponseConsentData.  # noqa: E501
        :type: datetime
        """
    ...
    def transaction_to_date_time(self):
        """Gets the transaction_to_date_time of this ResponseConsentData.  # noqa: E501

        Data e hora final da transação. Se não for preenchido, a transação terá a data aberta e a data será retornada com a ultima transação disponível. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).  # noqa: E501

        :return: The transaction_to_date_time of this ResponseConsentData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def transaction_to_date_time(self, transaction_to_date_time):
        """Sets the transaction_to_date_time of this ResponseConsentData.

        Data e hora final da transação. Se não for preenchido, a transação terá a data aberta e a data será retornada com a ultima transação disponível. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).  # noqa: E501

        :param transaction_to_date_time: The transaction_to_date_time of this ResponseConsentData.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseConsentData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseConsentData):
            return False
