...
from consents_1_0_3_yml.configuration import Configuration
import consents_1_0_3_yml.models
from consents_1_0_3_yml import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(consents_1_0_3_yml.models, klass)
