...
class ResponseConsentReadExtendsData(object):
    ...
    def __init__(self, expiration_date_time=None, logged_user=None, request_date_time=None):  # noqa: E501
        """ResponseConsentReadExtendsData - a model defined in Swagger"""  # noqa: E501
    ...
    def expiration_date_time(self):
        """Gets the expiration_date_time of this ResponseConsentReadExtendsData.  # noqa: E501

        Data e hora de expiração da permissão. De preenchimento obrigatório, reflete a data limite de validade do consentimento. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format), utilizado apenas para consulta de alterações históricas de extensão do consentimento.  # noqa: E501

        :return: The expiration_date_time of this ResponseConsentReadExtendsData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def expiration_date_time(self, expiration_date_time):
        """Sets the expiration_date_time of this ResponseConsentReadExtendsData.

        Data e hora de expiração da permissão. De preenchimento obrigatório, reflete a data limite de validade do consentimento. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format), utilizado apenas para consulta de alterações históricas de extensão do consentimento.  # noqa: E501

        :param expiration_date_time: The expiration_date_time of this ResponseConsentReadExtendsData.  # noqa: E501
        :type: datetime
        """
    ...
    def logged_user(self):
        """Gets the logged_user of this ResponseConsentReadExtendsData.  # noqa: E501


        :return: The logged_user of this ResponseConsentReadExtendsData.  # noqa: E501
        :rtype: LoggedUserExtends
        """
        return self._logged_user

    @logged_user.setter
    def logged_user(self, logged_user):
        """Sets the logged_user of this ResponseConsentReadExtendsData.


        :param logged_user: The logged_user of this ResponseConsentReadExtendsData.  # noqa: E501
        :type: LoggedUserExtends
        """
    ...
    def request_date_time(self):
        """Gets the request_date_time of this ResponseConsentReadExtendsData.  # noqa: E501
        ...
        :return: The request_date_time of this ResponseConsentReadExtendsData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def request_date_time(self, request_date_time):
        """Sets the request_date_time of this ResponseConsentReadExtendsData.

        Data e hora em que o recurso foi criado. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).  # noqa: E501

        :param request_date_time: The request_date_time of this ResponseConsentReadExtendsData.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseConsentReadExtendsData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseConsentReadExtendsData):
            return False
