...
class BusinessEntityExtends(object):
    ...
    def __init__(self, document=None):  # noqa: E501
        """BusinessEntityExtends - a model defined in Swagger"""  # noqa: E501
        self._document = None
    ...
    @property
    def document(self):
        """Gets the document of this BusinessEntityExtends.  # noqa: E501


        :return: The document of this BusinessEntityExtends.  # noqa: E501
    ...
    def document(self, document):
        """Sets the document of this BusinessEntityExtends.


        :param document: The document of this BusinessEntityExtends.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BusinessEntityExtends, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BusinessEntityExtends):
            return False
