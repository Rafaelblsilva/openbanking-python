...
class LoggedUserExtends(object):
    ...
    def __init__(self, document=None):  # noqa: E501
        """LoggedUserExtends - a model defined in Swagger"""  # noqa: E501
        self._document = None
    ...
    @property
    def document(self):
        """Gets the document of this LoggedUserExtends.  # noqa: E501


        :return: The document of this LoggedUserExtends.  # noqa: E501
    ...
    def document(self, document):
        """Sets the document of this LoggedUserExtends.


        :param document: The document of this LoggedUserExtends.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LoggedUserExtends, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoggedUserExtends):
            return False
