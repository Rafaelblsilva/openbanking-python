...
class InlineResponse529Errors(object):
    ...
    def __init__(self, code=None, title=None, detail=None):  # noqa: E501
        """InlineResponse529Errors - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._title = None
        self._detail = None
    ...
    @property
    def code(self):
        """Gets the code of this InlineResponse529Errors.  # noqa: E501

        Código de erro específico do endpoint  # noqa: E501

        :return: The code of this InlineResponse529Errors.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this InlineResponse529Errors.

        Código de erro específico do endpoint  # noqa: E501

        :param code: The code of this InlineResponse529Errors.  # noqa: E501
        :type: str
        """
        if code is None:
    ...
    @property
    def title(self):
        """Gets the title of this InlineResponse529Errors.  # noqa: E501

        Título legível por humanos deste erro específico  # noqa: E501

        :return: The title of this InlineResponse529Errors.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this InlineResponse529Errors.

        Título legível por humanos deste erro específico  # noqa: E501

        :param title: The title of this InlineResponse529Errors.  # noqa: E501
        :type: str
        """
        if title is None:
    ...
    @property
    def detail(self):
        """Gets the detail of this InlineResponse529Errors.  # noqa: E501

        Descrição legível por humanos deste erro específico  # noqa: E501

        :return: The detail of this InlineResponse529Errors.  # noqa: E501
        :rtype: str
        """
        return self._detail
    ...
    def detail(self, detail):
        """Sets the detail of this InlineResponse529Errors.

        Descrição legível por humanos deste erro específico  # noqa: E501

        :param detail: The detail of this InlineResponse529Errors.  # noqa: E501
        :type: str
        """
        if detail is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse529Errors, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse529Errors):
            return False
