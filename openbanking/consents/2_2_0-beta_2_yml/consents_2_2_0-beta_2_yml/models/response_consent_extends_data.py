...
"""
    ...
    OpenAPI spec version: 2.2.0-beta.2
...
class ResponseConsentExtendsData(object):
    ...
    def __init__(self, consent_id=None, creation_date_time=None, status=None, status_update_date_time=None, permissions=None, expiration_date_time=None):  # noqa: E501
        """ResponseConsentExtendsData - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def consent_id(self):
        """Gets the consent_id of this ResponseConsentExtendsData.  # noqa: E501
        ...
        :return: The consent_id of this ResponseConsentExtendsData.  # noqa: E501
        :rtype: str
        """
    ...
    def consent_id(self, consent_id):
        """Sets the consent_id of this ResponseConsentExtendsData.

        O consentId é o identificador único do consentimento e deverá ser um URN - Uniform Resource Name.   Um URN, conforme definido na [RFC8141](https://tools.ietf.org/html/rfc8141) é um Uniform Resource  Identifier - URI - que é atribuído sob o URI scheme \"urn\" e um namespace URN específico, com a intenção de que o URN  seja um identificador de recurso persistente e independente da localização.   Considerando a string urn:bancoex:C1DD33123 como exemplo para consentId temos: - o namespace(urn) - o identificador associado ao namespace da instituição transnmissora (bancoex)  - o identificador específico dentro do namespace (C1DD33123).   Informações mais detalhadas sobre a construção de namespaces devem ser consultadas na [RFC8141](https://tools.ietf.org/html/rfc8141).     # noqa: E501

        :param consent_id: The consent_id of this ResponseConsentExtendsData.  # noqa: E501
        :type: str
        """
    ...
    def creation_date_time(self):
        """Gets the creation_date_time of this ResponseConsentExtendsData.  # noqa: E501
        ...
        :return: The creation_date_time of this ResponseConsentExtendsData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def creation_date_time(self, creation_date_time):
        """Sets the creation_date_time of this ResponseConsentExtendsData.

        Data e hora em que o recurso foi criado. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).  # noqa: E501

        :param creation_date_time: The creation_date_time of this ResponseConsentExtendsData.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def status(self):
        """Gets the status of this ResponseConsentExtendsData.  # noqa: E501

        Estado atual do consentimento cadastrado.  # noqa: E501

        :return: The status of this ResponseConsentExtendsData.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ResponseConsentExtendsData.

        Estado atual do consentimento cadastrado.  # noqa: E501

        :param status: The status of this ResponseConsentExtendsData.  # noqa: E501
        :type: str
        """
        if status is None:
    ...
    def status_update_date_time(self):
        """Gets the status_update_date_time of this ResponseConsentExtendsData.  # noqa: E501
        ...
        :return: The status_update_date_time of this ResponseConsentExtendsData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def status_update_date_time(self, status_update_date_time):
        """Sets the status_update_date_time of this ResponseConsentExtendsData.

        Data e hora em que o recurso foi atualizado. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).  # noqa: E501

        :param status_update_date_time: The status_update_date_time of this ResponseConsentExtendsData.  # noqa: E501
        :type: datetime
        """
    ...
    def permissions(self):
        """Gets the permissions of this ResponseConsentExtendsData.  # noqa: E501
        ...
        :return: The permissions of this ResponseConsentExtendsData.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def permissions(self, permissions):
        """Sets the permissions of this ResponseConsentExtendsData.

        Especifica os tipos de permissões de acesso às APIs no escopo do Open Finance Brasil - Dados cadastrais e transacionais, de acordo com os blocos de consentimento fornecidos pelo usuário e necessários ao acesso a cada endpoint das APIs. Esse array não deve ter duplicidade de itens.  # noqa: E501

        :param permissions: The permissions of this ResponseConsentExtendsData.  # noqa: E501
        :type: list[str]
        """
    ...
    def expiration_date_time(self):
        """Gets the expiration_date_time of this ResponseConsentExtendsData.  # noqa: E501
        ...
        :return: The expiration_date_time of this ResponseConsentExtendsData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def expiration_date_time(self, expiration_date_time):
        """Sets the expiration_date_time of this ResponseConsentExtendsData.

        Data e hora de expiração da permissão. Deve ser preenchido caso o consentimento tenha data limite de validade. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).  [Restrição] Aceitar apenas data no futuro em relação à data de requisição.   # noqa: E501

        :param expiration_date_time: The expiration_date_time of this ResponseConsentExtendsData.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseConsentExtendsData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseConsentExtendsData):
            return False
