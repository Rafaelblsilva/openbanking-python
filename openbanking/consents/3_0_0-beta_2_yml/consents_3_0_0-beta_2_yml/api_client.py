...
from consents_3_0_0-beta_2_yml.configuration import Configuration
import consents_3_0_0-beta_2_yml.models
from consents_3_0_0-beta_2_yml import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(consents_3_0_0-beta_2_yml.models, klass)
