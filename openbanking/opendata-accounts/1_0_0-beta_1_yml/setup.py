...
NAME = "opendata-accounts-1-0-0-beta-1-yml"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="API OpenData Accounts do Open Finance Brasil",
    author_email="",
    url="",
    keywords=["Swagger", "API OpenData Accounts do Open Finance Brasil"],
