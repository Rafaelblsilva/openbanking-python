...
class LoanInterestRate(InterestRateFee):
    ...
    def applications(self):
        ...
        Lista  das faixas de cobrança da Taxa Nominal Mensal aplicada pela contratação de crédito  # noqa: E501
    ...
    def minimum_rate(self):
        ...
        Percentual mínimo cobrado (Taxa Nominal Mensal) no mês de referência, para o Empréstimo contratado  A apuração pode acontecer com até 4 casas decimais. O preenchimento deve respeitar as 4 casas decimais, mesmo que venham preenchidas com zeros (representação de porcentagem p.ex: 0.1500. Este valor representa 15%. O valor 1 representa 100%)  # noqa: E501
    ...
    def maximum_rate(self):
        ...
        Percentual máximo cobrado (Taxa Nominal Mensal) no mês de referência, para o Empréstimo contratado  A apuração pode acontecer com até 4 casas decimais. O preenchimento deve respeitar as 4 casas decimais, mesmo que venham preenchidas com zeros (representação de porcentagem p.ex: 0.1500. Este valor representa 15%. O valor 1 representa 100%)  # noqa: E501
