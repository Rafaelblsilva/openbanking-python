# BusinessCreditCardResponseDataBrandCompanies

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**name** | **str** | Nome da Instituição, pertencente à marca, responsável pela comercialização dos produtos e serviços | 
**cnpj_number** | **str** | O CNPJ corresponde ao número de inscrição no Cadastro de Pessoa Jurídica. | 
...
**business_credit_cards** | [**list[BusinessCreditCardResponseDataBrandBusinessCreditCards]**](BusinessCreditCardResponseDataBrandBusinessCreditCards.md) |  | [optional] 
