...
class BusinessFinancingBrand(object):
    ...
    @property
    def name(self):
        """Gets the name of this BusinessFinancingBrand.  # noqa: E501

        Nome da marca.  # noqa: E501

        :return: The name of this BusinessFinancingBrand.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this BusinessFinancingBrand.

        Nome da marca.  # noqa: E501

        :param name: The name of this BusinessFinancingBrand.  # noqa: E501
        :type: str
        """
        if name is None:
