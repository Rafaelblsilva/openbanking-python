...
class CreditCardService(object):
    ...
    def name(self):
        ...
        Denominação de Serviços relacionados à Modalidade de Contas de Pagmento Pós-Pagas, para pessoa jurídica (Campo Livre)  # noqa: E501
    ...
    def code(self):
        ...
        Sigla de identificação do Serviço relacionado à Modalidade de Contas de Pagamento Pós-Pagas para pessoa jurídica informada (Campo Livre)  # noqa: E501
