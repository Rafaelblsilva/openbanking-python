...
class AccountsTermsConditions(object):
    ...
    """
    swagger_types = {
        'minimum_balance': 'AccountsTermsConditionsMinimumBalance',
    ...
    def minimum_balance(self):
        ...
        :rtype: AccountsTermsConditionsMinimumBalance
        """
    ...
    def minimum_balance(self, minimum_balance):
        ...
        :type: AccountsTermsConditionsMinimumBalance
        """
    ...
    def elegibility_criteria_info(self):
        ...
        Critérios de qualificação do cliente com a finalidade de definir sua elegibilidade para a aquisição do tipo de conta. Possibilidade de inscrição da URL. Endereço eletrônico de acesso ao canal. URLs são limitadas a 2048 caracteres mas, para o contexto do Sistema Financeiro aberto, será adotado a metade deste tamanho.  # noqa: E501
    ...
    def closing_process_info(self):
        ...
        Procedimentos de encerramento para o tipo de conta tratado. Possibilidade de inscrição da URL. Endereço eletrônico de acesso ao canal. URLs são limitadas a 2048 caracteres mas, para o contexto do Sistema Financeiro aberto, será adotado a metade deste tamanho.  # noqa: E501
