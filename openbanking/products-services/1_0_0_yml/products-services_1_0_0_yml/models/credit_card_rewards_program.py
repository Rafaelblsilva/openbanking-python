...
class CreditCardRewardsProgram(object):
    ...
    def has_reward_program(self):
        ...
        Indicador da existência de programa de fidelidade/recompensa associado à conta  # noqa: E501
    ...
    def reward_program_info(self):
        ...
        Informações de termos e condições do programa de fidelidade/recompensa. Pode ser informada a URL referente ao endereço onde constam as condições informadas  # noqa: E501
