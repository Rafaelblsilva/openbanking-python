...
class PersonalFinancingCompany(CNPJ):
    ...
    def __init__(self, name=None, url_complementary_list=None, personal_financings=None, *args, **kwargs):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this PersonalFinancingCompany.  # noqa: E501

        Nome da Instituição, pertencente à marca, responsável pela comercialização dos produtos e serviços  # noqa: E501

        :return: The name of this PersonalFinancingCompany.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PersonalFinancingCompany.

        Nome da Instituição, pertencente à marca, responsável pela comercialização dos produtos e serviços  # noqa: E501

        :param name: The name of this PersonalFinancingCompany.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def url_complementary_list(self):
        """Gets the url_complementary_list of this PersonalFinancingCompany.  # noqa: E501
        ...
        :return: The url_complementary_list of this PersonalFinancingCompany.  # noqa: E501
        :rtype: str
        """
    ...
    def url_complementary_list(self, url_complementary_list):
        """Sets the url_complementary_list of this PersonalFinancingCompany.

        URL do link que conterá a lista complementar com os nomes e CNPJs agrupados sob o mesmo cnpjNumber. Os contidos nessa lista possuem as mesmas características para produtos e serviços. Endereço eletrônico de acesso ao canal.  # noqa: E501

        :param url_complementary_list: The url_complementary_list of this PersonalFinancingCompany.  # noqa: E501
        :type: str
        """
