...
class PersonalFinancing(object):
    ...
    swagger_types = {
        'type': 'str',
        'fees': 'list[PersonalFinancingFee]',
    ...
    def fees(self):
        ...
        :rtype: list[PersonalFinancingFee]
        """
        return self._fees
    ...
    def fees(self, fees):
        ...
        :type: list[PersonalFinancingFee]
        """
        if fees is None:
