...
class CreditCardIndentificationProduct(object):
    ...
    def __init__(self, type=None, additional_info=None):  # noqa: E501
        """CreditCardIndentificationProduct - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this CreditCardIndentificationProduct.  # noqa: E501
        ...
        :return: The type of this CreditCardIndentificationProduct.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CreditCardIndentificationProduct.

        Categoria atribuída a um cartão de pagamento, sob uma certa denominação, que lhe agrega um conjunto de vantagens, diferenciando-o de acordo com o perfil do portador. Essa categoria é definida pelo BACEN e está contida no documento de nome 'Elaboração e Remessa de Informações Relativas aos Cartões de Pagamento  Emissores'  # noqa: E501

        :param type: The type of this CreditCardIndentificationProduct.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def additional_info(self):
        """Gets the additional_info of this CreditCardIndentificationProduct.  # noqa: E501

        Informações complementares se tipo de Cartão 'OUTROS'  # noqa: E501

        :return: The additional_info of this CreditCardIndentificationProduct.  # noqa: E501
        :rtype: str
        """
    ...
    def additional_info(self, additional_info):
        """Sets the additional_info of this CreditCardIndentificationProduct.

        Informações complementares se tipo de Cartão 'OUTROS'  # noqa: E501

        :param additional_info: The additional_info of this CreditCardIndentificationProduct.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreditCardIndentificationProduct, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreditCardIndentificationProduct):
            return False
