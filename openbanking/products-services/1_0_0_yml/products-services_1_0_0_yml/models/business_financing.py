...
class BusinessFinancing(object):
    ...
    swagger_types = {
        'type': 'str',
        'fees': 'list[BusinessFinancingFee]',
    ...
    def __init__(self, type=None, fees=None, interest_rate=None, required_warranties=None, terms_conditions=None):  # noqa: E501
        """BusinessFinancing - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._fees = None
    ...
    @property
    def type(self):
        """Gets the type of this BusinessFinancing.  # noqa: E501
        ...
        :return: The type of this BusinessFinancing.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this BusinessFinancing.

        Modalidades de financiamentos ofertados para pessoas jurídicas, conforme Circular 4015-Bacen. Segundo cartilha do Bacen: Financiamento é um contrato entre o cliente e uma instituição financeira, mas com, destinação específica como para a aquisição de veículo ou de bem imóvel, que funcionam como garantia para o crédito concedido  # noqa: E501

        :param type: The type of this BusinessFinancing.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["FINANCIAMENTO_AQUISICAO_BENS_VEICULOS_AUTOMOTORES", "FINANCIAMENTO_AQUISICAO_BENS_OUTROS_BENS", "FINANCIAMENTO_MICROCREDITO", "FINANCIAMENTO_RURAL_CUSTEIO", "FINANCIAMENTO_RURAL_INVESTIMENTO", "FINANCIAMENTO_RURAL_COMERCIALIZACAO", "FINANCIAMENTO_RURAL_INDUSTRIALIZACAO", "FINANCIAMENTO_IMOBILIARIO_SISTEMA_FINANCIERO_HABILITACAO_SFH", "FINANCIAMENTO_IMOBILIARIO_SISTEMA_FINANCIERO_HABILITACAO_SFI"]  # noqa: E501
    ...
    @property
    def fees(self):
        """Gets the fees of this BusinessFinancing.  # noqa: E501


        :return: The fees of this BusinessFinancing.  # noqa: E501
        :rtype: list[BusinessFinancingFee]
        """
        return self._fees

    @fees.setter
    def fees(self, fees):
        """Sets the fees of this BusinessFinancing.


        :param fees: The fees of this BusinessFinancing.  # noqa: E501
        :type: list[BusinessFinancingFee]
        """
        if fees is None:
    ...
    def interest_rate(self):
        """Gets the interest_rate of this BusinessFinancing.  # noqa: E501


        :return: The interest_rate of this BusinessFinancing.  # noqa: E501
    ...
    def interest_rate(self, interest_rate):
        """Sets the interest_rate of this BusinessFinancing.


        :param interest_rate: The interest_rate of this BusinessFinancing.  # noqa: E501
    ...
    def required_warranties(self):
        """Gets the required_warranties of this BusinessFinancing.  # noqa: E501


        :return: The required_warranties of this BusinessFinancing.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def required_warranties(self, required_warranties):
        """Sets the required_warranties of this BusinessFinancing.


        :param required_warranties: The required_warranties of this BusinessFinancing.  # noqa: E501
        :type: list[str]
        """
    ...
    def terms_conditions(self):
        """Gets the terms_conditions of this BusinessFinancing.  # noqa: E501
        ...
        :return: The terms_conditions of this BusinessFinancing.  # noqa: E501
        :rtype: str
        """
    ...
    def terms_conditions(self, terms_conditions):
        """Sets the terms_conditions of this BusinessFinancing.

        Campo aberto para informar as condições contratuais relativas ao produto ou serviço informado. Pode ser informada a URL referente ao endereço onde constam as condições informadas.  # noqa: E501

        :param terms_conditions: The terms_conditions of this BusinessFinancing.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BusinessFinancing, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BusinessFinancing):
            return False
