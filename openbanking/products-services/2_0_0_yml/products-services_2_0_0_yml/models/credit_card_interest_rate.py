...
import six
from products-services_2_0_0_yml.models.interest_rate import InterestRate  # noqa: F401,E501

class CreditCardInterestRate(InterestRate):
    ...
    if hasattr(InterestRate, "swagger_types"):
        swagger_types.update(InterestRate.swagger_types)

    attribute_map = {
        'code': 'code',
        'additional_info': 'additionalInfo'
    }
    if hasattr(InterestRate, "attribute_map"):
        attribute_map.update(InterestRate.attribute_map)

    def __init__(self, code=None, additional_info=None, *args, **kwargs):  # noqa: E501
        ...
        InterestRate.__init__(self, *args, **kwargs)
