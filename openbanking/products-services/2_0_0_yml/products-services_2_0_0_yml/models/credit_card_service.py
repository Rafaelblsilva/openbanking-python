...
class CreditCardService(object):
    ...
    def name(self, name):
        ...
        allowed_values = ["ANUIDADE_CARTAO_BASICO_NACIONAL", "ANUIDADE_CARTAO_BASICO_INTERNACIONAL", "UTILIZACAO_CANAIS_ATENDIMENTO_RETIRADA_ESPECIE_BRASIL", "UTILIZACAO_CANAIS_ATENDIMENTO_RETIRADA_ESPECIE_EXTERIOR", "AVALIACAO_EMERGENCIAL_CREDITO", "FORNECIMENTO_SEGUNDA_VIA_FUNCAO_CREDITO", "PAGAMENTO_CONTAS_UTILIZANDO_FUNCAO_CREDITO", "SMS"]  # noqa: E501
    ...
    def code(self, code):
        ...
        allowed_values = ["ANUIDADE_NACIONAL", "ANUIDADE_INTERNACIONAL", "SAQUE_CARTAO_BRASIL", "SAQUE_CARTAO_EXTERIOR", "AVALIACAO_EMERGENCIAL_CREDITO", "EMISSAO_SEGUNDA_VIA", "TARIFA_PAGAMENTO_CONTAS", "SMS"]  # noqa: E501
