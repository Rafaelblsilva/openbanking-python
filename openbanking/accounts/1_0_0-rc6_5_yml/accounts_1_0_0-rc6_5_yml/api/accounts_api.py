...
from accounts_1_0_0-rc6_5_yml.api_client import ApiClient
...
class AccountsApi(object):
    ...
    def get_accounts(self, authorization, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_accounts(authorization, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_accounts_with_http_info(authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.get_accounts_with_http_info(authorization, **kwargs)  # noqa: E501
            return data

    def get_accounts_with_http_info(self, authorization, **kwargs):  # noqa: E501
        """Obtém a lista de contas consentidas pelo cliente.  # noqa: E501

        Método para obter a lista de contas depósito à vista, poupança e pagamento pré-pagas mantidas pelo cliente na instituição transmissora e para as quais ele tenha fornecido consentimento.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounts_with_http_info(authorization, async_req=True)
        >>> result = thread.get()
        ...
        if ('authorization' not in params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `get_accounts`")  # noqa: E501
    ...
    def get_accounts_account_id(self, authorization, account_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounts_account_id(authorization, account_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_accounts_account_id_with_http_info(authorization, account_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_accounts_account_id_with_http_info(authorization, account_id, **kwargs)  # noqa: E501
            return data

    def get_accounts_account_id_with_http_info(self, authorization, account_id, **kwargs):  # noqa: E501
        """Obtém os dados de identificação da conta identificada por accountId.  # noqa: E501

        Método para obter os dados de identificação da conta de depósito à vista, poupança ou pagamento pré-paga identificada por accountId mantida pelo cliente na instituição transmissora.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounts_account_id_with_http_info(authorization, account_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_accounts_account_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `get_accounts_account_id`")  # noqa: E501
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params or
                params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `get_accounts_account_id`")  # noqa: E501
    ...
    def get_accounts_account_id_balances(self, authorization, account_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounts_account_id_balances(authorization, account_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_accounts_account_id_balances_with_http_info(authorization, account_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_accounts_account_id_balances_with_http_info(authorization, account_id, **kwargs)  # noqa: E501
            return data

    def get_accounts_account_id_balances_with_http_info(self, authorization, account_id, **kwargs):  # noqa: E501
        """Obtém os saldos da conta identificada por accountId.  # noqa: E501

        Método para obter os saldos da conta de depósito à vista, poupança ou pagamento pré-paga identificada por accountId mantida pelo cliente na instituição transmissora.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounts_account_id_balances_with_http_info(authorization, account_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_accounts_account_id_balances" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `get_accounts_account_id_balances`")  # noqa: E501
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params or
                params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `get_accounts_account_id_balances`")  # noqa: E501
    ...
    def get_accounts_account_id_overdraft_limits(self, authorization, account_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounts_account_id_overdraft_limits(authorization, account_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_accounts_account_id_overdraft_limits_with_http_info(authorization, account_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_accounts_account_id_overdraft_limits_with_http_info(authorization, account_id, **kwargs)  # noqa: E501
            return data

    def get_accounts_account_id_overdraft_limits_with_http_info(self, authorization, account_id, **kwargs):  # noqa: E501
        """Obtém os limites da conta identificada por accountId.  # noqa: E501

        Método para obter os limites da conta de depósito à vista, poupança ou pagamento pré-paga identificada por accountId mantida pelo cliente na instituição transmissora.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounts_account_id_overdraft_limits_with_http_info(authorization, account_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_accounts_account_id_overdraft_limits" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `get_accounts_account_id_overdraft_limits`")  # noqa: E501
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params or
                params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `get_accounts_account_id_overdraft_limits`")  # noqa: E501
    ...
    def get_accounts_account_id_transactions(self, authorization, account_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounts_account_id_transactions(authorization, account_id, async_req=True)
        >>> result = thread.get()
        ...
        :param int page: Número da página que está sendo requisitada (o valor da primeira página é 1).
        :param int page_size: Quantidade total de registros por páginas.
        :param date from_booking_date: Data inicial de filtragem.
        :param date to_booking_date: Data final de filtragem.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_accounts_account_id_transactions_with_http_info(authorization, account_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_accounts_account_id_transactions_with_http_info(authorization, account_id, **kwargs)  # noqa: E501
            return data

    def get_accounts_account_id_transactions_with_http_info(self, authorization, account_id, **kwargs):  # noqa: E501
        """Obtém a lista de transações da conta identificada por accountId.  # noqa: E501

        Método para obter a lista de transações da conta de depósito à vista, poupança ou pagamento pré-paga identificada por accountId mantida pelo cliente na instituição transmissora.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounts_account_id_transactions_with_http_info(authorization, account_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_accounts_account_id_transactions" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `get_accounts_account_id_transactions`")  # noqa: E501
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params or
                params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `get_accounts_account_id_transactions`")  # noqa: E501
