...
from resources_3_0_0-beta_1_yml.api_client import ApiClient
...
class ResourcesApi(object):
    ...
    def resources_get_resources(self, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.resources_get_resources(authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.resources_get_resources_with_http_info(authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
        else:
            (data) = self.resources_get_resources_with_http_info(authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
            return data

    def resources_get_resources_with_http_info(self, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        """Obtém a lista de recursos consentidos pelo cliente.  # noqa: E501

        Método para obter a lista de recursos mantidos pelo cliente na instituição transmissora e para as quais ele tenha fornecido consentimento.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.resources_get_resources_with_http_info(authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'x_fapi_interaction_id', 'x_fapi_auth_date', 'x_fapi_customer_ip_address', 'x_customer_user_agent', 'page', 'page_size']  # noqa: E501
        ...
        if ('x_fapi_interaction_id' not in params or
            ...
            raise ValueError("Missing the required parameter `x_fapi_interaction_id` when calling `resources_get_resources`")  # noqa: E501
