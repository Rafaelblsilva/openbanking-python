...
class CreditFixedIdentification(object):
    ...
    def debtor_cnpj_number(self):
        ...
        CNPJ do devedor (condicional para CRI e CRA)   [Restrição] Campo de preenchimento obrigatório pelas participantes quando o campo 'investmentType' for igual a \"CRI\" ou \"CRA\".   # noqa: E501
    ...
    def debtor_name(self):
        ...
        Nome do devedor (condicional para CRI e CRA)   [Restrição] Campo de preenchimento obrigatório pelas participantes quando o campo 'investmentType' for igual a \"CRI\" ou \"CRA\".   # noqa: E501
