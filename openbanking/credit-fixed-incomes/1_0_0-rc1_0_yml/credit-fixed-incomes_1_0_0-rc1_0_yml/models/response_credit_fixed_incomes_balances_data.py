...
class ResponseCreditFixedIncomesBalancesData(object):
    ...
    swagger_types = {
        ...
        'updated_unit_price': 'UpdatedUnitPriceunit',
        'quantity': 'str',
    ...
    def pre_fixed_rate(self):
        ...
        Taxa de remuneração acordada com o cliente na contratação. Em casos de produtos progressivos, considerar taxa vigente.       [Restrição] Campo de preenchimento obrigatório pelas participantes quando houver 'PRE_FIXADO' no campo 'indexer' ou quando se tratar de produto com remuneração híbrida.   # noqa: E501
    ...
    def fine(self, fine):
        ...
        """
        if fine is None:
            raise ValueError("Invalid value for `fine`, must not be `None`")  # noqa: E501
