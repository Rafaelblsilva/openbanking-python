...
class ProductListApi(object):
    ...
    def credit_fixed_incomes_get_investments(self, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.credit_fixed_incomes_get_investments(authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: ResponseCreditFixedIncomesProductList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.credit_fixed_incomes_get_investments_with_http_info(authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
        else:
            (data) = self.credit_fixed_incomes_get_investments_with_http_info(authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
            return data

    def credit_fixed_incomes_get_investments_with_http_info(self, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        """Obtém a lista de operações de Renda Fixa Crédito mantidas pelo cliente na instituição transmissora e para as quais ele tenha fornecido consentimento.  # noqa: E501

        Obtém a lista de operações de Renda Fixa Crédito mantidas pelo cliente na instituição transmissora e para as quais ele tenha fornecido consentimento.        -  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.credit_fixed_incomes_get_investments_with_http_info(authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method credit_fixed_incomes_get_investments" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('authorization' not in params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `credit_fixed_incomes_get_investments`")  # noqa: E501
        ...
        if ('x_fapi_interaction_id' not in params or
            ...
            raise ValueError("Missing the required parameter `x_fapi_interaction_id` when calling `credit_fixed_incomes_get_investments`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponseCreditFixedIncomesProductList',  # noqa: E501
