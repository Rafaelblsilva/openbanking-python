...
class TransactionGrossValue(object):
    ...
    def __init__(self, amount=None, currency=None):  # noqa: E501
        """TransactionGrossValue - a model defined in Swagger"""  # noqa: E501
        self._amount = None
        self._currency = None
    ...
    @property
    def amount(self):
        """Gets the amount of this TransactionGrossValue.  # noqa: E501

        Valor relacionado ao objeto.  # noqa: E501

        :return: The amount of this TransactionGrossValue.  # noqa: E501
        :rtype: str
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this TransactionGrossValue.

        Valor relacionado ao objeto.  # noqa: E501

        :param amount: The amount of this TransactionGrossValue.  # noqa: E501
        :type: str
        """
        if amount is None:
    ...
    @property
    def currency(self):
        """Gets the currency of this TransactionGrossValue.  # noqa: E501


        :return: The currency of this TransactionGrossValue.  # noqa: E501
        :rtype: Currency
        """
    ...
    def currency(self, currency):
        """Sets the currency of this TransactionGrossValue.


        :param currency: The currency of this TransactionGrossValue.  # noqa: E501
        :type: Currency
        """
        if currency is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TransactionGrossValue, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransactionGrossValue):
            return False
