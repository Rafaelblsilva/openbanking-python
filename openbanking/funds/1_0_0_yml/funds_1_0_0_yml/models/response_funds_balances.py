...
class ResponseFundsBalances(object):
    ...
    def __init__(self, data=None, links=None, meta=None):  # noqa: E501
        """ResponseFundsBalances - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
        self._meta = None
    ...
    @property
    def data(self):
        """Gets the data of this ResponseFundsBalances.  # noqa: E501


        :return: The data of this ResponseFundsBalances.  # noqa: E501
        :rtype: ResponseFundsBalanceData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ResponseFundsBalances.


        :param data: The data of this ResponseFundsBalances.  # noqa: E501
        :type: ResponseFundsBalanceData
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this ResponseFundsBalances.  # noqa: E501


        :return: The links of this ResponseFundsBalances.  # noqa: E501
        :rtype: FundsLinks
        """
        return self._links
    ...
    def links(self, links):
        """Sets the links of this ResponseFundsBalances.


        :param links: The links of this ResponseFundsBalances.  # noqa: E501
        :type: FundsLinks
        """
        if links is None:
    ...
    @property
    def meta(self):
        """Gets the meta of this ResponseFundsBalances.  # noqa: E501


        :return: The meta of this ResponseFundsBalances.  # noqa: E501
        :rtype: FundsMeta
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this ResponseFundsBalances.


        :param meta: The meta of this ResponseFundsBalances.  # noqa: E501
        :type: FundsMeta
        """
        if meta is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseFundsBalances, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseFundsBalances):
            return False
