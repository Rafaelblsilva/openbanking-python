...
class ResponseFundsTransactions(object):
    ...
    def __init__(self, data=None, links=None, meta=None):  # noqa: E501
        """ResponseFundsTransactions - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
        self._meta = None
    ...
    @property
    def data(self):
        """Gets the data of this ResponseFundsTransactions.  # noqa: E501


        :return: The data of this ResponseFundsTransactions.  # noqa: E501
        :rtype: list[ResponseFundsTransactionsData]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ResponseFundsTransactions.


        :param data: The data of this ResponseFundsTransactions.  # noqa: E501
        :type: list[ResponseFundsTransactionsData]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this ResponseFundsTransactions.  # noqa: E501


        :return: The links of this ResponseFundsTransactions.  # noqa: E501
    ...
    def links(self, links):
        """Sets the links of this ResponseFundsTransactions.


        :param links: The links of this ResponseFundsTransactions.  # noqa: E501
    ...
    @property
    def meta(self):
        """Gets the meta of this ResponseFundsTransactions.  # noqa: E501


        :return: The meta of this ResponseFundsTransactions.  # noqa: E501
        :rtype: MetaSingle
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this ResponseFundsTransactions.


        :param meta: The meta of this ResponseFundsTransactions.  # noqa: E501
        :type: MetaSingle
        """
        if meta is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseFundsTransactions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseFundsTransactions):
            return False
