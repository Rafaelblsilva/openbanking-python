...
class AverageMetrics(object):
    ...
    def current_day(self):
        """Gets the current_day of this AverageMetrics.  # noqa: E501

        Tempo médio de resposta em milissegundos para chamadas no dia atual.  # noqa: E501

        :return: The current_day of this AverageMetrics.  # noqa: E501
        :rtype: int
        """
    ...
    def current_day(self, current_day):
        """Sets the current_day of this AverageMetrics.

        Tempo médio de resposta em milissegundos para chamadas no dia atual.  # noqa: E501

        :param current_day: The current_day of this AverageMetrics.  # noqa: E501
        :type: int
        """
    ...
    def previous_days(self):
        """Gets the previous_days of this AverageMetrics.  # noqa: E501

        Tempo médio de resposta em milissegundos para chamadas nos dias anteriores. O primeiro item do array é referente ao dia anterior ao corrente, e assim por diante. Devem ser retornados no máximo sete dias caso estejam disponíveis.​  # noqa: E501

        :return: The previous_days of this AverageMetrics.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def previous_days(self, previous_days):
        """Sets the previous_days of this AverageMetrics.

        Tempo médio de resposta em milissegundos para chamadas nos dias anteriores. O primeiro item do array é referente ao dia anterior ao corrente, e assim por diante. Devem ser retornados no máximo sete dias caso estejam disponíveis.​  # noqa: E501

        :param previous_days: The previous_days of this AverageMetrics.  # noqa: E501
        :type: list[int]
        """
