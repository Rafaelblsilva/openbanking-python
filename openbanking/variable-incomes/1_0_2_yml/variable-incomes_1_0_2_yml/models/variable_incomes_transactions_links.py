...
class VariableIncomesTransactionsLinks(object):
    ...
    def __init__(self, _self=None, first=None, prev=None, next=None):  # noqa: E501
        """VariableIncomesTransactionsLinks - a model defined in Swagger"""  # noqa: E501
        self.__self = None
        self._first = None
        self._prev = None
        self._next = None
    ...
    @property
    def _self(self):
        """Gets the _self of this VariableIncomesTransactionsLinks.  # noqa: E501

        URI completo que gerou a resposta atual.  # noqa: E501

        :return: The _self of this VariableIncomesTransactionsLinks.  # noqa: E501
        :rtype: str
        """
        return self.__self
    ...
    def _self(self, _self):
        """Sets the _self of this VariableIncomesTransactionsLinks.

        URI completo que gerou a resposta atual.  # noqa: E501

        :param _self: The _self of this VariableIncomesTransactionsLinks.  # noqa: E501
        :type: str
        """
        if _self is None:
    ...
    @property
    def first(self):
        """Gets the first of this VariableIncomesTransactionsLinks.  # noqa: E501
        ...
        :return: The first of this VariableIncomesTransactionsLinks.  # noqa: E501
        :rtype: str
        """
        return self._first
    ...
    def first(self, first):
        """Sets the first of this VariableIncomesTransactionsLinks.

        URI da primeira página que originou essa lista de resultados. Restrição - Obrigatório quando não for a primeira página da resposta  # noqa: E501

        :param first: The first of this VariableIncomesTransactionsLinks.  # noqa: E501
        :type: str
        """
    ...
    @property
    def prev(self):
        """Gets the prev of this VariableIncomesTransactionsLinks.  # noqa: E501
        ...
        :return: The prev of this VariableIncomesTransactionsLinks.  # noqa: E501
        :rtype: str
        """
        return self._prev
    ...
    @prev.setter
    def prev(self, prev):
        """Sets the prev of this VariableIncomesTransactionsLinks.

        URI da página anterior dessa lista de resultados. Restrição -  Obrigatório quando não for a primeira página da resposta  # noqa: E501

        :param prev: The prev of this VariableIncomesTransactionsLinks.  # noqa: E501
        :type: str
        """
    ...
    @property
    def next(self):
        """Gets the next of this VariableIncomesTransactionsLinks.  # noqa: E501
        ...
        :return: The next of this VariableIncomesTransactionsLinks.  # noqa: E501
        :rtype: str
        """
        return self._next
    ...
    @next.setter
    def next(self, next):
        """Sets the next of this VariableIncomesTransactionsLinks.

        URI da próxima página dessa lista de resultados. Restrição - Obrigatório quando não for a última página da resposta  # noqa: E501

        :param next: The next of this VariableIncomesTransactionsLinks.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VariableIncomesTransactionsLinks, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VariableIncomesTransactionsLinks):
            return False
