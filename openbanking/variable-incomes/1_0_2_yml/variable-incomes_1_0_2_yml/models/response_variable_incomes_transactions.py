...
class ResponseVariableIncomesTransactions(object):
    ...
    def __init__(self, data=None, links=None, meta=None):  # noqa: E501
        """ResponseVariableIncomesTransactions - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
        self._meta = None
    ...
    @property
    def data(self):
        """Gets the data of this ResponseVariableIncomesTransactions.  # noqa: E501


        :return: The data of this ResponseVariableIncomesTransactions.  # noqa: E501
        :rtype: list[ResponseVariableIncomesTransactionsData]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ResponseVariableIncomesTransactions.


        :param data: The data of this ResponseVariableIncomesTransactions.  # noqa: E501
        :type: list[ResponseVariableIncomesTransactionsData]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this ResponseVariableIncomesTransactions.  # noqa: E501


        :return: The links of this ResponseVariableIncomesTransactions.  # noqa: E501
        :rtype: VariableIncomesTransactionsLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this ResponseVariableIncomesTransactions.


        :param links: The links of this ResponseVariableIncomesTransactions.  # noqa: E501
        :type: VariableIncomesTransactionsLinks
        """
        if links is None:
    ...
    @property
    def meta(self):
        """Gets the meta of this ResponseVariableIncomesTransactions.  # noqa: E501


        :return: The meta of this ResponseVariableIncomesTransactions.  # noqa: E501
        :rtype: MetaSingle
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this ResponseVariableIncomesTransactions.


        :param meta: The meta of this ResponseVariableIncomesTransactions.  # noqa: E501
        :type: MetaSingle
        """
        if meta is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseVariableIncomesTransactions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseVariableIncomesTransactions):
            return False
