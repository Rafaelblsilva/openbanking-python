...
class BrokerNoteDetailsApi(object):
    ...
    def variable_incomes_get_investments_investment_id_broker_notes_broker_note_id(self, investment_id, broker_note_id, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.variable_incomes_get_investments_investment_id_broker_notes_broker_note_id(investment_id, broker_note_id, authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.variable_incomes_get_investments_investment_id_broker_notes_broker_note_id_with_http_info(investment_id, broker_note_id, authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
        else:
            (data) = self.variable_incomes_get_investments_investment_id_broker_notes_broker_note_id_with_http_info(investment_id, broker_note_id, authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
            return data

    def variable_incomes_get_investments_investment_id_broker_notes_broker_note_id_with_http_info(self, investment_id, broker_note_id, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        """Obtém as informações da nota de negociação identificado nas movimentações de compra e venda de ativos em bolsa. O brokerNoteId é enviado nos movimentos de compra ou venda de ativos e deve ser passada como parâmetro de entrada no endpoint “Nota de Negociação”.Como conteúdo do campo brokerNoteId é esperado que a transmissora gere um identificar único, imutável, para cada número (natural) de nota de negociação.   # noqa: E501

        Obtém as informações da nota de negociação identificado nas movimentações de compra e venda de ativos em bolsa. O brokerNoteId é enviado nos movimentos de compra ou venda de ativos e deve ser passada como parâmetro de entrada no endpoint “Nota de Negociação”.Como conteúdo do campo brokerNoteId é esperado que a transmissora gere um identificar único, imutável, para cada número (natural) de nota de negociação.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.variable_incomes_get_investments_investment_id_broker_notes_broker_note_id_with_http_info(investment_id, broker_note_id, authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['investment_id', 'broker_note_id', 'authorization', 'x_fapi_interaction_id', 'x_fapi_auth_date', 'x_fapi_customer_ip_address', 'x_customer_user_agent']  # noqa: E501
        ...
        if ('investment_id' not in params or
            ...
            raise ValueError("Missing the required parameter `investment_id` when calling `variable_incomes_get_investments_investment_id_broker_notes_broker_note_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/investments/{investmentId}/broker-notes/{brokerNoteId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
