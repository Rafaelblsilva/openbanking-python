...
class ProductListApi(object):
    ...
    def variable_incomes_get_investments(self, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        """Obtém a lista de operações de Renda Variável mantidas pelo cliente na instituição transmissora e para as quais ele tenha fornecido consentimento.  # noqa: E501

        Obtém a lista de operações de Renda Variável mantidas pelo cliente na instituição transmissora e para as quais ele tenha fornecido consentimento.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.variable_incomes_get_investments(authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: ResponseVariableIncomesProductList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.variable_incomes_get_investments_with_http_info(authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
        else:
            (data) = self.variable_incomes_get_investments_with_http_info(authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
            return data

    def variable_incomes_get_investments_with_http_info(self, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        """Obtém a lista de operações de Renda Variável mantidas pelo cliente na instituição transmissora e para as quais ele tenha fornecido consentimento.  # noqa: E501

        Obtém a lista de operações de Renda Variável mantidas pelo cliente na instituição transmissora e para as quais ele tenha fornecido consentimento.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.variable_incomes_get_investments_with_http_info(authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method variable_incomes_get_investments" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('authorization' not in params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `variable_incomes_get_investments`")  # noqa: E501
        ...
        if ('x_fapi_interaction_id' not in params or
            ...
            raise ValueError("Missing the required parameter `x_fapi_interaction_id` when calling `variable_incomes_get_investments`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponseVariableIncomesProductList',  # noqa: E501
