...
class ProductIdentificationApi(object):
    ...
    def variable_incomes_get_investments_investment_id(self, investment_id, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        """Obtém os dados da operação de Renda Variável identificada por investmentId.  # noqa: E501

        Obtém os dados da operação de Renda Variável identificada por investmentId.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.variable_incomes_get_investments_investment_id(investment_id, authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: ResponseVariableIncomesProductIdentification
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.variable_incomes_get_investments_investment_id_with_http_info(investment_id, authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
        else:
            (data) = self.variable_incomes_get_investments_investment_id_with_http_info(investment_id, authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
            return data

    def variable_incomes_get_investments_investment_id_with_http_info(self, investment_id, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        """Obtém os dados da operação de Renda Variável identificada por investmentId.  # noqa: E501

        Obtém os dados da operação de Renda Variável identificada por investmentId.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.variable_incomes_get_investments_investment_id_with_http_info(investment_id, authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method variable_incomes_get_investments_investment_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('investment_id' not in params or
            ...
            raise ValueError("Missing the required parameter `investment_id` when calling `variable_incomes_get_investments_investment_id`")  # noqa: E501
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `variable_incomes_get_investments_investment_id`")  # noqa: E501
        ...
        if ('x_fapi_interaction_id' not in params or
            ...
            raise ValueError("Missing the required parameter `x_fapi_interaction_id` when calling `variable_incomes_get_investments_investment_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponseVariableIncomesProductIdentification',  # noqa: E501
