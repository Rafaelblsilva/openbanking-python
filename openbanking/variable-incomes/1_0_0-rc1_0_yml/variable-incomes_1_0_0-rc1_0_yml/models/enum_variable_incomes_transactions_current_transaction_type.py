...
class EnumVariableIncomesTransactionsCurrentTransactionType(object):
    ...
    ALUGUEIS = "ALUGUEIS"
    INPLIT = "INPLIT"
    SPLIT_TRANSFERENCIA_CUSTODIA = "SPLIT_TRANSFERENCIA_CUSTODIA"
    ...
    def __init__(self):  # noqa: E501
        """EnumVariableIncomesTransactionsCurrentTransactionType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumVariableIncomesTransactionsCurrentTransactionType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumVariableIncomesTransactionsCurrentTransactionType):
            return False
