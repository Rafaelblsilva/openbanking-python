...
class PersonalInsuranceData(object):
    ...
    swagger_types = {
        ...
        'benefit_recalculation': 'PersonalInsuranceDataBenefitRecalculation',
        ...
        'portability_grace_time': 'GracePeriod',
    ...
    def __init__(self, participant=None, society=None, name=None, code=None, category=None, modality=None, coverages=None, assistance_types=None, assistance_types_additional_infos=None, additionals=None, terms_and_conditions=None, global_capital=None, terms=None, pmbac_remuneration=None, benefit_recalculation=None, age_adjustment=None, financial_regimes=None, reclaim=None, other_guaranteed_values=None, allow_portability=None, portability_grace_time=None, indemnity_payment_methods=None, indemnity_payment_incomes=None, premium_payment=None, minimum_requirement=None, target_audience=None):  # noqa: E501
        ...
        if financial_regimes is not None:
    ...
    def category(self):
        ...
        Indicar a categoria do Produto&#58;<br><ol><li>Tradicional</li><li>Microsseguro</li></ol>  # noqa: E501
    ...
    def category(self, category):
        ...
        :type: str
        """
        allowed_values = ["TRADICIONAL", "MICROSSEGURO"]  # noqa: E501
    ...
    def additionals(self, additionals):
        ...
        allowed_values = ["SORTEIO", "SERVICOS_ASSISTENCIAS_COMPLEMENTARES_PAGO", "SERVICOS_ASSISTENCIA_COMPLEMENTARES_GRATUITO", "OUTROS", "NAO_HA"]  # noqa: E501
    ...
    def terms(self, terms):
        ...
        allowed_values = ["VITALICIA", "TEMPORARIA_PRAZO_FIXO", "TEMPORARIA_INTERMITENTE"]  # noqa: E501
    ...
    def benefit_recalculation(self):
        ...
        :rtype: PersonalInsuranceDataBenefitRecalculation
        """
    ...
    def benefit_recalculation(self, benefit_recalculation):
        ...
        :type: PersonalInsuranceDataBenefitRecalculation
        """
        if benefit_recalculation is None:
            raise ValueError("Invalid value for `benefit_recalculation`, must not be `None`")  # noqa: E501
    ...
    def premium_payment(self, premium_payment):
        ...
        if premium_payment is None:
            raise ValueError("Invalid value for `premium_payment`, must not be `None`")  # noqa: E501
