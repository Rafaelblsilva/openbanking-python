...
class EnumPremiumPaymentMethodType(object):
    ...
    PONTOS_PROGRAMA_BENEF_CIO = "PONTOS_PROGRAMA_BENEFÍCIO"
    OUTROS = "OUTROS"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """EnumPremiumPaymentMethodType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumPremiumPaymentMethodType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumPremiumPaymentMethodType):
            return False
