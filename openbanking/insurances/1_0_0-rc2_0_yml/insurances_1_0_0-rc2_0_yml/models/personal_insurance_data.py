...
class PersonalInsuranceData(object):
    ...
    def global_capital(self, global_capital):
        ...
        :type: bool
        """
        if global_capital is None:
            raise ValueError("Invalid value for `global_capital`, must not be `None`")  # noqa: E501
    ...
    def allow_portability(self, allow_portability):
        ...
        :type: bool
        """
        if allow_portability is None:
            raise ValueError("Invalid value for `allow_portability`, must not be `None`")  # noqa: E501
