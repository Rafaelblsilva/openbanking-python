...
class InvoiceFinancingsPayments(object):
    ...
    swagger_types = {
        ...
        'releases': 'list[InvoiceFinancingsReleases]'
    }
    ...
    def __init__(self, paid_instalments=None, contract_outstanding_balance=None, releases=None):  # noqa: E501
        """InvoiceFinancingsPayments - a model defined in Swagger"""  # noqa: E501
    ...
    def paid_instalments(self):
        """Gets the paid_instalments of this InvoiceFinancingsPayments.  # noqa: E501

        Quantidade total de parcelas pagas do contrato referente à Modalidade de Crédito informada.  # noqa: E501

        :return: The paid_instalments of this InvoiceFinancingsPayments.  # noqa: E501
        :rtype: float
        """
    ...
    def paid_instalments(self, paid_instalments):
        """Sets the paid_instalments of this InvoiceFinancingsPayments.

        Quantidade total de parcelas pagas do contrato referente à Modalidade de Crédito informada.  # noqa: E501

        :param paid_instalments: The paid_instalments of this InvoiceFinancingsPayments.  # noqa: E501
        :type: float
        """
    ...
    def contract_outstanding_balance(self):
        """Gets the contract_outstanding_balance of this InvoiceFinancingsPayments.  # noqa: E501

        Valor necessario para o cliente liquidar a dívida.  # noqa: E501

        :return: The contract_outstanding_balance of this InvoiceFinancingsPayments.  # noqa: E501
        :rtype: str
        """
    ...
    def contract_outstanding_balance(self, contract_outstanding_balance):
        """Sets the contract_outstanding_balance of this InvoiceFinancingsPayments.

        Valor necessario para o cliente liquidar a dívida.  # noqa: E501

        :param contract_outstanding_balance: The contract_outstanding_balance of this InvoiceFinancingsPayments.  # noqa: E501
        :type: str
        """
    ...
    @property
    def releases(self):
        """Gets the releases of this InvoiceFinancingsPayments.  # noqa: E501

        Lista dos pagamentos realizados no período.  # noqa: E501

        :return: The releases of this InvoiceFinancingsPayments.  # noqa: E501
        :rtype: list[InvoiceFinancingsReleases]
        """
        return self._releases

    @releases.setter
    def releases(self, releases):
        """Sets the releases of this InvoiceFinancingsPayments.

        Lista dos pagamentos realizados no período.  # noqa: E501

        :param releases: The releases of this InvoiceFinancingsPayments.  # noqa: E501
        :type: list[InvoiceFinancingsReleases]
        """
        if releases is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InvoiceFinancingsPayments, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InvoiceFinancingsPayments):
            return False
