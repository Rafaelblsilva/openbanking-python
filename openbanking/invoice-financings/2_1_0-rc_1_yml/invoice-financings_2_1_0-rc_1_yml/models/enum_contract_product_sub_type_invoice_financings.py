...
class EnumContractProductSubTypeInvoiceFinancings(object):
    ...
    allowed enum values
    """
    DESCONTO_DUPLICATAS = "DESCONTO_DUPLICATAS"
    DESCONTO_CHEQUES = "DESCONTO_CHEQUES"
    ANTECIPACAO_FATURA_CARTAO_CREDITO = "ANTECIPACAO_FATURA_CARTAO_CREDITO"
    OUTROS_DIREITOS_CREDITORIOS_DESCONTADOS = "OUTROS_DIREITOS_CREDITORIOS_DESCONTADOS"
    OUTROS_TITULOS_DESCONTADOS = "OUTROS_TITULOS_DESCONTADOS"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """EnumContractProductSubTypeInvoiceFinancings - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumContractProductSubTypeInvoiceFinancings, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumContractProductSubTypeInvoiceFinancings):
            return False
