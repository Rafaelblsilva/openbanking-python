...
class InvoiceFinancingsContractedWarranty(object):
    ...
    def __init__(self, currency=None, warranty_type=None, warranty_sub_type=None, warranty_amount=None):  # noqa: E501
        """InvoiceFinancingsContractedWarranty - a model defined in Swagger"""  # noqa: E501
        self._currency = None
    ...
    @property
    def currency(self):
        """Gets the currency of this InvoiceFinancingsContractedWarranty.  # noqa: E501
        ...
        :return: The currency of this InvoiceFinancingsContractedWarranty.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this InvoiceFinancingsContractedWarranty.

        Moeda referente ao valor da garantia, segundo modelo ISO-4217. p.ex. 'BRL'. Todos os valores monetários informados estão representados com a moeda vigente do Brasil  # noqa: E501

        :param currency: The currency of this InvoiceFinancingsContractedWarranty.  # noqa: E501
        :type: str
        """
        if currency is None:
    ...
    def warranty_type(self):
        """Gets the warranty_type of this InvoiceFinancingsContractedWarranty.  # noqa: E501


        :return: The warranty_type of this InvoiceFinancingsContractedWarranty.  # noqa: E501
    ...
    def warranty_type(self, warranty_type):
        """Sets the warranty_type of this InvoiceFinancingsContractedWarranty.


        :param warranty_type: The warranty_type of this InvoiceFinancingsContractedWarranty.  # noqa: E501
    ...
    def warranty_sub_type(self):
        """Gets the warranty_sub_type of this InvoiceFinancingsContractedWarranty.  # noqa: E501


        :return: The warranty_sub_type of this InvoiceFinancingsContractedWarranty.  # noqa: E501
    ...
    def warranty_sub_type(self, warranty_sub_type):
        """Sets the warranty_sub_type of this InvoiceFinancingsContractedWarranty.


        :param warranty_sub_type: The warranty_sub_type of this InvoiceFinancingsContractedWarranty.  # noqa: E501
    ...
    def warranty_amount(self):
        """Gets the warranty_amount of this InvoiceFinancingsContractedWarranty.  # noqa: E501
        ...
        :return: The warranty_amount of this InvoiceFinancingsContractedWarranty.  # noqa: E501
        :rtype: str
        """
    ...
    def warranty_amount(self, warranty_amount):
        """Sets the warranty_amount of this InvoiceFinancingsContractedWarranty.

        Valor original da garantia. Expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais.  [Restrição] Nos casos em que warrantyType for igual a \"GARANTIA_FIDEJUSSORIA“ pode ser enviado o valor 0.00.   # noqa: E501

        :param warranty_amount: The warranty_amount of this InvoiceFinancingsContractedWarranty.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InvoiceFinancingsContractedWarranty, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InvoiceFinancingsContractedWarranty):
            return False
