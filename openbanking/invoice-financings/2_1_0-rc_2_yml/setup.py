...
NAME = "invoice-financings-2-1-0-rc-2-yml"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="API Invoice-financings - Open Finance Brasil",
    author_email="gt-interfaces@openbankingbr.org",
    url="",
    keywords=["Swagger", "API Invoice-financings - Open Finance Brasil"],
