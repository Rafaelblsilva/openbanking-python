...
class InvoiceFinancingsInstalments(object):
    ...
    swagger_types = {
        ...
        'balloon_payments': 'list[InvoiceFinancingsBalloonPayment]'
    }
    ...
    def __init__(self, type_number_of_instalments=None, total_number_of_instalments=None, type_contract_remaining=None, contract_remaining_number=None, paid_instalments=None, due_instalments=None, past_due_instalments=None, balloon_payments=None):  # noqa: E501
        """InvoiceFinancingsInstalments - a model defined in Swagger"""  # noqa: E501
    ...
    def type_number_of_instalments(self):
        """Gets the type_number_of_instalments of this InvoiceFinancingsInstalments.  # noqa: E501

        Tipo de prazo total do contrato referente à modalidade de crédito informada.  # noqa: E501

        :return: The type_number_of_instalments of this InvoiceFinancingsInstalments.  # noqa: E501
        :rtype: str
        """
    ...
    def type_number_of_instalments(self, type_number_of_instalments):
        """Sets the type_number_of_instalments of this InvoiceFinancingsInstalments.

        Tipo de prazo total do contrato referente à modalidade de crédito informada.  # noqa: E501

        :param type_number_of_instalments: The type_number_of_instalments of this InvoiceFinancingsInstalments.  # noqa: E501
        :type: str
        """
    ...
    def total_number_of_instalments(self):
        """Gets the total_number_of_instalments of this InvoiceFinancingsInstalments.  # noqa: E501

        Prazo Total segundo o tipo (dia, semana, mês, ano) referente à Modalidade de Crédito informada.  # noqa: E501

        :return: The total_number_of_instalments of this InvoiceFinancingsInstalments.  # noqa: E501
        :rtype: float
        """
    ...
    def total_number_of_instalments(self, total_number_of_instalments):
        """Sets the total_number_of_instalments of this InvoiceFinancingsInstalments.

        Prazo Total segundo o tipo (dia, semana, mês, ano) referente à Modalidade de Crédito informada.  # noqa: E501

        :param total_number_of_instalments: The total_number_of_instalments of this InvoiceFinancingsInstalments.  # noqa: E501
        :type: float
        """
    ...
    def type_contract_remaining(self):
        """Gets the type_contract_remaining of this InvoiceFinancingsInstalments.  # noqa: E501

        Tipo de prazo remanescente do contrato referente à modalidade de crédito informada.      # noqa: E501

        :return: The type_contract_remaining of this InvoiceFinancingsInstalments.  # noqa: E501
        :rtype: str
        """
    ...
    def type_contract_remaining(self, type_contract_remaining):
        """Sets the type_contract_remaining of this InvoiceFinancingsInstalments.

        Tipo de prazo remanescente do contrato referente à modalidade de crédito informada.      # noqa: E501

        :param type_contract_remaining: The type_contract_remaining of this InvoiceFinancingsInstalments.  # noqa: E501
        :type: str
        """
    ...
    def contract_remaining_number(self):
        """Gets the contract_remaining_number of this InvoiceFinancingsInstalments.  # noqa: E501

        Prazo Remanescente segundo o tipo (dia, semana, mês, ano) referente à Modalidade de Crédito informada.  # noqa: E501

        :return: The contract_remaining_number of this InvoiceFinancingsInstalments.  # noqa: E501
        :rtype: float
        """
    ...
    def contract_remaining_number(self, contract_remaining_number):
        """Sets the contract_remaining_number of this InvoiceFinancingsInstalments.

        Prazo Remanescente segundo o tipo (dia, semana, mês, ano) referente à Modalidade de Crédito informada.  # noqa: E501

        :param contract_remaining_number: The contract_remaining_number of this InvoiceFinancingsInstalments.  # noqa: E501
        :type: float
        """
    ...
    def paid_instalments(self):
        """Gets the paid_instalments of this InvoiceFinancingsInstalments.  # noqa: E501
        ...
        :return: The paid_instalments of this InvoiceFinancingsInstalments.  # noqa: E501
        :rtype: float
        """
    ...
    def paid_instalments(self, paid_instalments):
        """Sets the paid_instalments of this InvoiceFinancingsInstalments.

        Quantidade de prestações pagas. (No caso de modalidades que não possuam parcelas, o número de prestações é igual a zero)  # noqa: E501

        :param paid_instalments: The paid_instalments of this InvoiceFinancingsInstalments.  # noqa: E501
        :type: float
        """
    ...
    def due_instalments(self):
        """Gets the due_instalments of this InvoiceFinancingsInstalments.  # noqa: E501
        ...
        :return: The due_instalments of this InvoiceFinancingsInstalments.  # noqa: E501
        :rtype: float
        """
    ...
    def due_instalments(self, due_instalments):
        """Sets the due_instalments of this InvoiceFinancingsInstalments.

        Quantidade de prestações a vencer.(No caso de modalidades que não possuam parcelas, o número de prestações é igual a zero)  # noqa: E501

        :param due_instalments: The due_instalments of this InvoiceFinancingsInstalments.  # noqa: E501
        :type: float
        """
    ...
    def past_due_instalments(self):
        """Gets the past_due_instalments of this InvoiceFinancingsInstalments.  # noqa: E501
        ...
        :return: The past_due_instalments of this InvoiceFinancingsInstalments.  # noqa: E501
        :rtype: float
        """
    ...
    def past_due_instalments(self, past_due_instalments):
        """Sets the past_due_instalments of this InvoiceFinancingsInstalments.

        Quantidade de prestações vencidas. (No caso de modalidades que não possuam parcelas, o número de prestações é igual a zero)  # noqa: E501

        :param past_due_instalments: The past_due_instalments of this InvoiceFinancingsInstalments.  # noqa: E501
        :type: float
        """
    ...
    def balloon_payments(self):
        """Gets the balloon_payments of this InvoiceFinancingsInstalments.  # noqa: E501
        ...
        :return: The balloon_payments of this InvoiceFinancingsInstalments.  # noqa: E501
        :rtype: list[InvoiceFinancingsBalloonPayment]
        """
        return self._balloon_payments

    @balloon_payments.setter
    def balloon_payments(self, balloon_payments):
        """Sets the balloon_payments of this InvoiceFinancingsInstalments.

        Lista que traz as datas de vencimento e valor das parcelas não regulares do contrato da modalidade de crédito consultada  # noqa: E501

        :param balloon_payments: The balloon_payments of this InvoiceFinancingsInstalments.  # noqa: E501
        :type: list[InvoiceFinancingsBalloonPayment]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InvoiceFinancingsInstalments, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InvoiceFinancingsInstalments):
            return False
