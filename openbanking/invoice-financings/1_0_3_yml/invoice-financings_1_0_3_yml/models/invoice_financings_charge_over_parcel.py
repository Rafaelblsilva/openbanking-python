...
class InvoiceFinancingsChargeOverParcel(object):
    ...
    def __init__(self, charge_type=None, charge_additional_info=None, charge_amount=None):  # noqa: E501
        """InvoiceFinancingsChargeOverParcel - a model defined in Swagger"""  # noqa: E501
    ...
    def charge_type(self):
        """Gets the charge_type of this InvoiceFinancingsChargeOverParcel.  # noqa: E501

        Tipo de encargo pago fora da parcela  # noqa: E501

        :return: The charge_type of this InvoiceFinancingsChargeOverParcel.  # noqa: E501
        :rtype: str
        """
    ...
    def charge_type(self, charge_type):
        """Sets the charge_type of this InvoiceFinancingsChargeOverParcel.

        Tipo de encargo pago fora da parcela  # noqa: E501

        :param charge_type: The charge_type of this InvoiceFinancingsChargeOverParcel.  # noqa: E501
        :type: str
        """
    ...
    def charge_additional_info(self):
        """Gets the charge_additional_info of this InvoiceFinancingsChargeOverParcel.  # noqa: E501

        Campo de preenchimento obrigatório se selecionada a opção 'OUTROS' em Tipo de encargo pago fora da parcela  # noqa: E501

        :return: The charge_additional_info of this InvoiceFinancingsChargeOverParcel.  # noqa: E501
        :rtype: str
        """
    ...
    def charge_additional_info(self, charge_additional_info):
        """Sets the charge_additional_info of this InvoiceFinancingsChargeOverParcel.

        Campo de preenchimento obrigatório se selecionada a opção 'OUTROS' em Tipo de encargo pago fora da parcela  # noqa: E501

        :param charge_additional_info: The charge_additional_info of this InvoiceFinancingsChargeOverParcel.  # noqa: E501
        :type: str
        """
    ...
    def charge_amount(self):
        """Gets the charge_amount of this InvoiceFinancingsChargeOverParcel.  # noqa: E501

        Valor do pagamento do encargo pago fora da parcela. Expresso em valor monetário com até 4 casas decimais.  # noqa: E501

        :return: The charge_amount of this InvoiceFinancingsChargeOverParcel.  # noqa: E501
        :rtype: float
        """
    ...
    def charge_amount(self, charge_amount):
        """Sets the charge_amount of this InvoiceFinancingsChargeOverParcel.

        Valor do pagamento do encargo pago fora da parcela. Expresso em valor monetário com até 4 casas decimais.  # noqa: E501

        :param charge_amount: The charge_amount of this InvoiceFinancingsChargeOverParcel.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InvoiceFinancingsChargeOverParcel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InvoiceFinancingsChargeOverParcel):
            return False
