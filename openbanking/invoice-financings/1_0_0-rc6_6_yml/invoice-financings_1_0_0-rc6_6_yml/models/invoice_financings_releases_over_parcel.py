...
class InvoiceFinancingsReleasesOverParcel(object):
    ...
    """
    swagger_types = {
        'fees': 'list[InvoiceFinancingsFeeOverParcel]',
        'charges': 'list[InvoiceFinancingsChargeOverParcel]'
    }
    ...
    def __init__(self, fees=None, charges=None):  # noqa: E501
        """InvoiceFinancingsReleasesOverParcel - a model defined in Swagger"""  # noqa: E501
        self._fees = None
        self._charges = None
    ...
    @property
    def fees(self):
        """Gets the fees of this InvoiceFinancingsReleasesOverParcel.  # noqa: E501

        Lista das tarifas que foram pagas fora da parcela, só para pagamento avulso.  # noqa: E501

        :return: The fees of this InvoiceFinancingsReleasesOverParcel.  # noqa: E501
        :rtype: list[InvoiceFinancingsFeeOverParcel]
        """
        return self._fees

    @fees.setter
    def fees(self, fees):
        """Sets the fees of this InvoiceFinancingsReleasesOverParcel.

        Lista das tarifas que foram pagas fora da parcela, só para pagamento avulso.  # noqa: E501

        :param fees: The fees of this InvoiceFinancingsReleasesOverParcel.  # noqa: E501
        :type: list[InvoiceFinancingsFeeOverParcel]
        """
        if fees is None:
    ...
    @property
    def charges(self):
        """Gets the charges of this InvoiceFinancingsReleasesOverParcel.  # noqa: E501

        Lista dos encargos que foram pagos fora da parcela.  # noqa: E501

        :return: The charges of this InvoiceFinancingsReleasesOverParcel.  # noqa: E501
        :rtype: list[InvoiceFinancingsChargeOverParcel]
        """
        return self._charges

    @charges.setter
    def charges(self, charges):
        """Sets the charges of this InvoiceFinancingsReleasesOverParcel.

        Lista dos encargos que foram pagos fora da parcela.  # noqa: E501

        :param charges: The charges of this InvoiceFinancingsReleasesOverParcel.  # noqa: E501
        :type: list[InvoiceFinancingsChargeOverParcel]
        """
        if charges is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InvoiceFinancingsReleasesOverParcel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InvoiceFinancingsReleasesOverParcel):
            return False
