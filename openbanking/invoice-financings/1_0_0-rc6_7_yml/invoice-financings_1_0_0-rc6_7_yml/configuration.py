...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host = "https://api.banco.com.br/open-banking/invoice-financings/v1"
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("invoice-financings_1_0_0-rc6_7_yml")
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 1.0.0-rc6.7\n"\
