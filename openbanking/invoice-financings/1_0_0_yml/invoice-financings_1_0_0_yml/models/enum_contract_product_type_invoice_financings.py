...
class EnumContractProductTypeInvoiceFinancings(object):
    ...
    allowed enum values
    """
    DIREITOS_CREDITORIOS_DESCONTADOS = "DIREITOS_CREDITORIOS_DESCONTADOS"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """EnumContractProductTypeInvoiceFinancings - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumContractProductTypeInvoiceFinancings, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumContractProductTypeInvoiceFinancings):
            return False
