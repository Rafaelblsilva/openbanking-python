...
class EnumWarrantyTypeYaml(object):
    ...
    allowed enum values
    """
    SEM_TIPO_GARANTIA = "SEM_TIPO_GARANTIA"
    ...
    def __init__(self):  # noqa: E501
        """EnumWarrantyTypeYaml - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumWarrantyTypeYaml, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumWarrantyTypeYaml):
            return False
