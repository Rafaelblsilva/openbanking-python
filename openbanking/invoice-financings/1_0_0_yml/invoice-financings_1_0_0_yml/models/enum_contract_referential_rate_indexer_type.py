...
class EnumContractReferentialRateIndexerType(object):
    ...
    allowed enum values
    """
    SEM_TIPO_INDEXADOR = "SEM_TIPO_INDEXADOR"
    PRE_FIXADO = "PRE_FIXADO"
    POS_FIXADO = "POS_FIXADO"
    FLUTUANTES = "FLUTUANTES"
    INDICES_PRECOS = "INDICES_PRECOS"
    CREDITO_RURAL = "CREDITO_RURAL"
    ...
    def __init__(self):  # noqa: E501
        """EnumContractReferentialRateIndexerType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumContractReferentialRateIndexerType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumContractReferentialRateIndexerType):
            return False
