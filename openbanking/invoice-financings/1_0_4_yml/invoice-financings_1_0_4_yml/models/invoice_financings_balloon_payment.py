...
class InvoiceFinancingsBalloonPayment(object):
    ...
    def __init__(self, due_date=None, currency=None, amount=None):  # noqa: E501
        """InvoiceFinancingsBalloonPayment - a model defined in Swagger"""  # noqa: E501
        self._due_date = None
        self._currency = None
        self._amount = None
    ...
    @property
    def due_date(self):
        """Gets the due_date of this InvoiceFinancingsBalloonPayment.  # noqa: E501
        ...
        :return: The due_date of this InvoiceFinancingsBalloonPayment.  # noqa: E501
        :rtype: date
        """
    ...
    def due_date(self, due_date):
        """Sets the due_date of this InvoiceFinancingsBalloonPayment.

        Data de vencimento da parcela não regular  a vencer do contrato da modalidade de crédito consultada, conforme especificação RFC-3339. p.ex. 2014-03-19  # noqa: E501

        :param due_date: The due_date of this InvoiceFinancingsBalloonPayment.  # noqa: E501
        :type: date
        """
        if due_date is None:
    ...
    @property
    def currency(self):
        """Gets the currency of this InvoiceFinancingsBalloonPayment.  # noqa: E501
        ...
        :return: The currency of this InvoiceFinancingsBalloonPayment.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this InvoiceFinancingsBalloonPayment.

        Moeda referente ao valor monetário informado, segundo modelo ISO-4217. p.ex. 'BRL' Todos os valores monetários informados estão representados com a moeda vigente do Brasil   # noqa: E501

        :param currency: The currency of this InvoiceFinancingsBalloonPayment.  # noqa: E501
        :type: str
        """
        if currency is None:
    ...
    @property
    def amount(self):
        """Gets the amount of this InvoiceFinancingsBalloonPayment.  # noqa: E501

        Valor monetário da parcela não regular a vencer.  Expresso em valor monetário com 4 casas decimais.  # noqa: E501

        :return: The amount of this InvoiceFinancingsBalloonPayment.  # noqa: E501
        :rtype: float
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this InvoiceFinancingsBalloonPayment.

        Valor monetário da parcela não regular a vencer.  Expresso em valor monetário com 4 casas decimais.  # noqa: E501

        :param amount: The amount of this InvoiceFinancingsBalloonPayment.  # noqa: E501
        :type: float
        """
        if amount is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InvoiceFinancingsBalloonPayment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InvoiceFinancingsBalloonPayment):
            return False
