...
class InvoiceFinancingsContractData(object):
    ...
    def __init__(self, contract_id=None, brand_name=None, company_cnpj=None, product_type=None, product_sub_type=None, ipoc_code=None):  # noqa: E501
        """InvoiceFinancingsContractData - a model defined in Swagger"""  # noqa: E501
    ...
    def contract_id(self):
        """Gets the contract_id of this InvoiceFinancingsContractData.  # noqa: E501
        ...
        :return: The contract_id of this InvoiceFinancingsContractData.  # noqa: E501
        :rtype: str
        """
    ...
    def contract_id(self, contract_id):
        """Sets the contract_id of this InvoiceFinancingsContractData.

        Identifica de forma única o contrato da operação de crédito do cliente, mantendo as regras de imutabilidade dentro da instituição transmissora.  # noqa: E501

        :param contract_id: The contract_id of this InvoiceFinancingsContractData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def brand_name(self):
        """Gets the brand_name of this InvoiceFinancingsContractData.  # noqa: E501
        ...
        :return: The brand_name of this InvoiceFinancingsContractData.  # noqa: E501
        :rtype: str
        """
    ...
    def brand_name(self, brand_name):
        """Sets the brand_name of this InvoiceFinancingsContractData.

        Nome da Marca reportada pelo participante do Open Banking. O conceito a que se refere a 'marca' é em essência uma promessa da empresa em fornecer uma série específica de atributos, benefícios e serviços uniformes aos clientes  # noqa: E501

        :param brand_name: The brand_name of this InvoiceFinancingsContractData.  # noqa: E501
        :type: str
        """
    ...
    def company_cnpj(self):
        """Gets the company_cnpj of this InvoiceFinancingsContractData.  # noqa: E501
        ...
        :return: The company_cnpj of this InvoiceFinancingsContractData.  # noqa: E501
        :rtype: str
        """
    ...
    def company_cnpj(self, company_cnpj):
        """Sets the company_cnpj of this InvoiceFinancingsContractData.

        Número completo do CNPJ da instituição responsável pelo Cadastro - o CNPJ corresponde ao número de inscrição no Cadastro de Pessoa Jurídica. Deve-se ter apenas os números do CNPJ, sem máscara.  # noqa: E501

        :param company_cnpj: The company_cnpj of this InvoiceFinancingsContractData.  # noqa: E501
        :type: str
        """
    ...
    def product_type(self):
        """Gets the product_type of this InvoiceFinancingsContractData.  # noqa: E501


        :return: The product_type of this InvoiceFinancingsContractData.  # noqa: E501
    ...
    def product_type(self, product_type):
        """Sets the product_type of this InvoiceFinancingsContractData.


        :param product_type: The product_type of this InvoiceFinancingsContractData.  # noqa: E501
    ...
    def product_sub_type(self):
        """Gets the product_sub_type of this InvoiceFinancingsContractData.  # noqa: E501


        :return: The product_sub_type of this InvoiceFinancingsContractData.  # noqa: E501
    ...
    def product_sub_type(self, product_sub_type):
        """Sets the product_sub_type of this InvoiceFinancingsContractData.


        :param product_sub_type: The product_sub_type of this InvoiceFinancingsContractData.  # noqa: E501
    ...
    @property
    def ipoc_code(self):
        """Gets the ipoc_code of this InvoiceFinancingsContractData.  # noqa: E501
        ...
        :return: The ipoc_code of this InvoiceFinancingsContractData.  # noqa: E501
        :rtype: str
        """
    ...
    def ipoc_code(self, ipoc_code):
        """Sets the ipoc_code of this InvoiceFinancingsContractData.

        Número padronizado do contrato - IPOC (Identificação Padronizada da Operação de Crédito). Segundo DOC 3040, composta por: - **CNPJ da instituição:** 8 (oito) posições iniciais; - **Modalidade da operação:** 4 (quatro) posições; - **Tipo do cliente:** 1 (uma) posição( 1 = pessoa natural - CPF, 2= pessoa jurídica – CNPJ, 3 = pessoa física no exterior, 4 = pessoa jurídica no exterior, 5 = pessoa natural sem CPF e 6 = pessoa jurídica sem CNPJ); - **Código do cliente:** O número de posições varia conforme o tipo do cliente:   1. Para clientes pessoa física com CPF (tipo de cliente = 1), informar as 11 (onze) posições do CPF;   2. Para clientes pessoa jurídica com CNPJ (tipo de cliente = 2), informar as 8 (oito) posições iniciais do CNPJ;   3. Para os demais clientes (tipos de cliente 3, 4, 5 e 6), informar 14 (catorze) posições com complemento de zeros à esquerda se a identificação tiver tamanho inferior; - **Código do contrato:** 1 (uma) até 40 (quarenta) posições, sem complemento de caracteres.   # noqa: E501

        :param ipoc_code: The ipoc_code of this InvoiceFinancingsContractData.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InvoiceFinancingsContractData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InvoiceFinancingsContractData):
            return False
