...
class CapitalizationBondsProductPrizeDraw(object):
    ...
    def time_interval(self):
        ...
        Intervalo de tempo regular previsto entre os sorteios. Conforme os domínios:   - UNICO   - DIÁRIO   - SEMANAL   - QUINZENAL   - MENSAL   - BIMESTRAL   - TRIMESTRAL   - QUADRIMESTRAL   - SEMESTRAL   - ANUAL   - OUTROS   # noqa: E501
    ...
    def time_interval(self, time_interval):
        ...
        allowed_values = ["UNICO", "DIÁRIO", "SEMANAL", "QUINZENAL", "MENSAL", "BIMESTRAL", "TRIMESTRAL", "QUADRIMESTRAL", "SEMESTRAL", "ANUAL", "OUTROS"]  # noqa: E501
    ...
    def early_settlement_raffle(self, early_settlement_raffle):
        ...
        :type: bool
        """
        if early_settlement_raffle is None:
            raise ValueError("Invalid value for `early_settlement_raffle`, must not be `None`")  # noqa: E501
    ...
    def mandatory_contemplation(self, mandatory_contemplation):
        ...
        :type: bool
        """
        if mandatory_contemplation is None:
            raise ValueError("Invalid value for `mandatory_contemplation`, must not be `None`")  # noqa: E501
