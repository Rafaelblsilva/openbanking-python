...
class CapitalizationBondsProductPaymentMethod(object):
    ...
    PAGAMENTO_PONTOS = "PAGAMENTO_PONTOS"
    OUTROS = "OUTROS"
    NA = "NA"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """CapitalizationBondsProductPaymentMethod - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CapitalizationBondsProductPaymentMethod, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CapitalizationBondsProductPaymentMethod):
            return False
