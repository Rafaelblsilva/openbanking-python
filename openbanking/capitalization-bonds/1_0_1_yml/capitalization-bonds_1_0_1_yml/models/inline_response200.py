...
class InlineResponse200(object):
    ...
    """
    swagger_types = {
        'data': 'list[CapitalizationBondsProductIdentificationData]',
        'links': 'Links',
        'meta': 'OpenDataMeta'
    }
    ...
    def data(self):
        ...
        Conjunto de informações do Título de Capitalização  # noqa: E501

        :return: The data of this InlineResponse200.  # noqa: E501
        :rtype: list[CapitalizationBondsProductIdentificationData]
        """
        return self._data
    ...
    def data(self, data):
        ...
        :type: list[CapitalizationBondsProductIdentificationData]
        """
        if data is None:
