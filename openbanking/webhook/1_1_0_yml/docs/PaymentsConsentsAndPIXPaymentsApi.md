# webhook_1_1_0_yml.PaymentsConsentsAndPIXPaymentsApi
...
api_instance = webhook_1_1_0_yml.PaymentsConsentsAndPIXPaymentsApi()
body = webhook_1_1_0_yml.RequestBodyWebhook() # RequestBodyWebhook | Payload enviado para notificar a alteração no estado do consentimento.
...
# create an instance of the API class
api_instance = webhook_1_1_0_yml.PaymentsConsentsAndPIXPaymentsApi()
body = webhook_1_1_0_yml.RequestBodyWebhook() # RequestBodyWebhook | Payload enviado para notificar a alteração no estado do pagamento.
x_webhook_interaction_id = 'x_webhook_interaction_id_example' # str | Identificador único para cada tentativa de notificação realizada. O identificador deverá seguir o padrão UID [RFC4122](https://tools.ietf.org/html/rfc4122).
