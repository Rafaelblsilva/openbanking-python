# webhook_1_2_0_yml.PaymentsConsentsAndPixPaymentsApi

All URIs are relative to *https://api.banco.com.br/open-banking/webhook/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**consent_notification**](PaymentsConsentsAndPixPaymentsApi.md#consent_notification) | **POST** /payments/{versionApi}/consents/{consentId} | Notificações de mudanças de estados de consentimentos da API de Iniciação de Pagamentos.
[**pix_payment_notification**](PaymentsConsentsAndPixPaymentsApi.md#pix_payment_notification) | **POST** /payments/{versionApi}/pix/payments/{paymentId} | Notificações de mudanças de estados do pagamento: Arranjo Pix da API de Iniciação de Pagamentos.
...
api_instance = webhook_1_2_0_yml.PaymentsConsentsAndPixPaymentsApi()
body = webhook_1_2_0_yml.RequestBodyWebhook() # RequestBodyWebhook | Payload enviado para notificar a alteração no estado do consentimento.
...
try:
    ...
    print("Exception when calling PaymentsConsentsAndPixPaymentsApi->consent_notification: %s\n" % e)
```
...
# create an instance of the API class
api_instance = webhook_1_2_0_yml.PaymentsConsentsAndPixPaymentsApi()
body = webhook_1_2_0_yml.RequestBodyWebhook() # RequestBodyWebhook | Payload enviado para notificar a alteração no estado do pagamento.
x_webhook_interaction_id = 'x_webhook_interaction_id_example' # str | Identificador único para cada tentativa de notificação realizada. O identificador deverá seguir o padrão UID [RFC4122](https://tools.ietf.org/html/rfc4122).
...
try:
    ...
    print("Exception when calling PaymentsConsentsAndPixPaymentsApi->pix_payment_notification: %s\n" % e)
```
