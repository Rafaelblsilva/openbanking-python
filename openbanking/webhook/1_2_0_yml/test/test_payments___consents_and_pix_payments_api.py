...
from webhook_1_2_0_yml.api.payments___consents_and_pix_payments_api import PaymentsConsentsAndPixPaymentsApi  # noqa: E501
from webhook_1_2_0_yml.rest import ApiException


class TestPaymentsConsentsAndPixPaymentsApi(unittest.TestCase):
    """PaymentsConsentsAndPixPaymentsApi unit test stubs"""

    def setUp(self):
        self.api = PaymentsConsentsAndPixPaymentsApi()  # noqa: E501
