...
class GeographicCoordinates(object):
    ...
    def latitude(self):
        ...
        Informação da Latitude referente a geolocalização informada. Entre -90 e 90.p.ex. '-90.8365180'. (2 casas antes da vírgula, 11 posições)    # noqa: E501
    ...
    def longitude(self):
        ...
        Informação da Longitude referente a geolocalização informada. Entre -180 e 180. p.ex '-180.836519.' (3 casas antes da vírgula, 11 posições)    # noqa: E501
