...
class EnumPersonalOtherDocumentType(object):
    ...
    RNE = "RNE"
    OUTROS = "OUTROS"
    SEM_OUTROS_DOCUMENTOS = "SEM_OUTROS_DOCUMENTOS"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """EnumPersonalOtherDocumentType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumPersonalOtherDocumentType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumPersonalOtherDocumentType):
            return False
