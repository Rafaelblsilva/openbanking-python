...
class CustomersApi(object):
    ...
    def get_customers_business_identifications(self, authorization, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_customers_business_identifications(authorization, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_customers_business_identifications_with_http_info(authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.get_customers_business_identifications_with_http_info(authorization, **kwargs)  # noqa: E501
            return data

    def get_customers_business_identifications_with_http_info(self, authorization, **kwargs):  # noqa: E501
        """Obtém os registros de identificação da pessoa jurídica.  # noqa: E501

        Método para obter os registros de identificação da pessoa jurídica mantidos na instituição transmissora  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customers_business_identifications_with_http_info(authorization, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_customers_business_identifications" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('authorization' not in params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `get_customers_business_identifications`")  # noqa: E501
    ...
    def get_customers_business_qualifications(self, authorization, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customers_business_qualifications(authorization, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_customers_business_qualifications_with_http_info(authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.get_customers_business_qualifications_with_http_info(authorization, **kwargs)  # noqa: E501
            return data

    def get_customers_business_qualifications_with_http_info(self, authorization, **kwargs):  # noqa: E501
        """Obtém os registros de qualificação da pessoa jurídica.  # noqa: E501

        Método para obter os registros de qualificação da pessoa jurídica mantidos na instituição transmissora.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customers_business_qualifications_with_http_info(authorization, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_customers_business_qualifications" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `get_customers_business_qualifications`")  # noqa: E501
    ...
    def get_customers_business_relationships(self, authorization, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customers_business_relationships(authorization, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_customers_business_relationships_with_http_info(authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.get_customers_business_relationships_with_http_info(authorization, **kwargs)  # noqa: E501
            return data

    def get_customers_business_relationships_with_http_info(self, authorization, **kwargs):  # noqa: E501
        """Obtém os registros de relacionamentos com a instituição financeira e de representantes da pessoa jurídica.  # noqa: E501

        Método para obter registros de relacionamentos com a instituição financeira e de representantes da pessoa jurídica mantidos na instituição transmissora.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customers_business_relationships_with_http_info(authorization, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_customers_business_relationships" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `get_customers_business_relationships`")  # noqa: E501
    ...
    def get_customers_personal_identifications(self, authorization, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customers_personal_identifications(authorization, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_customers_personal_identifications_with_http_info(authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.get_customers_personal_identifications_with_http_info(authorization, **kwargs)  # noqa: E501
            return data

    def get_customers_personal_identifications_with_http_info(self, authorization, **kwargs):  # noqa: E501
        """Obtém os registros de identificação da pessoa natural.  # noqa: E501

        Método para obter os registros de identificação da pessoa natural mantidos na instituição transmissora.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customers_personal_identifications_with_http_info(authorization, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_customers_personal_identifications" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `get_customers_personal_identifications`")  # noqa: E501
    ...
    def get_customers_personal_qualifications(self, authorization, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customers_personal_qualifications(authorization, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_customers_personal_qualifications_with_http_info(authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.get_customers_personal_qualifications_with_http_info(authorization, **kwargs)  # noqa: E501
            return data

    def get_customers_personal_qualifications_with_http_info(self, authorization, **kwargs):  # noqa: E501
        """Obtém os registros de qualificação da pessoa natural.  # noqa: E501

        Método para obter os registros de qualificação da pessoa natural mantidos na instituição transmissora.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customers_personal_qualifications_with_http_info(authorization, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_customers_personal_qualifications" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `get_customers_personal_qualifications`")  # noqa: E501
    ...
    def get_customers_personal_relationships(self, authorization, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customers_personal_relationships(authorization, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_customers_personal_relationships_with_http_info(authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.get_customers_personal_relationships_with_http_info(authorization, **kwargs)  # noqa: E501
            return data

    def get_customers_personal_relationships_with_http_info(self, authorization, **kwargs):  # noqa: E501
        """Obtém os registros de relacionamentos com a instituição financeira e de representantes da pessoa natural.  # noqa: E501

        Método para obter registros de relacionamentos com a instituição financeira e de representantes da pessoa natural mantidos na instituição transmissora.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customers_personal_relationships_with_http_info(authorization, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_customers_personal_relationships" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `get_customers_personal_relationships`")  # noqa: E501
