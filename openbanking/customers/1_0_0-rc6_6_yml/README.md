...
------------ | ------------- | ------------- | -------------
*CustomersApi* | [**get_customers_business_identifications**](docs/CustomersApi.md#get_customers_business_identifications) | **GET** /business/identifications | Obtém os registros de identificação da pessoa jurídica.
*CustomersApi* | [**get_customers_business_qualifications**](docs/CustomersApi.md#get_customers_business_qualifications) | **GET** /business/qualifications | Obtém os registros de qualificação da pessoa jurídica.
*CustomersApi* | [**get_customers_business_relationships**](docs/CustomersApi.md#get_customers_business_relationships) | **GET** /business/financial-relations | Obtém os registros de relacionamentos com a instituição financeira e de representantes da pessoa jurídica.
*CustomersApi* | [**get_customers_personal_identifications**](docs/CustomersApi.md#get_customers_personal_identifications) | **GET** /personal/identifications | Obtém os registros de identificação da pessoa natural.
*CustomersApi* | [**get_customers_personal_qualifications**](docs/CustomersApi.md#get_customers_personal_qualifications) | **GET** /personal/qualifications | Obtém os registros de qualificação da pessoa natural.
*CustomersApi* | [**get_customers_personal_relationships**](docs/CustomersApi.md#get_customers_personal_relationships) | **GET** /personal/financial-relations | Obtém os registros de relacionamentos com a instituição financeira e de representantes da pessoa natural.
