...
class PersonalQualificationData(object):
    ...
    swagger_types = {
        ...
        'informed_income': 'PersonalQualificationDataInformedIncome',
    ...
    def occupation_description(self):
        ...
        Campo livre, de preenchimento obrigatório. Traz o código da ocupação ou o descritivo da ocupação, se selecionada a opção 'OUTRO'  # noqa: E501
    ...
    def occupation_description(self, occupation_description):
        ...
        :type: str
        """
        if occupation_description is None:
            raise ValueError("Invalid value for `occupation_description`, must not be `None`")  # noqa: E501
    ...
    def informed_income(self):
        ...
        :rtype: PersonalQualificationDataInformedIncome
        """
    ...
    def informed_income(self, informed_income):
        ...
        :type: PersonalQualificationDataInformedIncome
        """
        if informed_income is None:
            raise ValueError("Invalid value for `informed_income`, must not be `None`")  # noqa: E501
