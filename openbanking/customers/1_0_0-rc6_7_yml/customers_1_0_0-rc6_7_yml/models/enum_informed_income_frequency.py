...
class EnumInformedIncomeFrequency(object):
    ...
    SEMESTRAL = "SEMESTRAL"
    ANUAL = "ANUAL"
    SEM_FREQUENCIA_RENDA_INFORMADA = "SEM_FREQUENCIA_RENDA_INFORMADA"
    OUTROS = "OUTROS"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """EnumInformedIncomeFrequency - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumInformedIncomeFrequency, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumInformedIncomeFrequency):
            return False
