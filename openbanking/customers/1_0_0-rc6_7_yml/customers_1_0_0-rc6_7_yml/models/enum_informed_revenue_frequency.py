...
class EnumInformedRevenueFrequency(object):
    ...
    SEMESTRAL = "SEMESTRAL"
    ANUAL = "ANUAL"
    SEM_FREQUENCIA_FATURAMENTO_INFORMADO = "SEM_FREQUENCIA_FATURAMENTO_INFORMADO"
    OUTROS = "OUTROS"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """EnumInformedRevenueFrequency - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumInformedRevenueFrequency, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumInformedRevenueFrequency):
            return False
