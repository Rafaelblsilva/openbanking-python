...
class BusinessFinancialRelationData(object):
    ...
    swagger_types = {
        ...
        'procurators': 'list[BusinessProcurator]',
    ...
    def __init__(self, update_date_time=None, start_date=None, products_services_type=None, procurators=None, accounts=None):  # noqa: E501
        """BusinessFinancialRelationData - a model defined in Swagger"""  # noqa: E501
    ...
    def update_date_time(self):
        """Gets the update_date_time of this BusinessFinancialRelationData.  # noqa: E501
        ...
        :return: The update_date_time of this BusinessFinancialRelationData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def update_date_time(self, update_date_time):
        """Sets the update_date_time of this BusinessFinancialRelationData.

        Data e hora da atualização dos campos \\<_endpoint_\\>, conforme especificação RFC-3339, formato UTC. Quando não existente uma data vinculada especificamente ao bloco, assumir a data e hora de atualização do cadastro como um todo.   # noqa: E501

        :param update_date_time: The update_date_time of this BusinessFinancialRelationData.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def start_date(self):
        """Gets the start_date of this BusinessFinancialRelationData.  # noqa: E501
        ...
        :return: The start_date of this BusinessFinancialRelationData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_date(self, start_date):
        """Sets the start_date of this BusinessFinancialRelationData.

        Data de início de relacionamento com a Instituição Financeira. Deve trazer o menor valor entre a informação reportada ao BACEN pelo DOC 3040 e CCS.  # noqa: E501

        :param start_date: The start_date of this BusinessFinancialRelationData.  # noqa: E501
        :type: datetime
        """
    ...
    def products_services_type(self):
        """Gets the products_services_type of this BusinessFinancialRelationData.  # noqa: E501


        :return: The products_services_type of this BusinessFinancialRelationData.  # noqa: E501
    ...
    def products_services_type(self, products_services_type):
        """Sets the products_services_type of this BusinessFinancialRelationData.


        :param products_services_type: The products_services_type of this BusinessFinancialRelationData.  # noqa: E501
    ...
    def procurators(self):
        """Gets the procurators of this BusinessFinancialRelationData.  # noqa: E501

        Lista dos representantes. De preenchimento obrigatório se houver representante.  # noqa: E501

        :return: The procurators of this BusinessFinancialRelationData.  # noqa: E501
        :rtype: list[BusinessProcurator]
        """
        return self._procurators

    @procurators.setter
    def procurators(self, procurators):
        """Sets the procurators of this BusinessFinancialRelationData.

        Lista dos representantes. De preenchimento obrigatório se houver representante.  # noqa: E501

        :param procurators: The procurators of this BusinessFinancialRelationData.  # noqa: E501
        :type: list[BusinessProcurator]
        """
    ...
    @property
    def accounts(self):
        """Gets the accounts of this BusinessFinancialRelationData.  # noqa: E501
        ...
        :return: The accounts of this BusinessFinancialRelationData.  # noqa: E501
        :rtype: list[BusinessAccount]
        """
        return self._accounts

    @accounts.setter
    def accounts(self, accounts):
        """Sets the accounts of this BusinessFinancialRelationData.

        Lista de contas depósito à vista, poupança e pagamento pré-pagas mantidas pelo cliente na instituição transmissora.       # noqa: E501

        :param accounts: The accounts of this BusinessFinancialRelationData.  # noqa: E501
        :type: list[BusinessAccount]
        """
        if accounts is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BusinessFinancialRelationData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BusinessFinancialRelationData):
            return False
