...
class EconomicActivity(object):
    ...
    def __init__(self, code=None, is_main=None):  # noqa: E501
        """EconomicActivity - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._is_main = None
    ...
    @property
    def code(self):
        """Gets the code of this EconomicActivity.  # noqa: E501

        Traz o código do ramo da atividade principal da empresa consultada, segundo padrão CNAE (Classificação Nacional de Atividades Econômicas)   # noqa: E501

        :return: The code of this EconomicActivity.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this EconomicActivity.

        Traz o código do ramo da atividade principal da empresa consultada, segundo padrão CNAE (Classificação Nacional de Atividades Econômicas)   # noqa: E501

        :param code: The code of this EconomicActivity.  # noqa: E501
        :type: str
        """
        if code is None:
    ...
    @property
    def is_main(self):
        """Gets the is_main of this EconomicActivity.  # noqa: E501

        Indica se é o ramo principal de atividade da empresa quando true e se é o ramo secundário quando false. [Restrição] Somente uma ocorrência relativa ao código da atividade econômica principal deve trazer o valor true.  # noqa: E501

        :return: The is_main of this EconomicActivity.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_main(self, is_main):
        """Sets the is_main of this EconomicActivity.

        Indica se é o ramo principal de atividade da empresa quando true e se é o ramo secundário quando false. [Restrição] Somente uma ocorrência relativa ao código da atividade econômica principal deve trazer o valor true.  # noqa: E501

        :param is_main: The is_main of this EconomicActivity.  # noqa: E501
        :type: bool
        """
        if is_main is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EconomicActivity, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EconomicActivity):
            return False
