...
class PersonalProcurator(object):
    ...
    """
    swagger_types = {
        'type': 'EnumProcuratorsTypePersonal',
        'cpf_number': 'str',
        'civil_name': 'str',
        'social_name': 'str'
    }
    ...
    def __init__(self, type=None, cpf_number=None, civil_name=None, social_name=None):  # noqa: E501
        """PersonalProcurator - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this PersonalProcurator.  # noqa: E501


        :return: The type of this PersonalProcurator.  # noqa: E501
        :rtype: EnumProcuratorsTypePersonal
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this PersonalProcurator.


        :param type: The type of this PersonalProcurator.  # noqa: E501
        :type: EnumProcuratorsTypePersonal
        """
        if type is None:
    ...
    @property
    def cpf_number(self):
        """Gets the cpf_number of this PersonalProcurator.  # noqa: E501

        Número completo do CPF. O CPF é o Cadastro de Pessoa natural. Ele é um documento feito pela Receita Federal e serve para identificar os contribuintes. O CPF é uma numeração com 11 dígitos, que só mudam por decisão judicial. O documento é emitido pela receita federal  # noqa: E501

        :return: The cpf_number of this PersonalProcurator.  # noqa: E501
        :rtype: str
        """
    ...
    def cpf_number(self, cpf_number):
        """Sets the cpf_number of this PersonalProcurator.

        Número completo do CPF. O CPF é o Cadastro de Pessoa natural. Ele é um documento feito pela Receita Federal e serve para identificar os contribuintes. O CPF é uma numeração com 11 dígitos, que só mudam por decisão judicial. O documento é emitido pela receita federal  # noqa: E501

        :param cpf_number: The cpf_number of this PersonalProcurator.  # noqa: E501
        :type: str
        """
    ...
    @property
    def civil_name(self):
        """Gets the civil_name of this PersonalProcurator.  # noqa: E501
        ...
        :return: The civil_name of this PersonalProcurator.  # noqa: E501
        :rtype: str
        """
    ...
    def civil_name(self, civil_name):
        """Sets the civil_name of this PersonalProcurator.

        Nome civil completo da pessoa natural. (Direito fundamental da pessoa, o nome civil é aquele atribuído à pessoa natural desde o registro de seu nascimento, com o qual será identificada por toda a sua vida, bem como após a sua morte)  # noqa: E501

        :param civil_name: The civil_name of this PersonalProcurator.  # noqa: E501
        :type: str
        """
    ...
    def social_name(self):
        """Gets the social_name of this PersonalProcurator.  # noqa: E501

        Nome social da pessoa natural, se houver. (aquele pelo qual travestis e transexuais se reconhecem, bem como são identificados por sua comunidade e em seu meio social, conforme Decreto Nº 51.180, de 14 de janeiro de 2010)  # noqa: E501

        :return: The social_name of this PersonalProcurator.  # noqa: E501
        :rtype: str
        """
    ...
    def social_name(self, social_name):
        """Sets the social_name of this PersonalProcurator.

        Nome social da pessoa natural, se houver. (aquele pelo qual travestis e transexuais se reconhecem, bem como são identificados por sua comunidade e em seu meio social, conforme Decreto Nº 51.180, de 14 de janeiro de 2010)  # noqa: E501

        :param social_name: The social_name of this PersonalProcurator.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PersonalProcurator, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PersonalProcurator):
            return False
