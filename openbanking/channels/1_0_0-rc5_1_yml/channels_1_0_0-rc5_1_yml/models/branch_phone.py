...
import six
from channels_1_0_0-rc5_1_yml.models.phone import Phone  # noqa: F401,E501

class BranchPhone(Phone):
    ...
    if hasattr(Phone, "swagger_types"):
        swagger_types.update(Phone.swagger_types)

    attribute_map = {
    }
    if hasattr(Phone, "attribute_map"):
        attribute_map.update(Phone.attribute_map)
