...
class BranchServices(object):
    ...
    @property
    def name(self):
        """Gets the name of this BranchServices.  # noqa: E501


        :return: The name of this BranchServices.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this BranchServices.


        :param name: The name of this BranchServices.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def code(self):
        """Gets the code of this BranchServices.  # noqa: E501


        :return: The code of this BranchServices.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this BranchServices.


        :param code: The code of this BranchServices.  # noqa: E501
        :type: str
        """
        if code is None:
    ...
    def additional_info(self):
        ...
        Texto livre para complementar informação relativa ao Serviço disponível, quando for selecionada a opção p preenchida a opção 'OUTROS_PRODUTOS_SERVICOS'  # noqa: E501
