...
class BranchService(object):
    ...
    def __init__(self, name=None, code=None, additional_info=None):  # noqa: E501
        """BranchService - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._code = None
    ...
    @property
    def name(self):
        """Gets the name of this BranchService.  # noqa: E501

        Nome dos Serviços efetivamente prestados pelo Canal de Atendimento  # noqa: E501

        :return: The name of this BranchService.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this BranchService.

        Nome dos Serviços efetivamente prestados pelo Canal de Atendimento  # noqa: E501

        :param name: The name of this BranchService.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def code(self):
        """Gets the code of this BranchService.  # noqa: E501

        Código dos Serviços efetivamente prestados pelo Canal de Atendimento  # noqa: E501

        :return: The code of this BranchService.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this BranchService.

        Código dos Serviços efetivamente prestados pelo Canal de Atendimento  # noqa: E501

        :param code: The code of this BranchService.  # noqa: E501
        :type: str
        """
        if code is None:
    ...
    def additional_info(self):
        """Gets the additional_info of this BranchService.  # noqa: E501
        ...
        :return: The additional_info of this BranchService.  # noqa: E501
        :rtype: str
        """
    ...
    def additional_info(self, additional_info):
        """Sets the additional_info of this BranchService.

        Texto livre para complementar informação relativa ao Serviço disponível, quando for selecionada a opção 'OUTROS_PRODUTOS_SERVICOS'  # noqa: E501

        :param additional_info: The additional_info of this BranchService.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BranchService, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BranchService):
            return False
