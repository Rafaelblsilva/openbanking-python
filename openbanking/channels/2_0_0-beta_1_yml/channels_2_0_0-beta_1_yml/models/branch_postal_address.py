...
class BranchPostalAddress(object):
    ...
    def __init__(self, address=None, additional_info=None, district_name=None, town_name=None, ibge_code=None, country_sub_division=None, post_code=None, country=None, country_code=None, geographic_coordinates=None):  # noqa: E501
        """BranchPostalAddress - a model defined in Swagger"""  # noqa: E501
        self._address = None
    ...
    @property
    def address(self):
        """Gets the address of this BranchPostalAddress.  # noqa: E501
        ...
        :return: The address of this BranchPostalAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def address(self, address):
        """Sets the address of this BranchPostalAddress.

        Deverá trazer toda a informação referente ao endereço da dependência informada: Tipo de logradouro + Nome do logradouro + Número do Logradouro (se não existir usar ' s/n') + complemento (se houver), como, p.ex.: 'R Diamatina, 59, bloco 35, fundos' 'Praça da Boa Vontade s/n'  # noqa: E501

        :param address: The address of this BranchPostalAddress.  # noqa: E501
        :type: str
        """
        if address is None:
    ...
    def additional_info(self):
        """Gets the additional_info of this BranchPostalAddress.  # noqa: E501

        Alguns logradouros ainda necessitam ser especificados por meio de complemento  # noqa: E501

        :return: The additional_info of this BranchPostalAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def additional_info(self, additional_info):
        """Sets the additional_info of this BranchPostalAddress.

        Alguns logradouros ainda necessitam ser especificados por meio de complemento  # noqa: E501

        :param additional_info: The additional_info of this BranchPostalAddress.  # noqa: E501
        :type: str
        """
    ...
    def district_name(self):
        """Gets the district_name of this BranchPostalAddress.  # noqa: E501
        ...
        :return: The district_name of this BranchPostalAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def district_name(self, district_name):
        """Sets the district_name of this BranchPostalAddress.

        Bairro é uma comunidade ou região localizada em uma cidade ou município de acordo com as suas subdivisões geográficas. p.ex: 'Paraíso'  # noqa: E501

        :param district_name: The district_name of this BranchPostalAddress.  # noqa: E501
        :type: str
        """
    ...
    @property
    def town_name(self):
        """Gets the town_name of this BranchPostalAddress.  # noqa: E501
        ...
        :return: The town_name of this BranchPostalAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def town_name(self, town_name):
        """Sets the town_name of this BranchPostalAddress.

        Localidade: O nome da localidade corresponde à designação da cidade ou município no qual o endereço está localizado. p.ex. 'São Paulo'  # noqa: E501

        :param town_name: The town_name of this BranchPostalAddress.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ibge_code(self):
        """Gets the ibge_code of this BranchPostalAddress.  # noqa: E501

        Código IBGE do município  # noqa: E501

        :return: The ibge_code of this BranchPostalAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def ibge_code(self, ibge_code):
        """Sets the ibge_code of this BranchPostalAddress.

        Código IBGE do município  # noqa: E501

        :param ibge_code: The ibge_code of this BranchPostalAddress.  # noqa: E501
        :type: str
        """
    ...
    def country_sub_division(self):
        """Gets the country_sub_division of this BranchPostalAddress.  # noqa: E501
        ...
        :return: The country_sub_division of this BranchPostalAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def country_sub_division(self, country_sub_division):
        """Sets the country_sub_division of this BranchPostalAddress.

        Enumeração referente a cada sigla da unidade da federação que identifica o estado ou o distrito federal, no qual o endereço está localizado. p.ex. 'AC'. São consideradas apenas as siglas para os estados brasileiros  # noqa: E501

        :param country_sub_division: The country_sub_division of this BranchPostalAddress.  # noqa: E501
        :type: str
        """
    ...
    @property
    def post_code(self):
        """Gets the post_code of this BranchPostalAddress.  # noqa: E501

        Código de Endereçamento Postal  # noqa: E501

        :return: The post_code of this BranchPostalAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def post_code(self, post_code):
        """Sets the post_code of this BranchPostalAddress.

        Código de Endereçamento Postal  # noqa: E501

        :param post_code: The post_code of this BranchPostalAddress.  # noqa: E501
        :type: str
        """
    ...
    @property
    def country(self):
        """Gets the country of this BranchPostalAddress.  # noqa: E501

        Nome do país  # noqa: E501

        :return: The country of this BranchPostalAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def country(self, country):
        """Sets the country of this BranchPostalAddress.

        Nome do país  # noqa: E501

        :param country: The country of this BranchPostalAddress.  # noqa: E501
        :type: str
        """
    ...
    def country_code(self):
        """Gets the country_code of this BranchPostalAddress.  # noqa: E501

        Código do país de acordo com a ISO 3166-1 alpha-3  # noqa: E501

        :return: The country_code of this BranchPostalAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def country_code(self, country_code):
        """Sets the country_code of this BranchPostalAddress.

        Código do país de acordo com a ISO 3166-1 alpha-3  # noqa: E501

        :param country_code: The country_code of this BranchPostalAddress.  # noqa: E501
        :type: str
        """
    ...
    def geographic_coordinates(self):
        """Gets the geographic_coordinates of this BranchPostalAddress.  # noqa: E501


        :return: The geographic_coordinates of this BranchPostalAddress.  # noqa: E501
    ...
    def geographic_coordinates(self, geographic_coordinates):
        """Sets the geographic_coordinates of this BranchPostalAddress.


        :param geographic_coordinates: The geographic_coordinates of this BranchPostalAddress.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BranchPostalAddress, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BranchPostalAddress):
            return False
