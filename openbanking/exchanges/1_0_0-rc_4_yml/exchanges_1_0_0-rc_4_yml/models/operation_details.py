...
class OperationDetails(object):
    ...
    swagger_types = {
        ...
        'intermediary_institution_name': 'str',
    ...
    def __init__(self, authorized_institution_cnpj_number=None, authorized_institution_name=None, intermediary_institution_cnpj_number=None, intermediary_institution_name=None, operation_number=None, operation_type=None, operation_date=None, due_date=None, local_currency_operation_tax=None, local_currency_operation_value=None, foreign_operation_value=None, operation_outstanding_balance=None, vet_amount=None, local_currency_advance_percentage=None, delivery_foreign_currency=None, operation_category_code=None):  # noqa: E501
        ...
        self._intermediary_institution_name = None
        ...
        if intermediary_institution_name is not None:
            self.intermediary_institution_name = intermediary_institution_name
    ...
    @property
    def intermediary_institution_name(self):
        """Gets the intermediary_institution_name of this OperationDetails.  # noqa: E501
        ...
        :return: The intermediary_institution_name of this OperationDetails.  # noqa: E501
        :rtype: str
        """
        return self._intermediary_institution_name

    @intermediary_institution_name.setter
    def intermediary_institution_name(self, intermediary_institution_name):
        """Sets the intermediary_institution_name of this OperationDetails.

        Nome da corretora interveniente autorizada a operar no mercado de câmbio.  [Restrição] Campo de preenchimento obrigatório pelas participantes quando o campo 'intermediaryInstitutionCnpjNumber' for informado.   # noqa: E501

        :param intermediary_institution_name: The intermediary_institution_name of this OperationDetails.  # noqa: E501
        :type: str
        """

        self._intermediary_institution_name = intermediary_institution_name
