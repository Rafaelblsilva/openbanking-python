...
class LinksOperationId(object):
    ...
    def __init__(self, _self=None):  # noqa: E501
        """LinksOperationId - a model defined in Swagger"""  # noqa: E501
        self.__self = None
    ...
    @property
    def _self(self):
        """Gets the _self of this LinksOperationId.  # noqa: E501

        URI completo que gerou a resposta atual.  # noqa: E501

        :return: The _self of this LinksOperationId.  # noqa: E501
        :rtype: str
        """
        return self.__self
    ...
    def _self(self, _self):
        """Sets the _self of this LinksOperationId.

        URI completo que gerou a resposta atual.  # noqa: E501

        :param _self: The _self of this LinksOperationId.  # noqa: E501
        :type: str
        """
        if _self is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinksOperationId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinksOperationId):
            return False
