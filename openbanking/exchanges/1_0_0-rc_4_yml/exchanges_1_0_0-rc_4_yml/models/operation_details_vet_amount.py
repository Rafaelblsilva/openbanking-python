...
class OperationDetailsVetAmount(object):
    ...
    def __init__(self, amount=None, currency=None):  # noqa: E501
        """OperationDetailsVetAmount - a model defined in Swagger"""  # noqa: E501
        self._amount = None
        self._currency = None
    ...
    @property
    def amount(self):
        """Gets the amount of this OperationDetailsVetAmount.  # noqa: E501

        Valor relacionado ao objeto.  # noqa: E501

        :return: The amount of this OperationDetailsVetAmount.  # noqa: E501
        :rtype: str
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this OperationDetailsVetAmount.

        Valor relacionado ao objeto.  # noqa: E501

        :param amount: The amount of this OperationDetailsVetAmount.  # noqa: E501
        :type: str
        """
        if amount is None:
    ...
    @property
    def currency(self):
        """Gets the currency of this OperationDetailsVetAmount.  # noqa: E501

        Moeda referente ao valor monetário, seguindo o modelo ISO-4217.  # noqa: E501

        :return: The currency of this OperationDetailsVetAmount.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this OperationDetailsVetAmount.

        Moeda referente ao valor monetário, seguindo o modelo ISO-4217.  # noqa: E501

        :param currency: The currency of this OperationDetailsVetAmount.  # noqa: E501
        :type: str
        """
        if currency is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OperationDetailsVetAmount, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OperationDetailsVetAmount):
            return False
