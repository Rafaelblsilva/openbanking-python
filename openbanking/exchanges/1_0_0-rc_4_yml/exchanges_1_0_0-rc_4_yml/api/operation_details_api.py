...
class OperationDetailsApi(object):
    ...
    def exchanges_get_operations_operation_id(self, operation_id, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        """Obtém os dados da operação de Câmbio identificada por operationId.  # noqa: E501

        Obtém os dados da operação de Câmbio identificada por operationId.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exchanges_get_operations_operation_id(operation_id, authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: OKResponseOperationDetails
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.exchanges_get_operations_operation_id_with_http_info(operation_id, authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
        else:
            (data) = self.exchanges_get_operations_operation_id_with_http_info(operation_id, authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
            return data

    def exchanges_get_operations_operation_id_with_http_info(self, operation_id, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        """Obtém os dados da operação de Câmbio identificada por operationId.  # noqa: E501

        Obtém os dados da operação de Câmbio identificada por operationId.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exchanges_get_operations_operation_id_with_http_info(operation_id, authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['operation_id', 'authorization', 'x_fapi_interaction_id', 'x_fapi_auth_date', 'x_fapi_customer_ip_address', 'x_customer_user_agent']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method exchanges_get_operations_operation_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('operation_id' not in params or
            ...
            raise ValueError("Missing the required parameter `operation_id` when calling `exchanges_get_operations_operation_id`")  # noqa: E501
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `exchanges_get_operations_operation_id`")  # noqa: E501
        ...
        if ('x_fapi_interaction_id' not in params or
            ...
            raise ValueError("Missing the required parameter `x_fapi_interaction_id` when calling `exchanges_get_operations_operation_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='OKResponseOperationDetails',  # noqa: E501
