...
class OperationDetailsForeignPartie(object):
    ...
    def __init__(self, relationship_code=None, foreign_partie_name=None, foreign_partie_country_code=None):  # noqa: E501
        """OperationDetailsForeignPartie - a model defined in Swagger"""  # noqa: E501
    ...
    def relationship_code(self):
        """Gets the relationship_code of this OperationDetailsForeignPartie.  # noqa: E501
        ...
        :return: The relationship_code of this OperationDetailsForeignPartie.  # noqa: E501
        :rtype: str
        """
    ...
    def relationship_code(self, relationship_code):
        """Sets the relationship_code of this OperationDetailsForeignPartie.

        Código de Relação de vínculo entre o Cliente e o Pagador/Recebedor no Exterior. Deve respeitar os códigos de vínculo referenciados na resolução 277 ou na Circular 3690, conforme se aplicar ao contrato de câmbio.   # noqa: E501

        :param relationship_code: The relationship_code of this OperationDetailsForeignPartie.  # noqa: E501
        :type: str
        """
    ...
    def foreign_partie_name(self):
        """Gets the foreign_partie_name of this OperationDetailsForeignPartie.  # noqa: E501

        Nome do pagador ou recebedor no exterior.   # noqa: E501

        :return: The foreign_partie_name of this OperationDetailsForeignPartie.  # noqa: E501
        :rtype: str
        """
    ...
    def foreign_partie_name(self, foreign_partie_name):
        """Sets the foreign_partie_name of this OperationDetailsForeignPartie.

        Nome do pagador ou recebedor no exterior.   # noqa: E501

        :param foreign_partie_name: The foreign_partie_name of this OperationDetailsForeignPartie.  # noqa: E501
        :type: str
        """
    ...
    def foreign_partie_country_code(self):
        """Gets the foreign_partie_country_code of this OperationDetailsForeignPartie.  # noqa: E501

        País do pagador ou recebedor. Código do país segundo a norma ISO 3166-1.   # noqa: E501

        :return: The foreign_partie_country_code of this OperationDetailsForeignPartie.  # noqa: E501
        :rtype: str
        """
    ...
    def foreign_partie_country_code(self, foreign_partie_country_code):
        """Sets the foreign_partie_country_code of this OperationDetailsForeignPartie.

        País do pagador ou recebedor. Código do país segundo a norma ISO 3166-1.   # noqa: E501

        :param foreign_partie_country_code: The foreign_partie_country_code of this OperationDetailsForeignPartie.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OperationDetailsForeignPartie, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OperationDetailsForeignPartie):
            return False
