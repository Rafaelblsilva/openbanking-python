...
class OperationDetails(object):
    ...
    def foreign_partie(self):
        """Gets the foreign_partie of this OperationDetails.  # noqa: E501
        ...
        :return: The foreign_partie of this OperationDetails.  # noqa: E501
    ...
    def foreign_partie(self, foreign_partie):
        """Sets the foreign_partie of this OperationDetails.

        Lista para envio de informações de parte envolvida.  [Restrição] Lista de preenchimento opcional pelas participantes quando o campo 'deliveryForeignCurrency ' for igual EM ESPÉCIE E/OU CHEQUES DE VIAGEM.  Caso a instituição possua a informação, ela é de envio obrigatório.  Caso a informação seja atualizada posteriormente a contratação, ela deve ser enviada através de eventos.   # noqa: E501

        :param foreign_partie: The foreign_partie of this OperationDetails.  # noqa: E501
