...
from exchanges_1_0_0-rc2_0_yml.api.operation_details_api import OperationDetailsApi  # noqa: E501
from exchanges_1_0_0-rc2_0_yml.rest import ApiException


class TestOperationDetailsApi(unittest.TestCase):
    """OperationDetailsApi unit test stubs"""

    def setUp(self):
        self.api = OperationDetailsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_exchanges_get_operations_operation_id(self):
        """Test case for exchanges_get_operations_operation_id
