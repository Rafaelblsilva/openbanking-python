...
from exchanges_1_0_0-rc2_0_yml.api.product_list_api import ProductListApi  # noqa: E501
...
class TestProductListApi(unittest.TestCase):
    ...
    def test_exchanges_get_operations(self):
        """Test case for exchanges_get_operations
