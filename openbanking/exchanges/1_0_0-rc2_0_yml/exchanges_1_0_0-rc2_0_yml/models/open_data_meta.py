...
class OpenDataMeta(object):
    ...
    def __init__(self, total_records=None, total_pages=None, request_date_time=None):  # noqa: E501
        """OpenDataMeta - a model defined in Swagger"""  # noqa: E501
    ...
    def total_records(self):
        """Gets the total_records of this OpenDataMeta.  # noqa: E501

        Número total de registros no resultado  # noqa: E501

        :return: The total_records of this OpenDataMeta.  # noqa: E501
        :rtype: int
        """
    ...
    def total_records(self, total_records):
        """Sets the total_records of this OpenDataMeta.

        Número total de registros no resultado  # noqa: E501

        :param total_records: The total_records of this OpenDataMeta.  # noqa: E501
        :type: int
        """
    ...
    def total_pages(self):
        """Gets the total_pages of this OpenDataMeta.  # noqa: E501

        Número total de páginas no resultado  # noqa: E501

        :return: The total_pages of this OpenDataMeta.  # noqa: E501
        :rtype: int
        """
    ...
    def total_pages(self, total_pages):
        """Sets the total_pages of this OpenDataMeta.

        Número total de páginas no resultado  # noqa: E501

        :param total_pages: The total_pages of this OpenDataMeta.  # noqa: E501
        :type: int
        """
    ...
    def request_date_time(self):
        """Gets the request_date_time of this OpenDataMeta.  # noqa: E501

        Data e hora da consulta, conforme especificação RFC-3339, formato UTC.  # noqa: E501

        :return: The request_date_time of this OpenDataMeta.  # noqa: E501
        :rtype: datetime
        """
    ...
    def request_date_time(self, request_date_time):
        """Sets the request_date_time of this OpenDataMeta.

        Data e hora da consulta, conforme especificação RFC-3339, formato UTC.  # noqa: E501

        :param request_date_time: The request_date_time of this OpenDataMeta.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OpenDataMeta, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OpenDataMeta):
            return False
