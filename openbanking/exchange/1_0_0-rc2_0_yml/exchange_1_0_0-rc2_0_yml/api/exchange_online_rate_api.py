...
class ExchangeOnlineRateApi(object):
    ...
    def exchange_get_online_rate(self, **kwargs):  # noqa: E501
        ...
        :return: OKResponseExchangeOnlineRate
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.exchange_get_online_rate_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.exchange_get_online_rate_with_http_info(**kwargs)  # noqa: E501
            return data

    def exchange_get_online_rate_with_http_info(self, **kwargs):  # noqa: E501
        """Conjunto de informações de Câmbio para taxa online.  # noqa: E501

        As instituições autorizadas a operar em câmbio que disponibilizam em seus canais digitais a possibilidade de contratação ou a informação de taxa de câmbio devem retornar as condições no momento da consulta, sendo admitida uma defasagem máxima de atualização de 5 minutos em relação a seus canais digitais.  Já as demais instituições participantes do Open Finance autorizadas a operar em câmbio podem adotar as janelas de consulta da PTAX como frequência mínima de atualização das informações retornadas neste serviço.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exchange_get_online_rate_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method exchange_get_online_rate" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='OKResponseExchangeOnlineRate',  # noqa: E501
