...
class Model422ResponseErrorCreateConsentErrors(object):
    ...
    def code(self, code):
        ...
        allowed_values = ["FORMA_PAGAMENTO_INVALIDA", "DATA_PAGAMENTO_INVALIDA", "DETALHE_PGTO_INVALIDO", "PARAMETRO_NAO_INFORMADO", "PARAMETRO_INVALIDO", "ERRO_IDEMPOTENCIA", "NAO_INFORMADO"]  # noqa: E501
