...
class CreatePixPaymentData(object):
    ...
    swagger_types = {
        ...
        'proxy': 'str',
        'cnpj_initiator': 'str',
        'transaction_identification': 'object',
        'ibge_town_code': 'str'
    }
    ...
    def __init__(self, local_instrument=None, payment=None, creditor_account=None, remittance_information=None, qr_code=None, proxy=None, cnpj_initiator=None, transaction_identification=None, ibge_town_code=None):  # noqa: E501
    ...
    def local_instrument(self):
        ...
        Especifica a forma de iniciação do pagamento: - MANU - Inserção manual de dados da conta transacional - DICT - Inserção manual de chave Pix - QRDN - QR code dinâmico - QRES - QR code estático - INIC - Indica que o recebedor (creditor) contratou o Iniciador de Pagamentos especificamente para realizar iniciações de pagamento em que o beneficiário é previamente conhecido.   # noqa: E501
    ...
    def local_instrument(self, local_instrument):
        ...
        allowed_values = ["MANU", "DICT", "QRDN", "QRES", "INIC"]  # noqa: E501
