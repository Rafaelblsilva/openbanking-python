...
class EnumErrorsCreateConsent(object):
    ...
    allowed enum values
    """
    FORMA_PGTO_INVALIDA = "FORMA_PGTO_INVALIDA"
    DATA_PGTO_INVALIDA = "DATA_PGTO_INVALIDA"
    DETALHE_PGTO_INVALIDO = "DETALHE_PGTO_INVALIDO"
    ...
    def __init__(self):  # noqa: E501
        """EnumErrorsCreateConsent - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumErrorsCreateConsent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumErrorsCreateConsent):
            return False
