...
class Model422ResponseErrorCreateConsentErrors(object):
    ...
    def code(self):
        ...
        Códigos de erros previstos na criação de consentimento para a iniciação de pagamentos:   • FORMA_PGTO_INVALIDA: Forma de pagamento inválida.   • DATA_PGTO_INVALIDA: Data de pagamento inválida.   • DETALHE_PGTO_INVALIDO: Detalhe do pagamento inválido.   • NAO_INFORMADO: Não informado.      # noqa: E501
    ...
    def code(self, code):
        ...
        allowed_values = ["FORMA_PGTO_INVALIDA", "DATA_PGTO_INVALIDA", "DETALHE_PGTO_INVALIDO", "NAO_INFORMADO"]  # noqa: E501
