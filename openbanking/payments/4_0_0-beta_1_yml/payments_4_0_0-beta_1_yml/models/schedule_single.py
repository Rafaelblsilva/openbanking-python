...
class ScheduleSingle(object):
    ...
    @property
    def single(self):
        """Gets the single of this ScheduleSingle.  # noqa: E501


        :return: The single of this ScheduleSingle.  # noqa: E501
        :rtype: ScheduleSingleSingle
        """
        return self._single

    @single.setter
    def single(self, single):
        """Sets the single of this ScheduleSingle.


        :param single: The single of this ScheduleSingle.  # noqa: E501
        :type: ScheduleSingleSingle
        """
        if single is None:
