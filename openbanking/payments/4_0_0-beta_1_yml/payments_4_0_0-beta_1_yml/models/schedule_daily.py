...
class ScheduleDaily(object):
    ...
    def __init__(self, daily=None):  # noqa: E501
        """ScheduleDaily - a model defined in Swagger"""  # noqa: E501
        self._daily = None
    ...
    @property
    def daily(self):
        """Gets the daily of this ScheduleDaily.  # noqa: E501


        :return: The daily of this ScheduleDaily.  # noqa: E501
        :rtype: ScheduleDailyDaily
        """
        return self._daily

    @daily.setter
    def daily(self, daily):
        """Sets the daily of this ScheduleDaily.


        :param daily: The daily of this ScheduleDaily.  # noqa: E501
        :type: ScheduleDailyDaily
        """
        if daily is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ScheduleDaily, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScheduleDaily):
            return False
