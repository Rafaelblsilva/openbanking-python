...
class RejectionReasonGetPix(object):
    ...
    def __init__(self, code=None, detail=None):  # noqa: E501
        """RejectionReasonGetPix - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._detail = None
    ...
    @property
    def code(self):
        """Gets the code of this RejectionReasonGetPix.  # noqa: E501


        :return: The code of this RejectionReasonGetPix.  # noqa: E501
        :rtype: EnumRejectionReasonTypeGetPix
        """
        return self._code

    @code.setter
    def code(self, code):
        """Sets the code of this RejectionReasonGetPix.


        :param code: The code of this RejectionReasonGetPix.  # noqa: E501
        :type: EnumRejectionReasonTypeGetPix
        """
        if code is None:
    ...
    @property
    def detail(self):
        """Gets the detail of this RejectionReasonGetPix.  # noqa: E501

        Contém informações adicionais ao pagamento rejeitado  # noqa: E501

        :return: The detail of this RejectionReasonGetPix.  # noqa: E501
        :rtype: str
        """
        return self._detail
    ...
    def detail(self, detail):
        """Sets the detail of this RejectionReasonGetPix.

        Contém informações adicionais ao pagamento rejeitado  # noqa: E501

        :param detail: The detail of this RejectionReasonGetPix.  # noqa: E501
        :type: str
        """
        if detail is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RejectionReasonGetPix, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RejectionReasonGetPix):
            return False
