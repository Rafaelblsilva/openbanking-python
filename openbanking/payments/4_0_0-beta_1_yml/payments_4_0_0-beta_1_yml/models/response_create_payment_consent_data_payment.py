...
class ResponseCreatePaymentConsentDataPayment(object):
    ...
    swagger_types = {
        ...
        'schedule': 'OneOfResponseCreatePaymentConsentDataPaymentSchedule',
        '_date': 'date',
        'currency': 'str',
        'amount': 'str',
        'ibge_town_code': 'str',
    ...
    def __init__(self, type=None, schedule=None, _date=None, currency=None, amount=None, ibge_town_code=None, details=None):  # noqa: E501
        """ResponseCreatePaymentConsentDataPayment - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._schedule = None
        self.__date = None
        self._currency = None
    ...
    @property
    def type(self):
        """Gets the type of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501


        :return: The type of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ResponseCreatePaymentConsentDataPayment.


        :param type: The type of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        :type: EnumPaymentType
        """
        if type is None:
    ...
    @property
    def schedule(self):
        """Gets the schedule of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501

        [Restrição] Mutuamente excludente com o campo date.   Este campo é obrigatório no caso de agendamento.   Neste caso, o campo date não deve ser informado.   # noqa: E501

        :return: The schedule of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        :rtype: OneOfResponseCreatePaymentConsentDataPaymentSchedule
        """
        return self._schedule

    @schedule.setter
    def schedule(self, schedule):
        """Sets the schedule of this ResponseCreatePaymentConsentDataPayment.

        [Restrição] Mutuamente excludente com o campo date.   Este campo é obrigatório no caso de agendamento.   Neste caso, o campo date não deve ser informado.   # noqa: E501

        :param schedule: The schedule of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        :type: OneOfResponseCreatePaymentConsentDataPaymentSchedule
        """
    ...
    @property
    def _date(self):
        """Gets the _date of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        ...
        :return: The _date of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        :rtype: date
        """
        return self.__date
    ...
    def _date(self, _date):
        """Sets the _date of this ResponseCreatePaymentConsentDataPayment.

        [Restrição] Mutuamente excludente com o objeto schedule.   Este campo é obrigatório no caso de pagamento único.   Neste caso, o objeto schedule não deve ser informado.   # noqa: E501

        :param _date: The _date of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        :type: date
        """
    ...
    @property
    def currency(self):
        """Gets the currency of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        ...
        :return: The currency of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this ResponseCreatePaymentConsentDataPayment.

        Código da moeda nacional segundo modelo ISO-4217, ou seja, 'BRL'. Todos os valores monetários informados estão representados com a moeda vigente do Brasil.   # noqa: E501

        :param currency: The currency of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        :type: str
        """
        if currency is None:
    ...
    @property
    def amount(self):
        """Gets the amount of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        ...
        :return: The amount of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        :rtype: str
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this ResponseCreatePaymentConsentDataPayment.

        Valor da transação com 2 casas decimais. O valor deve ser o mesmo enviado no consentimento.   Para QR Code estático com valor pré-determinado no QR Code ou para QR Code dinâmico com indicação de que o valor não pode ser alterado: O campo amount deve ser preenchido com o valor estabelecido no QR Code.  Caso seja preenchido com valor divergente do QR Code, deve ser retornado um erro HTTP Status 422.   # noqa: E501

        :param amount: The amount of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        :type: str
        """
        if amount is None:
    ...
    def ibge_town_code(self):
        """Gets the ibge_town_code of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        ...
        :return: The ibge_town_code of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        :rtype: str
        """
    ...
    def ibge_town_code(self, ibge_town_code):
        """Sets the ibge_town_code of this ResponseCreatePaymentConsentDataPayment.

        O campo ibgetowncode no arranjo PIX, tem o mesmo comportamento que o campo codMun descrito no item 1.6.6 do manual do PIX, conforme segue:  1. Caso a informação referente ao município não seja enviada; o PSP do recebedor assumirá que não existem feriados estaduais e municipais no período em questão;   # noqa: E501

        :param ibge_town_code: The ibge_town_code of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        :type: str
        """
    ...
    @property
    def details(self):
        """Gets the details of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501


        :return: The details of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        :rtype: Details
        """
    ...
    def details(self, details):
        """Sets the details of this ResponseCreatePaymentConsentDataPayment.


        :param details: The details of this ResponseCreatePaymentConsentDataPayment.  # noqa: E501
        :type: Details
        """
        if details is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseCreatePaymentConsentDataPayment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseCreatePaymentConsentDataPayment):
            return False
