...
class ScheduleCustomCustom(object):
    ...
    def __init__(self, dates=None, additional_information=None):  # noqa: E501
        """ScheduleCustomCustom - a model defined in Swagger"""  # noqa: E501
        self._dates = None
    ...
    @property
    def dates(self):
        """Gets the dates of this ScheduleCustomCustom.  # noqa: E501


        :return: The dates of this ScheduleCustomCustom.  # noqa: E501
        :rtype: list[date]
        """
        return self._dates
    ...
    def dates(self, dates):
        """Sets the dates of this ScheduleCustomCustom.


        :param dates: The dates of this ScheduleCustomCustom.  # noqa: E501
        :type: list[date]
        """
        if dates is None:
    ...
    def additional_information(self):
        """Gets the additional_information of this ScheduleCustomCustom.  # noqa: E501

        Texto livre para Iniciador preencher de forma compreensível pelo usuário aprovador/pagador.  O texto pode ser utilizado pelo detentor para exibição do resumo da transação durante aprovação do usuário aprovador/pagador.   # noqa: E501

        :return: The additional_information of this ScheduleCustomCustom.  # noqa: E501
        :rtype: str
        """
    ...
    def additional_information(self, additional_information):
        """Sets the additional_information of this ScheduleCustomCustom.

        Texto livre para Iniciador preencher de forma compreensível pelo usuário aprovador/pagador.  O texto pode ser utilizado pelo detentor para exibição do resumo da transação durante aprovação do usuário aprovador/pagador.   # noqa: E501

        :param additional_information: The additional_information of this ScheduleCustomCustom.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ScheduleCustomCustom, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScheduleCustomCustom):
            return False
