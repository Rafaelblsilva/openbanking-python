...
class ScheduleWeekly(object):
    ...
    def __init__(self, weekly=None):  # noqa: E501
        """ScheduleWeekly - a model defined in Swagger"""  # noqa: E501
        self._weekly = None
    ...
    @property
    def weekly(self):
        """Gets the weekly of this ScheduleWeekly.  # noqa: E501


        :return: The weekly of this ScheduleWeekly.  # noqa: E501
        :rtype: ScheduleWeeklyWeekly
        """
        return self._weekly

    @weekly.setter
    def weekly(self, weekly):
        """Sets the weekly of this ScheduleWeekly.


        :param weekly: The weekly of this ScheduleWeekly.  # noqa: E501
        :type: ScheduleWeeklyWeekly
        """
        if weekly is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ScheduleWeekly, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScheduleWeekly):
            return False
