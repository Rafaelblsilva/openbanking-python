...
class ScheduleCustom(object):
    ...
    def __init__(self, custom=None):  # noqa: E501
        """ScheduleCustom - a model defined in Swagger"""  # noqa: E501
        self._custom = None
    ...
    @property
    def custom(self):
        """Gets the custom of this ScheduleCustom.  # noqa: E501


        :return: The custom of this ScheduleCustom.  # noqa: E501
        :rtype: ScheduleCustomCustom
        """
        return self._custom

    @custom.setter
    def custom(self, custom):
        """Sets the custom of this ScheduleCustom.


        :param custom: The custom of this ScheduleCustom.  # noqa: E501
        :type: ScheduleCustomCustom
        """
        if custom is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ScheduleCustom, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScheduleCustom):
            return False
