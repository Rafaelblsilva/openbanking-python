...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host = "https://api.banco.com.br/open-banking/payments/v4"
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("payments_4_0_0-beta_1_yml")
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 4.0.0-beta.1\n"\
