...
class CreatePixPaymentData(object):
    ...
    def __init__(self, local_instrument=None, payment=None, creditor_account=None, remittance_information=None, qr_code=None, proxy=None, cnpj_initiator=None, transaction_identification=None):  # noqa: E501
