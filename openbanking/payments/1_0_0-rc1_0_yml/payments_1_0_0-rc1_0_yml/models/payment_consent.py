...
class PaymentConsent(object):
    ...
    def __init__(self, type=None, date_time=None, currency=None, amount=None):  # noqa: E501
    ...
    @property
    def date_time(self):
        """Gets the date_time of this PaymentConsent.  # noqa: E501

        Data e hora do pagamento.  Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).   # noqa: E501

        :return: The date_time of this PaymentConsent.  # noqa: E501
        :rtype: datetime
        """
    ...
    def date_time(self, date_time):
        """Sets the date_time of this PaymentConsent.

        Data e hora do pagamento.  Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).   # noqa: E501

        :param date_time: The date_time of this PaymentConsent.  # noqa: E501
        :type: datetime
        """
