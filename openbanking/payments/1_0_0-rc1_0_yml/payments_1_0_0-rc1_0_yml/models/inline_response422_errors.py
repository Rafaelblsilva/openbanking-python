...
class InlineResponse422Errors(object):
    ...
    def code(self):
        ...
        Códigos de erros previstos na criação de consentimento para a iniciação de pagamentos.   • 01 – Forma de pagamento inválida;   • 02 – Data de pagamento inválida;   • 99 – Desconhecido.     # noqa: E501
    ...
    def code(self, code):
        ...
        allowed_values = ["01", "02", "99"]  # noqa: E501
    ...
    def title(self):
        ...
        Título específico do erro reportado, de acordo com o código enviado:   • 01: Forma de pagamento inválida;   • 02: Data de pagamento inválida;   • 99: Desconhecido.          # noqa: E501
    ...
    def detail(self):
        ...
        Descrição específica do erro de acordo com o código reportado. • 01: Meio de pagamento inválido;   • 02: Data de pagamento inválida no contexto, por exemplo, data no passado.   Para pagamentos únicos deve ser informada a data atual, do dia corrente.     • 99: Não informada pela instituição detentora da conta.    # noqa: E501
