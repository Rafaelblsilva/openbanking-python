...
class CreditorAccount(object):
    ...
    def branch_code(self):
        """Gets the branch_code of this CreditorAccount.  # noqa: E501
        ...
        :return: The branch_code of this CreditorAccount.  # noqa: E501
        :rtype: str
        """
    ...
    def branch_code(self, branch_code):
        """Sets the branch_code of this CreditorAccount.

        Código da Agência detentora da conta sem dígito.   (Agência é a dependência destinada ao atendimento aos clientes, ao público em geral e aos associados de cooperativas de crédito,   no exercício de atividades da instituição, não podendo ser móvel ou transitória).   [Restrição] Preenchimento obrigatório para os seguintes tipos de conta: CACC (CONTA_DEPOSITO_A_VISTA), SVGS (CONTA_POUPANCA) e SLRY (CONTA_SALARIO).   # noqa: E501

        :param branch_code: The branch_code of this CreditorAccount.  # noqa: E501
        :type: str
        """
