...
class PagamentosApi(object):
    ...
    def payments_get_consents_consent_id_with_http_info(self, consent_id, authorization, **kwargs):  # noqa: E501
        ...
        auth_settings = ['OpenId']  # noqa: E501
    ...
    def payments_post_consents(self, body, authorization, x_idempotency_key, x_jws_signature, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.payments_post_consents(body, authorization, x_idempotency_key, x_jws_signature, async_req=True)
        >>> result = thread.get()
        ...
        :param str x_jws_signature: Cabeçalho contendo uma assinatura JWS separada do corpo do payload. (required)
        :param str x_fapi_auth_date: Data em que o usuário logou pela última vez com o receptor. Representada de acordo com a [RFC7231](https://tools.ietf.org/html/rfc7231).Exemplo: Sun, 10 Sep 2017 19:43:31 UTC
        :param str x_fapi_customer_ip_address: O endereço IP do usuário se estiver atualmente logado com o receptor.
        :param str x_fapi_interaction_id: Um UID [RFC4122](https://tools.ietf.org/html/rfc4122) usado como um ID de correlação. Se fornecido, o transmissor deve \"reproduzir\" esse valor no cabeçalho de resposta.
        :param str x_customer_user_agent: Indica o user-agent que o usuário utiliza.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.payments_post_consents_with_http_info(body, authorization, x_idempotency_key, x_jws_signature, **kwargs)  # noqa: E501
        else:
            (data) = self.payments_post_consents_with_http_info(body, authorization, x_idempotency_key, x_jws_signature, **kwargs)  # noqa: E501
            return data

    def payments_post_consents_with_http_info(self, body, authorization, x_idempotency_key, x_jws_signature, **kwargs):  # noqa: E501
        """Criar consentimento para a iniciação de pagamento.  # noqa: E501

        Método de criação do consentimento para a iniciação de pagamento.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.payments_post_consents_with_http_info(body, authorization, x_idempotency_key, x_jws_signature, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'authorization', 'x_idempotency_key', 'x_jws_signature', 'x_fapi_auth_date', 'x_fapi_customer_ip_address', 'x_fapi_interaction_id', 'x_customer_user_agent']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('x_jws_signature' not in params or
                params['x_jws_signature'] is None):
            raise ValueError("Missing the required parameter `x_jws_signature` when calling `payments_post_consents`")  # noqa: E501
    ...
    def payments_post_pix_payments(self, body, authorization, x_idempotency_key, x_jws_signature, **kwargs):  # noqa: E501
        """Criar iniciação de pagamento.  # noqa: E501

        Método para criar uma iniciação de pagamento.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.payments_post_pix_payments(body, authorization, x_idempotency_key, x_jws_signature, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.payments_post_pix_payments_with_http_info(body, authorization, x_idempotency_key, x_jws_signature, **kwargs)  # noqa: E501
        else:
            (data) = self.payments_post_pix_payments_with_http_info(body, authorization, x_idempotency_key, x_jws_signature, **kwargs)  # noqa: E501
            return data

    def payments_post_pix_payments_with_http_info(self, body, authorization, x_idempotency_key, x_jws_signature, **kwargs):  # noqa: E501
        """Criar iniciação de pagamento.  # noqa: E501

        Método para criar uma iniciação de pagamento.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.payments_post_pix_payments_with_http_info(body, authorization, x_idempotency_key, x_jws_signature, async_req=True)
        >>> result = thread.get()
        ...
        if ('x_jws_signature' not in params or
                params['x_jws_signature'] is None):
            raise ValueError("Missing the required parameter `x_jws_signature` when calling `payments_post_pix_payments`")  # noqa: E501
