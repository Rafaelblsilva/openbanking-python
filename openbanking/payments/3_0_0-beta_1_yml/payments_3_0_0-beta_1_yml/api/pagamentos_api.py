...
from payments_3_0_0-beta_1_yml.api_client import ApiClient
...
class PagamentosApi(object):
    ...
    def payments_get_consents_consent_id(self, consent_id, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        ...
        :param str x_fapi_interaction_id: Um UID [RFC4122](https://tools.ietf.org/html/rfc4122) usado como um ID de correlação. Se fornecido, o transmissor deve \"reproduzir\" esse valor no cabeçalho de resposta. (required)
