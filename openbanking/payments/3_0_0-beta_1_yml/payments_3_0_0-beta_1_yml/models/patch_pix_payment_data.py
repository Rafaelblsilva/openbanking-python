...
class PatchPixPaymentData(object):
    ...
    def __init__(self, status=None, cancellation=None):  # noqa: E501
        """PatchPixPaymentData - a model defined in Swagger"""  # noqa: E501
        self._status = None
    ...
    @property
    def status(self):
        """Gets the status of this PatchPixPaymentData.  # noqa: E501


        :return: The status of this PatchPixPaymentData.  # noqa: E501
        :rtype: EnumPaymentCancellationStatusType
        """
        return self._status

    @status.setter
    def status(self, status):
        """Sets the status of this PatchPixPaymentData.


        :param status: The status of this PatchPixPaymentData.  # noqa: E501
        :type: EnumPaymentCancellationStatusType
        """
        if status is None:
    ...
    def cancellation(self):
        """Gets the cancellation of this PatchPixPaymentData.  # noqa: E501


        :return: The cancellation of this PatchPixPaymentData.  # noqa: E501
        :rtype: PatchPixPaymentDataCancellation
        """
        return self._cancellation

    @cancellation.setter
    def cancellation(self, cancellation):
        """Sets the cancellation of this PatchPixPaymentData.


        :param cancellation: The cancellation of this PatchPixPaymentData.  # noqa: E501
        :type: PatchPixPaymentDataCancellation
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchPixPaymentData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchPixPaymentData):
            return False
