...
class ResponsePixPaymentData(object):
    ...
    swagger_types = {
        ...
        'creditor_account': 'PaymentsCreditorAccount',
        'cancellation': 'PixPaymentCancellation',
        'debtor_account': 'PaymentsDebtorAccount',
    ...
    def authorisation_flow(self):
        """Gets the authorisation_flow of this ResponsePixPaymentData.  # noqa: E501
        ...
        :return: The authorisation_flow of this ResponsePixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def authorisation_flow(self, authorisation_flow):
        """Sets the authorisation_flow of this ResponsePixPaymentData.

        Campo condicional utilizado para identificar o fluxo de autorização em que o pagamento foi solicitado.  [Restrição] Caso o campo não esteja presente no payload, subentende-se que o fluxo de autorização utilizado é o HYBRID_FLOW.   # noqa: E501

        :param authorisation_flow: The authorisation_flow of this ResponsePixPaymentData.  # noqa: E501
        :type: str
        """
