...
class PatchPixPaymentDataCancellationCancelledBy(object):
    ...
    """
    swagger_types = {
        'document': 'PatchPixPaymentDataCancellationCancelledByDocument'
    }
    ...
    def __init__(self, document=None):  # noqa: E501
        """PatchPixPaymentDataCancellationCancelledBy - a model defined in Swagger"""  # noqa: E501
        self._document = None
    ...
    @property
    def document(self):
        """Gets the document of this PatchPixPaymentDataCancellationCancelledBy.  # noqa: E501


        :return: The document of this PatchPixPaymentDataCancellationCancelledBy.  # noqa: E501
        :rtype: PatchPixPaymentDataCancellationCancelledByDocument
        """
        return self._document

    @document.setter
    def document(self, document):
        """Sets the document of this PatchPixPaymentDataCancellationCancelledBy.


        :param document: The document of this PatchPixPaymentDataCancellationCancelledBy.  # noqa: E501
        :type: PatchPixPaymentDataCancellationCancelledByDocument
        """
        if document is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchPixPaymentDataCancellationCancelledBy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchPixPaymentDataCancellationCancelledBy):
            return False
