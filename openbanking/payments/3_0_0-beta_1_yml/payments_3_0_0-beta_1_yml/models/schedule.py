...
class Schedule(object):
    ...
    def __init__(self, single=None):  # noqa: E501
    ...
    @property
    def single(self):
        """Gets the single of this Schedule.  # noqa: E501


        :return: The single of this Schedule.  # noqa: E501
        :rtype: ScheduleSingle
        """
        return self._single

    @single.setter
    def single(self, single):
        """Sets the single of this Schedule.


        :param single: The single of this Schedule.  # noqa: E501
        :type: ScheduleSingle
        """
        if single is None:
            raise ValueError("Invalid value for `single`, must not be `None`")  # noqa: E501
