...
class PatchPixPaymentDataCancellationCancelledByDocument(object):
    ...
    def __init__(self, identification=None, rel=None):  # noqa: E501
        """PatchPixPaymentDataCancellationCancelledByDocument - a model defined in Swagger"""  # noqa: E501
    ...
    def identification(self):
        """Gets the identification of this PatchPixPaymentDataCancellationCancelledByDocument.  # noqa: E501

        Número do documento do usuário pagador responsável pelo cancelamento do pagamento.  # noqa: E501

        :return: The identification of this PatchPixPaymentDataCancellationCancelledByDocument.  # noqa: E501
        :rtype: str
        """
    ...
    def identification(self, identification):
        """Sets the identification of this PatchPixPaymentDataCancellationCancelledByDocument.

        Número do documento do usuário pagador responsável pelo cancelamento do pagamento.  # noqa: E501

        :param identification: The identification of this PatchPixPaymentDataCancellationCancelledByDocument.  # noqa: E501
        :type: str
        """
    ...
    @property
    def rel(self):
        """Gets the rel of this PatchPixPaymentDataCancellationCancelledByDocument.  # noqa: E501

        Tipo do documento do usuário pagador responsável pelo cancelamento do pagamento.  # noqa: E501

        :return: The rel of this PatchPixPaymentDataCancellationCancelledByDocument.  # noqa: E501
        :rtype: str
        """
        return self._rel
    ...
    @rel.setter
    def rel(self, rel):
        """Sets the rel of this PatchPixPaymentDataCancellationCancelledByDocument.

        Tipo do documento do usuário pagador responsável pelo cancelamento do pagamento.  # noqa: E501

        :param rel: The rel of this PatchPixPaymentDataCancellationCancelledByDocument.  # noqa: E501
        :type: str
        """
        if rel is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchPixPaymentDataCancellationCancelledByDocument, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchPixPaymentDataCancellationCancelledByDocument):
            return False
