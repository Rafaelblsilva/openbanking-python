...
class ResponseCreatePaymentConsentData(object):
    ...
    def __init__(self, consent_id=None, creation_date_time=None, expiration_date_time=None, status_update_date_time=None, status=None, logged_user=None, business_entity=None, creditor=None, payment=None, debtor_account=None):  # noqa: E501
        """ResponseCreatePaymentConsentData - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def consent_id(self):
        """Gets the consent_id of this ResponseCreatePaymentConsentData.  # noqa: E501
        ...
        :return: The consent_id of this ResponseCreatePaymentConsentData.  # noqa: E501
        :rtype: str
        """
    ...
    def consent_id(self, consent_id):
        """Sets the consent_id of this ResponseCreatePaymentConsentData.

        Identificador único do consentimento criado para a iniciação de pagamento solicitada. Deverá ser um URN - Uniform Resource Name. Um URN, conforme definido na [RFC8141](https://tools.ietf.org/html/rfc8141) é um Uniform Resource Identifier - URI - que é atribuído sob o URI scheme \"urn\" e um namespace URN específico, com a intenção de que o URN seja um identificador de recurso persistente e independente da localização. Considerando a string urn:bancoex:C1DD33123 como exemplo para consentId temos: - o namespace(urn) - o identificador associado ao namespace da instituição transnmissora (bancoex) - o identificador específico dentro do namespace (C1DD33123). Informações mais detalhadas sobre a construção de namespaces devem ser consultadas na [RFC8141](https://tools.ietf.org/html/rfc8141).   # noqa: E501

        :param consent_id: The consent_id of this ResponseCreatePaymentConsentData.  # noqa: E501
        :type: str
        """
    ...
    def creation_date_time(self):
        """Gets the creation_date_time of this ResponseCreatePaymentConsentData.  # noqa: E501
        ...
        :return: The creation_date_time of this ResponseCreatePaymentConsentData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def creation_date_time(self, creation_date_time):
        """Sets the creation_date_time of this ResponseCreatePaymentConsentData.

        Data e hora em que o consentimento foi criado. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).  # noqa: E501

        :param creation_date_time: The creation_date_time of this ResponseCreatePaymentConsentData.  # noqa: E501
        :type: datetime
        """
    ...
    def expiration_date_time(self):
        """Gets the expiration_date_time of this ResponseCreatePaymentConsentData.  # noqa: E501
        ...
        :return: The expiration_date_time of this ResponseCreatePaymentConsentData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def expiration_date_time(self, expiration_date_time):
        """Sets the expiration_date_time of this ResponseCreatePaymentConsentData.

        Data e hora em que o consentimento da iniciação de pagamento expira, devendo ser sempre o creationDateTime mais 5 minutos. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC (UTC time format). O consentimento é criado com o status AWAITING_AUTHORISATION, e deve assumir o status AUTHORIZED ou REJECTED antes do tempo de expiração - 5 minutos. Caso o tempo seja expirado, o status deve assumir REJECTED. Para o cenário em que o status assumiu AUTHORISED, o tempo máximo do expirationDateTime do consentimento deve assumir \"now + 60 minutos\". Este é o tempo para consumir o consentimento autorizado, mudando seu status para CONSUMED. Não é possível prorrogar este tempo e a criação de um novo consentimento será necessária para os cenários de insucesso. O tempo do expirationDateTime é garantido com os 15 minutos do access token, sendo possível utilizar mais três refresh tokens até totalizar 60 minutos.   # noqa: E501

        :param expiration_date_time: The expiration_date_time of this ResponseCreatePaymentConsentData.  # noqa: E501
        :type: datetime
        """
    ...
    def status_update_date_time(self):
        """Gets the status_update_date_time of this ResponseCreatePaymentConsentData.  # noqa: E501
        ...
        :return: The status_update_date_time of this ResponseCreatePaymentConsentData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def status_update_date_time(self, status_update_date_time):
        """Sets the status_update_date_time of this ResponseCreatePaymentConsentData.

        Data e hora em que o recurso foi atualizado. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).   # noqa: E501

        :param status_update_date_time: The status_update_date_time of this ResponseCreatePaymentConsentData.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def status(self):
        """Gets the status of this ResponseCreatePaymentConsentData.  # noqa: E501


        :return: The status of this ResponseCreatePaymentConsentData.  # noqa: E501
    ...
    def status(self, status):
        """Sets the status of this ResponseCreatePaymentConsentData.


        :param status: The status of this ResponseCreatePaymentConsentData.  # noqa: E501
    ...
    def logged_user(self):
        """Gets the logged_user of this ResponseCreatePaymentConsentData.  # noqa: E501


        :return: The logged_user of this ResponseCreatePaymentConsentData.  # noqa: E501
        :rtype: LoggedUser
        """
    ...
    def logged_user(self, logged_user):
        """Sets the logged_user of this ResponseCreatePaymentConsentData.


        :param logged_user: The logged_user of this ResponseCreatePaymentConsentData.  # noqa: E501
        :type: LoggedUser
        """
    ...
    def business_entity(self):
        """Gets the business_entity of this ResponseCreatePaymentConsentData.  # noqa: E501


        :return: The business_entity of this ResponseCreatePaymentConsentData.  # noqa: E501
    ...
    def business_entity(self, business_entity):
        """Sets the business_entity of this ResponseCreatePaymentConsentData.


        :param business_entity: The business_entity of this ResponseCreatePaymentConsentData.  # noqa: E501
        :type: BusinessEntity
        """
    ...
    @property
    def creditor(self):
        """Gets the creditor of this ResponseCreatePaymentConsentData.  # noqa: E501


        :return: The creditor of this ResponseCreatePaymentConsentData.  # noqa: E501
    ...
    def creditor(self, creditor):
        """Sets the creditor of this ResponseCreatePaymentConsentData.


        :param creditor: The creditor of this ResponseCreatePaymentConsentData.  # noqa: E501
        :type: Identification
        """
        if creditor is None:
    ...
    @property
    def payment(self):
        """Gets the payment of this ResponseCreatePaymentConsentData.  # noqa: E501


        :return: The payment of this ResponseCreatePaymentConsentData.  # noqa: E501
        :rtype: CreatePaymentConsentDataPayment
        """
        return self._payment

    @payment.setter
    def payment(self, payment):
        """Sets the payment of this ResponseCreatePaymentConsentData.


        :param payment: The payment of this ResponseCreatePaymentConsentData.  # noqa: E501
        :type: CreatePaymentConsentDataPayment
        """
        if payment is None:
    ...
    def debtor_account(self):
        """Gets the debtor_account of this ResponseCreatePaymentConsentData.  # noqa: E501


        :return: The debtor_account of this ResponseCreatePaymentConsentData.  # noqa: E501
    ...
    def debtor_account(self, debtor_account):
        """Sets the debtor_account of this ResponseCreatePaymentConsentData.


        :param debtor_account: The debtor_account of this ResponseCreatePaymentConsentData.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseCreatePaymentConsentData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseCreatePaymentConsentData):
            return False
