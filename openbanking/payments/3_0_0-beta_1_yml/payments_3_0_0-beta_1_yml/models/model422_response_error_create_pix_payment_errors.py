...
class Model422ResponseErrorCreatePixPaymentErrors(object):
    ...
    def __init__(self, code=None, title=None, detail=None):  # noqa: E501
        """Model422ResponseErrorCreatePixPaymentErrors - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._title = None
        self._detail = None
    ...
    @property
    def code(self):
        """Gets the code of this Model422ResponseErrorCreatePixPaymentErrors.  # noqa: E501


        :return: The code of this Model422ResponseErrorCreatePixPaymentErrors.  # noqa: E501
        :rtype: EnumErrorsCreatePixPayment
        """
        return self._code

    @code.setter
    def code(self, code):
        """Sets the code of this Model422ResponseErrorCreatePixPaymentErrors.


        :param code: The code of this Model422ResponseErrorCreatePixPaymentErrors.  # noqa: E501
        :type: EnumErrorsCreatePixPayment
        """
        if code is None:
    ...
    @property
    def title(self):
        """Gets the title of this Model422ResponseErrorCreatePixPaymentErrors.  # noqa: E501

        Título específico do erro reportado, de acordo com o código enviado:  • PAGAMENTO_NAO_PERMITE_CANCELAMENTO: Pagamento não permite cancelamento   # noqa: E501

        :return: The title of this Model422ResponseErrorCreatePixPaymentErrors.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this Model422ResponseErrorCreatePixPaymentErrors.

        Título específico do erro reportado, de acordo com o código enviado:  • PAGAMENTO_NAO_PERMITE_CANCELAMENTO: Pagamento não permite cancelamento   # noqa: E501

        :param title: The title of this Model422ResponseErrorCreatePixPaymentErrors.  # noqa: E501
        :type: str
        """
        if title is None:
    ...
    @property
    def detail(self):
        """Gets the detail of this Model422ResponseErrorCreatePixPaymentErrors.  # noqa: E501

        Descrição específica do erro de acordo com o código reportado:  • PAGAMENTO_NAO_PERMITE_CANCELAMENTO: Pagamento não permite cancelamento   # noqa: E501

        :return: The detail of this Model422ResponseErrorCreatePixPaymentErrors.  # noqa: E501
        :rtype: str
        """
        return self._detail
    ...
    def detail(self, detail):
        """Sets the detail of this Model422ResponseErrorCreatePixPaymentErrors.

        Descrição específica do erro de acordo com o código reportado:  • PAGAMENTO_NAO_PERMITE_CANCELAMENTO: Pagamento não permite cancelamento   # noqa: E501

        :param detail: The detail of this Model422ResponseErrorCreatePixPaymentErrors.  # noqa: E501
        :type: str
        """
        if detail is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Model422ResponseErrorCreatePixPaymentErrors, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Model422ResponseErrorCreatePixPaymentErrors):
            return False
