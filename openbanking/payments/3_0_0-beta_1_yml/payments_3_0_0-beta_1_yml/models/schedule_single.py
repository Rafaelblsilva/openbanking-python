...
class ScheduleSingle(object):
    ...
    def __init__(self, _date=None):  # noqa: E501
        """ScheduleSingle - a model defined in Swagger"""  # noqa: E501
        self.__date = None
    ...
    @property
    def _date(self):
        """Gets the _date of this ScheduleSingle.  # noqa: E501

        Define a data alvo da liquidação do pagamento.   O fuso horário de Brasília deve ser utilizado para criação e racionalização sobre os dados deste campo.  Observação: Esse campo deverá sempre ser no mínimo D+1 corrido, ou seja, a data imediatamente posterior em relação a data do consentimento considerando o fuso horário de Brasília e deverá ser no máximo D+365 corridos a partir da data do consentimento considerando o fuso horário de Brasília   # noqa: E501

        :return: The _date of this ScheduleSingle.  # noqa: E501
        :rtype: date
        """
        return self.__date
    ...
    def _date(self, _date):
        """Sets the _date of this ScheduleSingle.

        Define a data alvo da liquidação do pagamento.   O fuso horário de Brasília deve ser utilizado para criação e racionalização sobre os dados deste campo.  Observação: Esse campo deverá sempre ser no mínimo D+1 corrido, ou seja, a data imediatamente posterior em relação a data do consentimento considerando o fuso horário de Brasília e deverá ser no máximo D+365 corridos a partir da data do consentimento considerando o fuso horário de Brasília   # noqa: E501

        :param _date: The _date of this ScheduleSingle.  # noqa: E501
        :type: date
        """
        if _date is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ScheduleSingle, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScheduleSingle):
            return False
