...
class Model422ResponseErrorCreatePixPaymentsErrors(object):
    ...
    def __init__(self, code=None, title=None, detail=None):  # noqa: E501
        """Model422ResponseErrorCreatePixPaymentsErrors - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._title = None
        self._detail = None
    ...
    @property
    def code(self):
        """Gets the code of this Model422ResponseErrorCreatePixPaymentsErrors.  # noqa: E501


        :return: The code of this Model422ResponseErrorCreatePixPaymentsErrors.  # noqa: E501
        :rtype: EnumErrorsCreatePayment
        """
        return self._code

    @code.setter
    def code(self, code):
        """Sets the code of this Model422ResponseErrorCreatePixPaymentsErrors.


        :param code: The code of this Model422ResponseErrorCreatePixPaymentsErrors.  # noqa: E501
    ...
    @property
    def title(self):
        """Gets the title of this Model422ResponseErrorCreatePixPaymentsErrors.  # noqa: E501

        Título específico do erro reportado, de acordo com o código enviado:  • SALDO_INSUFICIENTE: Saldo insuficiente.  • VALOR_ACIMA_LIMITE: Acima do limite estabelecido.  • VALOR_INVALIDO: Valor inválido.  • COBRANCA_INVALIDA: Cobrança inválida.  • CONSENTIMENTO_INVALIDO: Consentimento inválido.  • PARAMETRO_NAO_INFORMADO: Parâmetro obrigatório não informado.  • PARAMETRO_INVALIDO: Parâmetro com valor inválido.  • NAO_INFORMADO: Não informado.  • PAGAMENTO_DIVERGENTE_CONSENTIMENTO: Divergência entre pagamento e consentimento.  • DETALHE_PAGAMENTO_INVALIDO: Detalhe do pagamento inválido.  • PAGAMENTO_RECUSADO_DETENTORA: Pagamento recusado pela detentora de conta.  • PAGAMENTO_RECUSADO_SPI: Pagamento recusado no Sistema de Pagamentos Instantâneos (SPI).  • ERRO_IDEMPOTENCIA: Erro idempotência.   # noqa: E501

        :return: The title of this Model422ResponseErrorCreatePixPaymentsErrors.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this Model422ResponseErrorCreatePixPaymentsErrors.

        Título específico do erro reportado, de acordo com o código enviado:  • SALDO_INSUFICIENTE: Saldo insuficiente.  • VALOR_ACIMA_LIMITE: Acima do limite estabelecido.  • VALOR_INVALIDO: Valor inválido.  • COBRANCA_INVALIDA: Cobrança inválida.  • CONSENTIMENTO_INVALIDO: Consentimento inválido.  • PARAMETRO_NAO_INFORMADO: Parâmetro obrigatório não informado.  • PARAMETRO_INVALIDO: Parâmetro com valor inválido.  • NAO_INFORMADO: Não informado.  • PAGAMENTO_DIVERGENTE_CONSENTIMENTO: Divergência entre pagamento e consentimento.  • DETALHE_PAGAMENTO_INVALIDO: Detalhe do pagamento inválido.  • PAGAMENTO_RECUSADO_DETENTORA: Pagamento recusado pela detentora de conta.  • PAGAMENTO_RECUSADO_SPI: Pagamento recusado no Sistema de Pagamentos Instantâneos (SPI).  • ERRO_IDEMPOTENCIA: Erro idempotência.   # noqa: E501

        :param title: The title of this Model422ResponseErrorCreatePixPaymentsErrors.  # noqa: E501
        :type: str
        """
        if title is None:
    ...
    def detail(self, detail):
        """Sets the detail of this Model422ResponseErrorCreatePixPaymentsErrors.

        Descrição específica do erro de acordo com o código reportado:  • SALDO_INSUFICIENTE: A conta selecionada não possui saldo suficiente para realizar o pagamento.  • VALOR_ACIMA_LIMITE: O valor (ou quantidade de transações) ultrapassa a faixa de limite parametrizada na detentora para permitir a realização de transações pelo cliente.  • VALOR_INVALIDO: O valor enviado não é válido para o QR Code informado.  • COBRANCA_INVALIDA: Validação de expiração, validação de vencimento ou Status Válido.  • CONSENTIMENTO_INVALIDO: Consentimento inválido (status diferente de \"AUTHORISED\" ou está expirado).  • PARAMETRO_NAO_INFORMADO: endToEndId  • PARAMETRO_INVALIDO: endToEndId  • NAO_INFORMADO: Não reportado/identificado pela instituição detentora de conta.  • PAGAMENTO_DIVERGENTE_CONSENTIMENTO: Dados do pagamento divergentes dos dados do consentimento.  • DETALHE_PAGAMENTO_INVALIDO: Parâmetro [nome_campo] não obedece às regras de negócio.  • PAGAMENTO_RECUSADO_DETENTORA: [descrição do motivo de recusa].  • PAGAMENTO_RECUSADO_SPI: [código de erro conforme tabela de domínios reason PACS.002].  • ERRO_IDEMPOTENCIA: Conteúdo da mensagem (claim data) diverge do conteúdo associado a esta chave de idempotência (x-idempotency-key).   # noqa: E501

        :param detail: The detail of this Model422ResponseErrorCreatePixPaymentsErrors.  # noqa: E501
        :type: str
        """
        if detail is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Model422ResponseErrorCreatePixPaymentsErrors, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Model422ResponseErrorCreatePixPaymentsErrors):
            return False
