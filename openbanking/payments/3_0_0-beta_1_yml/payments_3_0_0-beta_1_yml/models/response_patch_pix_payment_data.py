...
class ResponsePatchPixPaymentData(object):
    ...
    def __init__(self, payment_id=None, end_to_end_id=None, consent_id=None, creation_date_time=None, status_update_date_time=None, proxy=None, ibge_town_code=None, status=None, rejection_reason=None, local_instrument=None, cnpj_initiator=None, payment=None, transaction_identification=None, remittance_information=None, creditor_account=None, cancellation=None, debtor_account=None, authorisation_flow=None):  # noqa: E501
        """ResponsePatchPixPaymentData - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def payment_id(self):
        """Gets the payment_id of this ResponsePatchPixPaymentData.  # noqa: E501
        ...
        :return: The payment_id of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_id(self, payment_id):
        """Sets the payment_id of this ResponsePatchPixPaymentData.

        Código ou identificador único informado pela instituição detentora da conta para representar a iniciação de pagamento individual. O `paymentId` deve ser diferente do `endToEndId`. Este é o identificador que deverá ser utilizado na consulta ao status da iniciação de pagamento efetuada.   # noqa: E501

        :param payment_id: The payment_id of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    def end_to_end_id(self):
        """Gets the end_to_end_id of this ResponsePatchPixPaymentData.  # noqa: E501


        :return: The end_to_end_id of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: EndToEndId
        """
    ...
    def end_to_end_id(self, end_to_end_id):
        """Sets the end_to_end_id of this ResponsePatchPixPaymentData.


        :param end_to_end_id: The end_to_end_id of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: EndToEndId
        """
    ...
    @property
    def consent_id(self):
        """Gets the consent_id of this ResponsePatchPixPaymentData.  # noqa: E501
        ...
        :return: The consent_id of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def consent_id(self, consent_id):
        """Sets the consent_id of this ResponsePatchPixPaymentData.

        Identificador único do consentimento criado para a iniciação de pagamento solicitada. Deverá ser um URN - Uniform Resource Name. Um URN, conforme definido na [RFC8141](https://tools.ietf.org/html/rfc8141) é um Uniform Resource Identifier - URI - que é atribuído sob o URI scheme \"urn\" e um namespace URN específico, com a intenção de que o URN seja um identificador de recurso persistente e independente da localização. Considerando a string urn:bancoex:C1DD33123 como exemplo para consentId temos: - o namespace(urn) - o identificador associado ao namespace da instituição transnmissora (bancoex) - o identificador específico dentro do namespace (C1DD33123). Informações mais detalhadas sobre a construção de namespaces devem ser consultadas na [RFC8141](https://tools.ietf.org/html/rfc8141).   # noqa: E501

        :param consent_id: The consent_id of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    def creation_date_time(self):
        """Gets the creation_date_time of this ResponsePatchPixPaymentData.  # noqa: E501
        ...
        :return: The creation_date_time of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def creation_date_time(self, creation_date_time):
        """Sets the creation_date_time of this ResponsePatchPixPaymentData.

        Data e hora em que o recurso foi criado. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).   # noqa: E501

        :param creation_date_time: The creation_date_time of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: datetime
        """
    ...
    def status_update_date_time(self):
        """Gets the status_update_date_time of this ResponsePatchPixPaymentData.  # noqa: E501
        ...
        :return: The status_update_date_time of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: datetime
        """
    ...
    def status_update_date_time(self, status_update_date_time):
        """Sets the status_update_date_time of this ResponsePatchPixPaymentData.

        Data e hora da última atualização da iniciação de pagamento. Uma string com data e hora conforme especificação RFC-3339, sempre com a utilização de timezone UTC(UTC time format).   # noqa: E501

        :param status_update_date_time: The status_update_date_time of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def proxy(self):
        """Gets the proxy of this ResponsePatchPixPaymentData.  # noqa: E501
        ...
        :return: The proxy of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: str
        """
        return self._proxy
    ...
    def proxy(self, proxy):
        """Sets the proxy of this ResponsePatchPixPaymentData.

        Chave cadastrada no DICT pertencente ao recebedor. Os tipos de chaves podem ser: telefone, e-mail, cpf/cnpj ou chave aleatória. No caso de telefone celular deve ser informado no padrão E.1641. Para e-mail deve ter o formato xxxxxxxx@xxxxxxx.xxx(.xx) e no máximo 77 caracteres. No caso de CPF deverá ser informado com 11 números, sem pontos ou traços. Para o caso de CNPJ deverá ser informado com 14 números, sem pontos ou traços. No caso de chave aleatória deve ser informado o UUID gerado pelo DICT, conforme formato especificado na RFC41223. Se informado, a detentora da conta deve validar o proxy no DICT quando localInstrument for igual a DICT, QRDN ou QRES e validar o campo creditorAccount. Esta validação é opcional caso o localInstrument for igual a INIC. [Restrição] Se localInstrument for igual a MANU, o campo proxy não deve ser preenchido. Se localInstrument for igual INIC, DICT, QRDN ou QRES, o campo proxy deve ser sempre preenchido com a chave Pix.   # noqa: E501

        :param proxy: The proxy of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    def ibge_town_code(self):
        """Gets the ibge_town_code of this ResponsePatchPixPaymentData.  # noqa: E501
        ...
        :return: The ibge_town_code of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def ibge_town_code(self, ibge_town_code):
        """Sets the ibge_town_code of this ResponsePatchPixPaymentData.

        O campo ibgetowncode no arranjo PIX, tem o mesmo comportamento que o campo codMun descrito no item 1.6.6 do manual do PIX, conforme segue:  1. Caso a informação referente ao município não seja enviada; o PSP do recebedor assumirá que não existem feriados estaduais e municipais no período em questão;   # noqa: E501

        :param ibge_town_code: The ibge_town_code of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this ResponsePatchPixPaymentData.  # noqa: E501


        :return: The status of this ResponsePatchPixPaymentData.  # noqa: E501
    ...
    def status(self, status):
        """Sets the status of this ResponsePatchPixPaymentData.


        :param status: The status of this ResponsePatchPixPaymentData.  # noqa: E501
    ...
    def rejection_reason(self):
        """Gets the rejection_reason of this ResponsePatchPixPaymentData.  # noqa: E501


        :return: The rejection_reason of this ResponsePatchPixPaymentData.  # noqa: E501
    ...
    def rejection_reason(self, rejection_reason):
        """Sets the rejection_reason of this ResponsePatchPixPaymentData.


        :param rejection_reason: The rejection_reason of this ResponsePatchPixPaymentData.  # noqa: E501
    ...
    def local_instrument(self):
        """Gets the local_instrument of this ResponsePatchPixPaymentData.  # noqa: E501


        :return: The local_instrument of this ResponsePatchPixPaymentData.  # noqa: E501
    ...
    def local_instrument(self, local_instrument):
        """Sets the local_instrument of this ResponsePatchPixPaymentData.


        :param local_instrument: The local_instrument of this ResponsePatchPixPaymentData.  # noqa: E501
    ...
    def cnpj_initiator(self):
        """Gets the cnpj_initiator of this ResponsePatchPixPaymentData.  # noqa: E501

        CNPJ do Iniciador de Pagamento devidamente habilitado para a prestação de Serviço de Iniciação no Pix.  # noqa: E501

        :return: The cnpj_initiator of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def cnpj_initiator(self, cnpj_initiator):
        """Sets the cnpj_initiator of this ResponsePatchPixPaymentData.

        CNPJ do Iniciador de Pagamento devidamente habilitado para a prestação de Serviço de Iniciação no Pix.  # noqa: E501

        :param cnpj_initiator: The cnpj_initiator of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def payment(self):
        """Gets the payment of this ResponsePatchPixPaymentData.  # noqa: E501


        :return: The payment of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: PaymentPix
        """
    ...
    def payment(self, payment):
        """Sets the payment of this ResponsePatchPixPaymentData.


        :param payment: The payment of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: PaymentPix
        """
        if payment is None:
    ...
    def transaction_identification(self):
        """Gets the transaction_identification of this ResponsePatchPixPaymentData.  # noqa: E501
        ...
        :return: The transaction_identification of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def transaction_identification(self, transaction_identification):
        """Sets the transaction_identification of this ResponsePatchPixPaymentData.

        Trata-se de um identificador de transação que deve ser retransmitido intacto pelo PSP do pagador ao gerar a ordem de pagamento.  [Restrição] A detentora deve obrigatoriamente retornar o campo com o mesmo valor recebido da iniciadora, caso ele tenha sido enviado na requisição da iniciação do pagamento.   # noqa: E501

        :param transaction_identification: The transaction_identification of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    def remittance_information(self):
        """Gets the remittance_information of this ResponsePatchPixPaymentData.  # noqa: E501
        ...
        :return: The remittance_information of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def remittance_information(self, remittance_information):
        """Sets the remittance_information of this ResponsePatchPixPaymentData.

        Deve ser preenchido sempre que o usuário pagador inserir alguma informação adicional em um pagamento, a ser enviada ao recebedor.   # noqa: E501

        :param remittance_information: The remittance_information of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    def creditor_account(self):
        """Gets the creditor_account of this ResponsePatchPixPaymentData.  # noqa: E501


        :return: The creditor_account of this ResponsePatchPixPaymentData.  # noqa: E501
    ...
    def creditor_account(self, creditor_account):
        """Sets the creditor_account of this ResponsePatchPixPaymentData.


        :param creditor_account: The creditor_account of this ResponsePatchPixPaymentData.  # noqa: E501
    ...
    def cancellation(self):
        """Gets the cancellation of this ResponsePatchPixPaymentData.  # noqa: E501


        :return: The cancellation of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: PatchPixPaymentCancellation
        """
        return self._cancellation

    @cancellation.setter
    def cancellation(self, cancellation):
        """Sets the cancellation of this ResponsePatchPixPaymentData.


        :param cancellation: The cancellation of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: PatchPixPaymentCancellation
        """
    ...
    def debtor_account(self):
        """Gets the debtor_account of this ResponsePatchPixPaymentData.  # noqa: E501


        :return: The debtor_account of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: DebtorAccount
        """
    ...
    def debtor_account(self, debtor_account):
        """Sets the debtor_account of this ResponsePatchPixPaymentData.


        :param debtor_account: The debtor_account of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: DebtorAccount
        """
    ...
    def authorisation_flow(self):
        """Gets the authorisation_flow of this ResponsePatchPixPaymentData.  # noqa: E501

        Campo condicional utilizado para identificar o fluxo de autorização em que o pagamento foi solicitado.  [Restrição] Caso o campo não esteja presente no payload, subentende-se que o fluxo de autorização utilizado é o HYBRID_FLOW.   # noqa: E501

        :return: The authorisation_flow of this ResponsePatchPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def authorisation_flow(self, authorisation_flow):
        """Sets the authorisation_flow of this ResponsePatchPixPaymentData.

        Campo condicional utilizado para identificar o fluxo de autorização em que o pagamento foi solicitado.  [Restrição] Caso o campo não esteja presente no payload, subentende-se que o fluxo de autorização utilizado é o HYBRID_FLOW.   # noqa: E501

        :param authorisation_flow: The authorisation_flow of this ResponsePatchPixPaymentData.  # noqa: E501
        :type: str
        """
        allowed_values = ["HYBRID_FLOW", "CIBA_FLOW"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponsePatchPixPaymentData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponsePatchPixPaymentData):
            return False
