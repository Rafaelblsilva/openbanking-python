...
class ResponseCreatePixPaymentDataPayment(object):
    ...
    def __init__(self, amount=None, currency=None):  # noqa: E501
        """ResponseCreatePixPaymentDataPayment - a model defined in Swagger"""  # noqa: E501
        self._amount = None
        self._currency = None
    ...
    @property
    def amount(self):
        """Gets the amount of this ResponseCreatePixPaymentDataPayment.  # noqa: E501
        ...
        :return: The amount of this ResponseCreatePixPaymentDataPayment.  # noqa: E501
        :rtype: str
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this ResponseCreatePixPaymentDataPayment.

        Valor da transação com 2 casas decimais. O valor deve ser o mesmo enviado no consentimento.   Para QR Code estático com valor pré-determinado no QR Code ou para QR Code dinâmico com indicação de que o valor não pode ser alterado: O campo amount deve ser preenchido com o valor estabelecido no QR Code.  Caso seja preenchido com valor divergente do QR Code, deve ser retornado um erro HTTP Status 422.   # noqa: E501

        :param amount: The amount of this ResponseCreatePixPaymentDataPayment.  # noqa: E501
        :type: str
        """
        if amount is None:
    ...
    @property
    def currency(self):
        """Gets the currency of this ResponseCreatePixPaymentDataPayment.  # noqa: E501
        ...
        :return: The currency of this ResponseCreatePixPaymentDataPayment.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this ResponseCreatePixPaymentDataPayment.

        Código da moeda nacional segundo modelo ISO-4217, ou seja, 'BRL'.   Todos os valores monetários informados estão representados com a moeda vigente do Brasil.   # noqa: E501

        :param currency: The currency of this ResponseCreatePixPaymentDataPayment.  # noqa: E501
        :type: str
        """
        if currency is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseCreatePixPaymentDataPayment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseCreatePixPaymentDataPayment):
            return False
