...
class PatchPixPayment(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """PatchPixPayment - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this PatchPixPayment.  # noqa: E501


        :return: The data of this PatchPixPayment.  # noqa: E501
        :rtype: PatchPixPaymentData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this PatchPixPayment.


        :param data: The data of this PatchPixPayment.  # noqa: E501
        :type: PatchPixPaymentData
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchPixPayment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchPixPayment):
            return False
