...
class Model422ResponseErrorCreateConsentErrors(object):
    ...
    def code(self):
        ...
        Códigos de erros previstos na criação de consentimento para a iniciação de pagamentos:   • FORMA_PAGAMENTO_INVALIDA: Forma de pagamento inválida.   • DATA_PAGAMENTO_INVALIDA: Data de pagamento inválida.   • DETALHE_PAGAMENTO_INVALIDO: Detalhe do pagamento inválido.   • PARAMETRO_NAO_INFORMADO: Parâmetro não informado.   • PARAMETRO_INVALIDO: Parâmetro inválido.   • ERRO_IDEMPOTENCIA: Erro idempotência.   • NAO_INFORMADO: Não informado.      # noqa: E501
    ...
    def code(self, code):
        ...
        allowed_values = ["FORMA_PAGAMENTO_INVALIDA", "DATA_PAGAMENTO_INVALIDA", "DETALHE_PAGAMENTO_INVALIDO", "PARAMETRO_NAO_INFORMADO", "PARAMETRO_INVALIDO", "ERRO_IDEMPOTENCIA", "NAO_INFORMADO"]  # noqa: E501
    ...
    def title(self):
        ...
        Título específico do erro reportado, de acordo com o código enviado:   • FORMA_PAGAMENTO_INVALIDA: Forma de pagamento inválida.   • DATA_PAGAMENTO_INVALIDA: Data de pagamento inválida.   • DETALHE_PAGAMENTO_INVALIDO: Detalhe do pagamento inválido.   • PARAMETRO_NAO_INFORMADO: Parâmetro não informado.   • PARAMETRO_INVALIDO: Parâmetro inválido.   • ERRO_IDEMPOTENCIA: Erro idempotência.   • NAO_INFORMADO: Não informado.       # noqa: E501
