...
class ResponseCreatePaymentConsent(object):
    ...
    def __init__(self, data=None, links=None, meta=None):  # noqa: E501
        """ResponseCreatePaymentConsent - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
        self._meta = None
    ...
    @property
    def data(self):
        """Gets the data of this ResponseCreatePaymentConsent.  # noqa: E501


        :return: The data of this ResponseCreatePaymentConsent.  # noqa: E501
        :rtype: ResponseCreatePaymentConsentData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ResponseCreatePaymentConsent.


        :param data: The data of this ResponseCreatePaymentConsent.  # noqa: E501
        :type: ResponseCreatePaymentConsentData
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this ResponseCreatePaymentConsent.  # noqa: E501


        :return: The links of this ResponseCreatePaymentConsent.  # noqa: E501
        :rtype: LinkSingle
        """
        return self._links
    ...
    def links(self, links):
        """Sets the links of this ResponseCreatePaymentConsent.


        :param links: The links of this ResponseCreatePaymentConsent.  # noqa: E501
        :type: LinkSingle
        """
        if links is None:
    ...
    @property
    def meta(self):
        """Gets the meta of this ResponseCreatePaymentConsent.  # noqa: E501


        :return: The meta of this ResponseCreatePaymentConsent.  # noqa: E501
        :rtype: Meta
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this ResponseCreatePaymentConsent.


        :param meta: The meta of this ResponseCreatePaymentConsent.  # noqa: E501
        :type: Meta
        """
        if meta is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseCreatePaymentConsent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseCreatePaymentConsent):
            return False
