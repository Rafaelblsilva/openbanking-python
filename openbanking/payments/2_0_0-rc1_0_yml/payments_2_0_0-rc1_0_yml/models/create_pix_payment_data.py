...
class CreatePixPaymentData(object):
    ...
    def __init__(self, end_to_end_id=None, local_instrument=None, payment=None, creditor_account=None, remittance_information=None, qr_code=None, proxy=None, cnpj_initiator=None, transaction_identification=None, ibge_town_code=None):  # noqa: E501
