...
class ResponsePixPaymentData(object):
    ...
    def __init__(self, payment_id=None, end_to_end_id=None, consent_id=None, creation_date_time=None, status_update_date_time=None, proxy=None, status=None, rejection_reason=None, local_instrument=None, cnpj_initiator=None, payment=None, remittance_information=None, creditor_account=None):  # noqa: E501
