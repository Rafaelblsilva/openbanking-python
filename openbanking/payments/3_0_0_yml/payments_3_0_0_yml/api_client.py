...
from payments_3_0_0_yml.configuration import Configuration
import payments_3_0_0_yml.models
from payments_3_0_0_yml import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(payments_3_0_0_yml.models, klass)
