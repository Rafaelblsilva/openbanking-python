...
*PagamentosApi* | [**payments_patch_pix_payments**](docs/PagamentosApi.md#payments_patch_pix_payments) | **PATCH** /consents/{consentId} | Revogar consentimento de pagamento.
...
## Documentation For Models
 ...
 - [EnumAuthorisationPatchStatusType](docs/EnumAuthorisationPatchStatusType.md)
 - [EnumAuthorisationStatusType](docs/EnumAuthorisationStatusType.md)
 - [EnumErrorsCreatePayment](docs/EnumErrorsCreatePayment.md)
 - [EnumErrorsPatchConsent](docs/EnumErrorsPatchConsent.md)
 ...
 - [EnumRevocationReason](docs/EnumRevocationReason.md)
 - [EnumRevokedBy](docs/EnumRevokedBy.md)
 ...
 - [Model422ResponseErrorPatchConsent](docs/Model422ResponseErrorPatchConsent.md)
 - [Model422ResponseErrorPatchConsentErrors](docs/Model422ResponseErrorPatchConsentErrors.md)
 - [OneOfPaymentConsentSchedule](docs/OneOfPaymentConsentSchedule.md)
 - [PatchPaymentsConsent](docs/PatchPaymentsConsent.md)
 - [PatchPaymentsConsentData](docs/PatchPaymentsConsentData.md)
 ...
 - [ResponsePixPaymentLinks](docs/ResponsePixPaymentLinks.md)
