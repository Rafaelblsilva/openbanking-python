...
class EnumErrorsPatchConsent(object):
    ...
    allowed enum values
    """
    INFORMACAO_USUARIO_REQUERIDA = "INFORMACAO_USUARIO_REQUERIDA"
    OPERACAO_NAO_PERMITIDA_STATUS = "OPERACAO_NAO_PERMITIDA_STATUS"
    OPERACAO_NAO_SUPORTADA_TIPO_CONSENTIMENTO = "OPERACAO_NAO_SUPORTADA_TIPO_CONSENTIMENTO"
    TEMPO_LIMITE_REVOGACAO_EXCEDIDO = "TEMPO_LIMITE_REVOGACAO_EXCEDIDO"
    MOTIVO_REVOGACAO_NAO_PERMITIDO = "MOTIVO_REVOGACAO_NAO_PERMITIDO"
    INFORMACAO_ADICIONAL_REVOGACAO_REQUERIDA = "INFORMACAO_ADICIONAL_REVOGACAO_REQUERIDA"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """EnumErrorsPatchConsent - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumErrorsPatchConsent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumErrorsPatchConsent):
            return False
