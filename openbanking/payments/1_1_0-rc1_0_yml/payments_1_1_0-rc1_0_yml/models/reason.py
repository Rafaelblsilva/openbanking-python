...
class Reason(object):
    ...
    @property
    def code(self):
        """Gets the code of this Reason.  # noqa: E501


        :return: The code of this Reason.  # noqa: E501
        :rtype: EnumRevocationReason
        """
        return self._code
    ...
    def code(self, code):
        ...
        :param code: The code of this Reason.  # noqa: E501
        :type: EnumRevocationReason
        """
        if code is None:
    ...
    def additional_information(self):
        """Gets the additional_information of this Reason.  # noqa: E501

        Contém informações adicionais definidas pelo requisitante da revogação.  [Restrição] Deverá ser obrigatoriamente preenchido quando a revogação for feita pela iniciadora ou pela detentora unilateralmente, ou seja, quando o campo revokedBy for igual a TPP ou ASPSP e o motivo de revogação for OTHER.   # noqa: E501

        :return: The additional_information of this Reason.  # noqa: E501
        :rtype: str
        """
    ...
    def additional_information(self, additional_information):
        """Sets the additional_information of this Reason.

        Contém informações adicionais definidas pelo requisitante da revogação.  [Restrição] Deverá ser obrigatoriamente preenchido quando a revogação for feita pela iniciadora ou pela detentora unilateralmente, ou seja, quando o campo revokedBy for igual a TPP ou ASPSP e o motivo de revogação for OTHER.   # noqa: E501

        :param additional_information: The additional_information of this Reason.  # noqa: E501
        :type: str
        """
