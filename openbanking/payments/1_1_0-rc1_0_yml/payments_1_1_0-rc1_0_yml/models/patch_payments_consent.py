...
class PatchPaymentsConsent(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """PatchPaymentsConsent - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this PatchPaymentsConsent.  # noqa: E501


        :return: The data of this PatchPaymentsConsent.  # noqa: E501
        :rtype: PatchPaymentsConsentData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this PatchPaymentsConsent.


        :param data: The data of this PatchPaymentsConsent.  # noqa: E501
        :type: PatchPaymentsConsentData
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchPaymentsConsent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchPaymentsConsent):
            return False
