...
class Model422ResponseErrorPatchConsentErrors(object):
    ...
    def __init__(self, code=None, title=None, detail=None):  # noqa: E501
        """Model422ResponseErrorPatchConsentErrors - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._title = None
        self._detail = None
    ...
    @property
    def code(self):
        """Gets the code of this Model422ResponseErrorPatchConsentErrors.  # noqa: E501


        :return: The code of this Model422ResponseErrorPatchConsentErrors.  # noqa: E501
        :rtype: EnumErrorsPatchConsent
        """
        return self._code

    @code.setter
    def code(self, code):
        """Sets the code of this Model422ResponseErrorPatchConsentErrors.


        :param code: The code of this Model422ResponseErrorPatchConsentErrors.  # noqa: E501
        :type: EnumErrorsPatchConsent
        """
        if code is None:
    ...
    @property
    def title(self):
        """Gets the title of this Model422ResponseErrorPatchConsentErrors.  # noqa: E501

        Título específico do erro reportado, de acordo com o código enviado:   • INFORMACAO_USUARIO_REQUERIDA: Informação do usuário requerida.   • OPERACAO_NAO_PERMITIDA_STATUS: Operação não permitida.   • OPERACAO_NAO_SUPORTADA_TIPO_CONSENTIMENTO: Operação não permitida.   • TEMPO_LIMITE_REVOGACAO_EXCEDIDO: Prazo limite para revogação excedido.   • MOTIVO_REVOGACAO_NAO_PERMITIDO: Motivo de revogação não permitido.   • INFORMACAO_ADICIONAL_REVOGACAO_REQUERIDA: Informação adicional requerida.   # noqa: E501

        :return: The title of this Model422ResponseErrorPatchConsentErrors.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this Model422ResponseErrorPatchConsentErrors.

        Título específico do erro reportado, de acordo com o código enviado:   • INFORMACAO_USUARIO_REQUERIDA: Informação do usuário requerida.   • OPERACAO_NAO_PERMITIDA_STATUS: Operação não permitida.   • OPERACAO_NAO_SUPORTADA_TIPO_CONSENTIMENTO: Operação não permitida.   • TEMPO_LIMITE_REVOGACAO_EXCEDIDO: Prazo limite para revogação excedido.   • MOTIVO_REVOGACAO_NAO_PERMITIDO: Motivo de revogação não permitido.   • INFORMACAO_ADICIONAL_REVOGACAO_REQUERIDA: Informação adicional requerida.   # noqa: E501

        :param title: The title of this Model422ResponseErrorPatchConsentErrors.  # noqa: E501
        :type: str
        """
        if title is None:
    ...
    @property
    def detail(self):
        """Gets the detail of this Model422ResponseErrorPatchConsentErrors.  # noqa: E501

        Descrição específica do erro de acordo com o código reportado:   • INFORMACAO_USUARIO_REQUERIDA: Informação do usuário requerida.   • OPERACAO_NAO_PERMITIDA_STATUS: Operação não permitida devido ao status atual do consentimento.   • OPERACAO_NAO_SUPORTADA_TIPO_CONSENTIMENTO: Operação não suportada pelo tipo de consentimento.   • TEMPO_LIMITE_REVOGACAO_EXCEDIDO: Prazo limite para revogação excedido.   • MOTIVO_REVOGACAO_NAO_PERMITIDO: Motivo de revogação não permitido.   • INFORMACAO_ADICIONAL_REVOGACAO_REQUERIDA: Informação adicional requerida.   # noqa: E501

        :return: The detail of this Model422ResponseErrorPatchConsentErrors.  # noqa: E501
        :rtype: str
        """
        return self._detail
    ...
    def detail(self, detail):
        """Sets the detail of this Model422ResponseErrorPatchConsentErrors.

        Descrição específica do erro de acordo com o código reportado:   • INFORMACAO_USUARIO_REQUERIDA: Informação do usuário requerida.   • OPERACAO_NAO_PERMITIDA_STATUS: Operação não permitida devido ao status atual do consentimento.   • OPERACAO_NAO_SUPORTADA_TIPO_CONSENTIMENTO: Operação não suportada pelo tipo de consentimento.   • TEMPO_LIMITE_REVOGACAO_EXCEDIDO: Prazo limite para revogação excedido.   • MOTIVO_REVOGACAO_NAO_PERMITIDO: Motivo de revogação não permitido.   • INFORMACAO_ADICIONAL_REVOGACAO_REQUERIDA: Informação adicional requerida.   # noqa: E501

        :param detail: The detail of this Model422ResponseErrorPatchConsentErrors.  # noqa: E501
        :type: str
        """
        if detail is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Model422ResponseErrorPatchConsentErrors, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Model422ResponseErrorPatchConsentErrors):
            return False
