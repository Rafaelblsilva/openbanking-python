...
class PatchPaymentsConsentData(object):
    ...
    """
    swagger_types = {
        'status': 'EnumAuthorisationPatchStatusType',
    ...
    def __init__(self, status=None, revocation=None):  # noqa: E501
        """PatchPaymentsConsentData - a model defined in Swagger"""  # noqa: E501
        self._status = None
    ...
    @property
    def status(self):
        """Gets the status of this PatchPaymentsConsentData.  # noqa: E501


        :return: The status of this PatchPaymentsConsentData.  # noqa: E501
        :rtype: EnumAuthorisationPatchStatusType
        """
        return self._status

    @status.setter
    def status(self, status):
        """Sets the status of this PatchPaymentsConsentData.


        :param status: The status of this PatchPaymentsConsentData.  # noqa: E501
        :type: EnumAuthorisationPatchStatusType
        """
        if status is None:
    ...
    @property
    def revocation(self):
        """Gets the revocation of this PatchPaymentsConsentData.  # noqa: E501


        :return: The revocation of this PatchPaymentsConsentData.  # noqa: E501
        :rtype: Revocation
        """
    ...
    def revocation(self, revocation):
        """Sets the revocation of this PatchPaymentsConsentData.


        :param revocation: The revocation of this PatchPaymentsConsentData.  # noqa: E501
        :type: Revocation
        """
        if revocation is None:
            raise ValueError("Invalid value for `revocation`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchPaymentsConsentData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchPaymentsConsentData):
            return False
