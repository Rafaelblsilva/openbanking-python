...
class PagamentosApi(object):
    ...
    def payments_patch_pix_payments(self, body, authorization, x_idempotency_key, consent_id, **kwargs):  # noqa: E501
        """Revogar consentimento de pagamento.  # noqa: E501

        Método para revogação do consentimento.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.payments_patch_pix_payments(body, authorization, x_idempotency_key, consent_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PatchPaymentsConsent body: Payload para revogação do consentimento. (required)
        :param str authorization: Cabeçalho HTTP padrão. Permite que as credenciais sejam fornecidas dependendo do tipo de recurso solicitado (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.payments_patch_pix_payments_with_http_info(body, authorization, x_idempotency_key, consent_id, **kwargs)  # noqa: E501
        else:
            (data) = self.payments_patch_pix_payments_with_http_info(body, authorization, x_idempotency_key, consent_id, **kwargs)  # noqa: E501
            return data

    def payments_patch_pix_payments_with_http_info(self, body, authorization, x_idempotency_key, consent_id, **kwargs):  # noqa: E501
        """Revogar consentimento de pagamento.  # noqa: E501

        Método para revogação do consentimento.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.payments_patch_pix_payments_with_http_info(body, authorization, x_idempotency_key, consent_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method payments_patch_pix_payments" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `payments_patch_pix_payments`")  # noqa: E501
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `payments_patch_pix_payments`")  # noqa: E501
        ...
        if ('x_idempotency_key' not in params or
            ...
            raise ValueError("Missing the required parameter `x_idempotency_key` when calling `payments_patch_pix_payments`")  # noqa: E501
        # verify the required parameter 'consent_id' is set
        if ('consent_id' not in params or
                params['consent_id'] is None):
            raise ValueError("Missing the required parameter `consent_id` when calling `payments_patch_pix_payments`")  # noqa: E501
