...
class FinancingsOverParcel(object):
    ...
    """
    swagger_types = {
        'fees': 'list[FinancingsFeeOverParcel]',
        'charges': 'list[FinancingsChargeOverParcel]'
    }
    ...
    def __init__(self, fees=None, charges=None):  # noqa: E501
        """FinancingsOverParcel - a model defined in Swagger"""  # noqa: E501
        self._fees = None
        self._charges = None
    ...
    @property
    def fees(self):
        """Gets the fees of this FinancingsOverParcel.  # noqa: E501

        Lista das tarifas que foram pagas fora da parcela, só para pagamento avulso.  # noqa: E501

        :return: The fees of this FinancingsOverParcel.  # noqa: E501
        :rtype: list[FinancingsFeeOverParcel]
        """
        return self._fees

    @fees.setter
    def fees(self, fees):
        """Sets the fees of this FinancingsOverParcel.

        Lista das tarifas que foram pagas fora da parcela, só para pagamento avulso.  # noqa: E501

        :param fees: The fees of this FinancingsOverParcel.  # noqa: E501
        :type: list[FinancingsFeeOverParcel]
        """
        if fees is None:
    ...
    @property
    def charges(self):
        """Gets the charges of this FinancingsOverParcel.  # noqa: E501

        Lista dos encargos que foram pagos fora da parcela.  # noqa: E501

        :return: The charges of this FinancingsOverParcel.  # noqa: E501
        :rtype: list[FinancingsChargeOverParcel]
        """
        return self._charges

    @charges.setter
    def charges(self, charges):
        """Sets the charges of this FinancingsOverParcel.

        Lista dos encargos que foram pagos fora da parcela.  # noqa: E501

        :param charges: The charges of this FinancingsOverParcel.  # noqa: E501
        :type: list[FinancingsChargeOverParcel]
        """
        if charges is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FinancingsOverParcel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FinancingsOverParcel):
            return False
