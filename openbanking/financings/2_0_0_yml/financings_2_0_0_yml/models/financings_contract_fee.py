...
class FinancingsContractFee(object):
    ...
    def __init__(self, fee_name=None, fee_code=None, fee_charge_type=None, fee_charge=None, fee_amount=None, fee_rate=None):  # noqa: E501
        """FinancingsContractFee - a model defined in Swagger"""  # noqa: E501
        self._fee_name = None
        self._fee_code = None
    ...
    @property
    def fee_name(self):
        """Gets the fee_name of this FinancingsContractFee.  # noqa: E501

        Denominação da Tarifa pactuada  # noqa: E501

        :return: The fee_name of this FinancingsContractFee.  # noqa: E501
        :rtype: str
        """
    ...
    def fee_name(self, fee_name):
        """Sets the fee_name of this FinancingsContractFee.

        Denominação da Tarifa pactuada  # noqa: E501

        :param fee_name: The fee_name of this FinancingsContractFee.  # noqa: E501
        :type: str
        """
        if fee_name is None:
    ...
    @property
    def fee_code(self):
        """Gets the fee_code of this FinancingsContractFee.  # noqa: E501

        Sigla identificadora da tarifa pactuada  # noqa: E501

        :return: The fee_code of this FinancingsContractFee.  # noqa: E501
        :rtype: str
        """
    ...
    def fee_code(self, fee_code):
        """Sets the fee_code of this FinancingsContractFee.

        Sigla identificadora da tarifa pactuada  # noqa: E501

        :param fee_code: The fee_code of this FinancingsContractFee.  # noqa: E501
        :type: str
        """
        if fee_code is None:
    ...
    def fee_charge_type(self):
        """Gets the fee_charge_type of this FinancingsContractFee.  # noqa: E501

        Tipo de cobrança para a tarifa pactuada no contrato.  # noqa: E501

        :return: The fee_charge_type of this FinancingsContractFee.  # noqa: E501
        :rtype: str
        """
    ...
    def fee_charge_type(self, fee_charge_type):
        """Sets the fee_charge_type of this FinancingsContractFee.

        Tipo de cobrança para a tarifa pactuada no contrato.  # noqa: E501

        :param fee_charge_type: The fee_charge_type of this FinancingsContractFee.  # noqa: E501
        :type: str
        """
        if fee_charge_type is None:
            raise ValueError("Invalid value for `fee_charge_type`, must not be `None`")  # noqa: E501
        allowed_values = ["UNICA", "POR_PARCELA"]  # noqa: E501
        if fee_charge_type not in allowed_values:
            raise ValueError(
                "Invalid value for `fee_charge_type` ({0}), must be one of {1}"  # noqa: E501
                .format(fee_charge_type, allowed_values)
            )
    ...
    @property
    def fee_charge(self):
        """Gets the fee_charge of this FinancingsContractFee.  # noqa: E501

        \"Forma de cobrança relativa a tarifa pactuada no contrato. (Vide Enum) - Mínimo - Máximo - Fixo - Percentual\"   # noqa: E501

        :return: The fee_charge of this FinancingsContractFee.  # noqa: E501
        :rtype: str
        """
    ...
    def fee_charge(self, fee_charge):
        """Sets the fee_charge of this FinancingsContractFee.

        \"Forma de cobrança relativa a tarifa pactuada no contrato. (Vide Enum) - Mínimo - Máximo - Fixo - Percentual\"   # noqa: E501

        :param fee_charge: The fee_charge of this FinancingsContractFee.  # noqa: E501
        :type: str
        """
        if fee_charge is None:
            raise ValueError("Invalid value for `fee_charge`, must not be `None`")  # noqa: E501
        allowed_values = ["MINIMO", "MAXIMO", "FIXO", "PERCENTUAL"]  # noqa: E501
        if fee_charge not in allowed_values:
            raise ValueError(
                "Invalid value for `fee_charge` ({0}), must be one of {1}"  # noqa: E501
                .format(fee_charge, allowed_values)
            )
    ...
    @property
    def fee_amount(self):
        """Gets the fee_amount of this FinancingsContractFee.  # noqa: E501
        ...
        :return: The fee_amount of this FinancingsContractFee.  # noqa: E501
        :rtype: str
        """
    ...
    def fee_amount(self, fee_amount):
        """Sets the fee_amount of this FinancingsContractFee.

        Valor monetário da tarifa pactuada no contrato.   [Restrição] Preenchimento obrigatório quando a forma de cobrança for diferente de Percentual.   # noqa: E501

        :param fee_amount: The fee_amount of this FinancingsContractFee.  # noqa: E501
        :type: str
        """
    ...
    @property
    def fee_rate(self):
        """Gets the fee_rate of this FinancingsContractFee.  # noqa: E501
        ...
        :return: The fee_rate of this FinancingsContractFee.  # noqa: E501
        :rtype: str
        """
    ...
    def fee_rate(self, fee_rate):
        """Sets the fee_rate of this FinancingsContractFee.

        Objeto que traz o conjunto de informações necessárias para demonstrar a composição das taxas de juros remuneratórios da Modalidade de crédito.  [Restrição] Preenchimento obrigatório quando a forma de cobrança for Percentual.   # noqa: E501

        :param fee_rate: The fee_rate of this FinancingsContractFee.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FinancingsContractFee, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FinancingsContractFee):
            return False
