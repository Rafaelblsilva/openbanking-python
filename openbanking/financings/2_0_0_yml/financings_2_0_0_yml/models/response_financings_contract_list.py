...
class ResponseFinancingsContractList(object):
    ...
    """
    swagger_types = {
        'data': 'list[FinancingsListContract]',
        'links': 'Links',
        'meta': 'Meta'
    }
    ...
    def __init__(self, data=None, links=None, meta=None):  # noqa: E501
        """ResponseFinancingsContractList - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
        self._meta = None
    ...
    @property
    def data(self):
        """Gets the data of this ResponseFinancingsContractList.  # noqa: E501


        :return: The data of this ResponseFinancingsContractList.  # noqa: E501
        :rtype: list[FinancingsListContract]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ResponseFinancingsContractList.


        :param data: The data of this ResponseFinancingsContractList.  # noqa: E501
        :type: list[FinancingsListContract]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this ResponseFinancingsContractList.  # noqa: E501


        :return: The links of this ResponseFinancingsContractList.  # noqa: E501
        :rtype: Links
        """
        return self._links
    ...
    def links(self, links):
        """Sets the links of this ResponseFinancingsContractList.


        :param links: The links of this ResponseFinancingsContractList.  # noqa: E501
        :type: Links
        """
        if links is None:
    ...
    @property
    def meta(self):
        """Gets the meta of this ResponseFinancingsContractList.  # noqa: E501


        :return: The meta of this ResponseFinancingsContractList.  # noqa: E501
        :rtype: Meta
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this ResponseFinancingsContractList.


        :param meta: The meta of this ResponseFinancingsContractList.  # noqa: E501
        :type: Meta
        """
        if meta is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseFinancingsContractList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseFinancingsContractList):
            return False
