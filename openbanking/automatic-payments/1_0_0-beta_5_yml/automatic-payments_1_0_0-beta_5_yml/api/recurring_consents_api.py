...
"""
    ...
    OpenAPI spec version: 1.0.0-beta.5
...
from automatic-payments_1_0_0-beta_5_yml.api_client import ApiClient


class RecurringConsentsApi(object):
    ...
    def automatic_payments_get_recurring_consents_consent_id(self, authorization, x_fapi_interaction_id, recurring_consent_id, **kwargs):  # noqa: E501
        """Busca informações de um consentimento.  # noqa: E501

        Método para buscar informações sobre um consentimento de longa duração.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.automatic_payments_get_recurring_consents_consent_id(authorization, x_fapi_interaction_id, recurring_consent_id, async_req=True)
        >>> result = thread.get()
        ...
        :param str x_fapi_interaction_id: Um UUID [RFC4122](https://tools.ietf.org/html/rfc4122) usado como um ID de correlação. A detentora deve obrigatoriamente retornar o campo com o mesmo valor recebido da iniciadora. Caso não recebido ou recebido um valor inválido, a detentora deve gerar um x-fapi-interaction-id e retornar na resposta de erro. O iniciador deve acatar o valor recebido do detentor. (required)
        ...
        :return: ResponseRecurringConsent
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.automatic_payments_get_recurring_consents_consent_id_with_http_info(authorization, x_fapi_interaction_id, recurring_consent_id, **kwargs)  # noqa: E501
        else:
            (data) = self.automatic_payments_get_recurring_consents_consent_id_with_http_info(authorization, x_fapi_interaction_id, recurring_consent_id, **kwargs)  # noqa: E501
            return data

    def automatic_payments_get_recurring_consents_consent_id_with_http_info(self, authorization, x_fapi_interaction_id, recurring_consent_id, **kwargs):  # noqa: E501
        """Busca informações de um consentimento.  # noqa: E501

        Método para buscar informações sobre um consentimento de longa duração.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.automatic_payments_get_recurring_consents_consent_id_with_http_info(authorization, x_fapi_interaction_id, recurring_consent_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'x_fapi_interaction_id', 'recurring_consent_id', 'x_customer_user_agent', 'x_fapi_auth_date', 'x_fapi_customer_ip_address']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method automatic_payments_get_recurring_consents_consent_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('authorization' not in params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `automatic_payments_get_recurring_consents_consent_id`")  # noqa: E501
        ...
        if ('x_fapi_interaction_id' not in params or
            ...
            raise ValueError("Missing the required parameter `x_fapi_interaction_id` when calling `automatic_payments_get_recurring_consents_consent_id`")  # noqa: E501
        ...
        if ('recurring_consent_id' not in params or
            ...
            raise ValueError("Missing the required parameter `recurring_consent_id` when calling `automatic_payments_get_recurring_consents_consent_id`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'recurring_consent_id' in params:
            path_params['recurringConsentId'] = params['recurring_consent_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/recurring-consents/{recurringConsentId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='ResponseRecurringConsent',  # noqa: E501
    ...
    def automatic_payments_patch_recurring_consents_consent_id(self, body, authorization, x_fapi_interaction_id, x_idempotency_key, recurring_consent_id, **kwargs):  # noqa: E501
        """Rejeita, revoga ou edita um consentimento.  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.automatic_payments_patch_recurring_consents_consent_id(body, authorization, x_fapi_interaction_id, x_idempotency_key, recurring_consent_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PatchRecurringConsent body: Payload para criação do consentimento para iniciação do pagamento. (required)
        :param str authorization: Cabeçalho HTTP padrão. Permite que as credenciais sejam fornecidas dependendo do tipo de recurso solicitado (required)
        :param str x_fapi_interaction_id: Um UUID [RFC4122](https://tools.ietf.org/html/rfc4122) usado como um ID de correlação. A detentora deve obrigatoriamente retornar o campo com o mesmo valor recebido da iniciadora. Caso não recebido ou recebido um valor inválido, a detentora deve gerar um x-fapi-interaction-id e retornar na resposta de erro. O iniciador deve acatar o valor recebido do detentor. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.automatic_payments_patch_recurring_consents_consent_id_with_http_info(body, authorization, x_fapi_interaction_id, x_idempotency_key, recurring_consent_id, **kwargs)  # noqa: E501
        else:
            (data) = self.automatic_payments_patch_recurring_consents_consent_id_with_http_info(body, authorization, x_fapi_interaction_id, x_idempotency_key, recurring_consent_id, **kwargs)  # noqa: E501
            return data

    def automatic_payments_patch_recurring_consents_consent_id_with_http_info(self, body, authorization, x_fapi_interaction_id, x_idempotency_key, recurring_consent_id, **kwargs):  # noqa: E501
        """Rejeita, revoga ou edita um consentimento.  # noqa: E501

        Método para rejeitar, revogar ou editar um consentimento de longa duração:   1 - Informações sobre a revogação: - Caso bem sucedido, o consentimento vai para o status “REVOKED”; - Apenas consentimentos com status “AUTHORISED” podem ser revogados; - Pagamentos automáticos associados ao consentimento e que estão agendados para ocorrer até as 23:59h do próximo dia (a partir do dia de  solicitação da revogação) deverão ser mantidos. Pagamentos agendados para ocorrer após esse período devem ser cancelados. - Demais orientações referentes a revogação podem ser encontrados no header da API, tópico “Validações”, item 3.  2 - Informações sobre a edição:  - Os campos que são passíveis de edição e suas regras podem ser encontrados através do [link](https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/198410772); - A edição é possível apenas em casos de consentimento para Pix Automático (“automatic” escolhido no oneOf do objeto “recurringConfiguration”); - O envio do item \"/data/creditors/name\" atualizará o nome do recebedor em todos os elementos do array.  3 - Informações sobre a rejeição:   - Caso haja necessidade de cancelamento de um consentimento ainda não autorizado, o iniciador poderá chamar o endpoint para mover o consentimento para REJECTED.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.automatic_payments_patch_recurring_consents_consent_id_with_http_info(body, authorization, x_fapi_interaction_id, x_idempotency_key, recurring_consent_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'authorization', 'x_fapi_interaction_id', 'x_idempotency_key', 'recurring_consent_id', 'x_customer_user_agent', 'x_fapi_auth_date', 'x_fapi_customer_ip_address']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method automatic_payments_patch_recurring_consents_consent_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `automatic_payments_patch_recurring_consents_consent_id`")  # noqa: E501
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `automatic_payments_patch_recurring_consents_consent_id`")  # noqa: E501
        # verify the required parameter 'x_fapi_interaction_id' is set
        if ('x_fapi_interaction_id' not in params or
                params['x_fapi_interaction_id'] is None):
            raise ValueError("Missing the required parameter `x_fapi_interaction_id` when calling `automatic_payments_patch_recurring_consents_consent_id`")  # noqa: E501
        ...
        if ('x_idempotency_key' not in params or
            ...
            raise ValueError("Missing the required parameter `x_idempotency_key` when calling `automatic_payments_patch_recurring_consents_consent_id`")  # noqa: E501
        # verify the required parameter 'recurring_consent_id' is set
        if ('recurring_consent_id' not in params or
                params['recurring_consent_id'] is None):
            raise ValueError("Missing the required parameter `recurring_consent_id` when calling `automatic_payments_patch_recurring_consents_consent_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/recurring-consents/{recurringConsentId}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def automatic_payments_post_recurring_consents(self, body, authorization, x_fapi_interaction_id, x_idempotency_key, **kwargs):  # noqa: E501
        """Cria um consentimento para transações de pagamentos.  # noqa: E501

        Método para criação de consentimento de longa duração. Retorna um `recurringConsentId` no status AWAITING_AUTHORISATION.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.automatic_payments_post_recurring_consents(body, authorization, x_fapi_interaction_id, x_idempotency_key, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CreateRecurringConsent body: Payload para criação do consentimento para iniciação do pagamento. (required)
        :param str authorization: Cabeçalho HTTP padrão. Permite que as credenciais sejam fornecidas dependendo do tipo de recurso solicitado (required)
        :param str x_fapi_interaction_id: Um UUID [RFC4122](https://tools.ietf.org/html/rfc4122) usado como um ID de correlação. A detentora deve obrigatoriamente retornar o campo com o mesmo valor recebido da iniciadora. Caso não recebido ou recebido um valor inválido, a detentora deve gerar um x-fapi-interaction-id e retornar na resposta de erro. O iniciador deve acatar o valor recebido do detentor. (required)
        :param str x_idempotency_key: Cabeçalho HTTP personalizado. Identificador de solicitação exclusivo para suportar a idempotência. (required)
        :param str x_customer_user_agent: Indica o user-agent que o usuário utiliza.
        :param str x_fapi_auth_date: Data em que o usuário logou pela última vez com o iniciador. Representada de acordo com a [RFC7231](https://tools.ietf.org/html/rfc7231).Exemplo: Sun, 10 Sep 2017 19:43:31 UTC
        :param str x_fapi_customer_ip_address: O endereço IP do usuário se estiver atualmente logado com o iniciador.
        :return: ResponsePostRecurringConsent
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.automatic_payments_post_recurring_consents_with_http_info(body, authorization, x_fapi_interaction_id, x_idempotency_key, **kwargs)  # noqa: E501
        else:
            (data) = self.automatic_payments_post_recurring_consents_with_http_info(body, authorization, x_fapi_interaction_id, x_idempotency_key, **kwargs)  # noqa: E501
            return data

    def automatic_payments_post_recurring_consents_with_http_info(self, body, authorization, x_fapi_interaction_id, x_idempotency_key, **kwargs):  # noqa: E501
        """Cria um consentimento para transações de pagamentos.  # noqa: E501

        Método para criação de consentimento de longa duração. Retorna um `recurringConsentId` no status AWAITING_AUTHORISATION.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.automatic_payments_post_recurring_consents_with_http_info(body, authorization, x_fapi_interaction_id, x_idempotency_key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method automatic_payments_post_recurring_consents" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `automatic_payments_post_recurring_consents`")  # noqa: E501
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `automatic_payments_post_recurring_consents`")  # noqa: E501
        # verify the required parameter 'x_fapi_interaction_id' is set
        if ('x_fapi_interaction_id' not in params or
                params['x_fapi_interaction_id'] is None):
            raise ValueError("Missing the required parameter `x_fapi_interaction_id` when calling `automatic_payments_post_recurring_consents`")  # noqa: E501
        # verify the required parameter 'x_idempotency_key' is set
        if ('x_idempotency_key' not in params or
                params['x_idempotency_key'] is None):
            raise ValueError("Missing the required parameter `x_idempotency_key` when calling `automatic_payments_post_recurring_consents`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResponsePostRecurringConsent',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
