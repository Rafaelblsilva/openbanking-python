...
class PatchRecurringConsent(object):
    ...
    """
    swagger_types = {
        'data': 'OneOfPatchRecurringConsentData'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """PatchRecurringConsent - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this PatchRecurringConsent.  # noqa: E501

        Objeto contendo as informações de rejeição e revogação dos consentimentos  # noqa: E501

        :return: The data of this PatchRecurringConsent.  # noqa: E501
        :rtype: OneOfPatchRecurringConsentData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this PatchRecurringConsent.

        Objeto contendo as informações de rejeição e revogação dos consentimentos  # noqa: E501

        :param data: The data of this PatchRecurringConsent.  # noqa: E501
        :type: OneOfPatchRecurringConsentData
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchRecurringConsent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchRecurringConsent):
            return False
