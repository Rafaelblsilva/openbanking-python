...
class Vrp(object):
    ...
    def __init__(self, vrp=None):  # noqa: E501
    ...
    @property
    def vrp(self):
        """Gets the vrp of this Vrp.  # noqa: E501


        :return: The vrp of this Vrp.  # noqa: E501
        :rtype: VrpVrp
        """
        return self._vrp
    ...
    @vrp.setter
    def vrp(self, vrp):
        """Sets the vrp of this Vrp.


        :param vrp: The vrp of this Vrp.  # noqa: E501
        :type: VrpVrp
        """
        if vrp is None:
            raise ValueError("Invalid value for `vrp`, must not be `None`")  # noqa: E501
