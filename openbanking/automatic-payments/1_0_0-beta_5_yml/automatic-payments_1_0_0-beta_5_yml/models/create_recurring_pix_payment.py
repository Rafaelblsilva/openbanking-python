...
class CreateRecurringPixPayment(object):
    ...
    """
    swagger_types = {
        'data': 'CreateRecurringPixPaymentData'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """CreateRecurringPixPayment - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this CreateRecurringPixPayment.  # noqa: E501


        :return: The data of this CreateRecurringPixPayment.  # noqa: E501
        :rtype: CreateRecurringPixPaymentData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this CreateRecurringPixPayment.


        :param data: The data of this CreateRecurringPixPayment.  # noqa: E501
        :type: CreateRecurringPixPaymentData
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateRecurringPixPayment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRecurringPixPayment):
            return False
