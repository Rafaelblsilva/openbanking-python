...
class RiskSignalsPaymentsAutomatic(object):
    ...
    def __init__(self, last_login_date_time=None, pix_key_registration_date_time=None):  # noqa: E501
        """RiskSignalsPaymentsAutomatic - a model defined in Swagger"""  # noqa: E501
        self._last_login_date_time = None
        self._pix_key_registration_date_time = None
        self.discriminator = None
        self.last_login_date_time = last_login_date_time
        if pix_key_registration_date_time is not None:
            self.pix_key_registration_date_time = pix_key_registration_date_time

    @property
    def last_login_date_time(self):
        """Gets the last_login_date_time of this RiskSignalsPaymentsAutomatic.  # noqa: E501

        Data e hora do último login do cliente na iniciadora  # noqa: E501

        :return: The last_login_date_time of this RiskSignalsPaymentsAutomatic.  # noqa: E501
        :rtype: datetime
        """
    ...
    def last_login_date_time(self, last_login_date_time):
        """Sets the last_login_date_time of this RiskSignalsPaymentsAutomatic.

        Data e hora do último login do cliente na iniciadora  # noqa: E501

        :param last_login_date_time: The last_login_date_time of this RiskSignalsPaymentsAutomatic.  # noqa: E501
        :type: datetime
        """
        if last_login_date_time is None:
            raise ValueError("Invalid value for `last_login_date_time`, must not be `None`")  # noqa: E501

        self._last_login_date_time = last_login_date_time

    @property
    def pix_key_registration_date_time(self):
        """Gets the pix_key_registration_date_time of this RiskSignalsPaymentsAutomatic.  # noqa: E501

        Data e hora de cadastro da chave Pix do recebedor na iniciadora  [Restrição] Campo obrigatório a ser enviado, caso o valor do campo `/data/localInstrument` seja igual a `DICT` ou `INIC`.   # noqa: E501

        :return: The pix_key_registration_date_time of this RiskSignalsPaymentsAutomatic.  # noqa: E501
        :rtype: datetime
        """
        return self._pix_key_registration_date_time

    @pix_key_registration_date_time.setter
    def pix_key_registration_date_time(self, pix_key_registration_date_time):
        """Sets the pix_key_registration_date_time of this RiskSignalsPaymentsAutomatic.

        Data e hora de cadastro da chave Pix do recebedor na iniciadora  [Restrição] Campo obrigatório a ser enviado, caso o valor do campo `/data/localInstrument` seja igual a `DICT` ou `INIC`.   # noqa: E501

        :param pix_key_registration_date_time: The pix_key_registration_date_time of this RiskSignalsPaymentsAutomatic.  # noqa: E501
        :type: datetime
        """

        self._pix_key_registration_date_time = pix_key_registration_date_time
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RiskSignalsPaymentsAutomatic, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RiskSignalsPaymentsAutomatic):
            return False
