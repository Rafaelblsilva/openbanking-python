...
class AutomaticAutomatic(object):
    ...
    def __init__(self, contract_id=None, amount=None, transaction_limit=None, period=None, day_of_month=None, day_of_week=None, month=None, contract_debtor=None, immediate_payment=None):  # noqa: E501
        """AutomaticAutomatic - a model defined in Swagger"""  # noqa: E501
        ...
        self._month = None
        self._contract_debtor = None
        self._immediate_payment = None
        ...
        if month is not None:
            self.month = month
        self.contract_debtor = contract_debtor
        if immediate_payment is not None:
            self.immediate_payment = immediate_payment

    @property
    def contract_id(self):
        """Gets the contract_id of this AutomaticAutomatic.  # noqa: E501

        Identificador do contrato de transação  # noqa: E501

        :return: The contract_id of this AutomaticAutomatic.  # noqa: E501
        :rtype: str
        """
    ...
    def contract_id(self, contract_id):
        """Sets the contract_id of this AutomaticAutomatic.

        Identificador do contrato de transação  # noqa: E501

        :param contract_id: The contract_id of this AutomaticAutomatic.  # noqa: E501
        :type: str
        """
    ...
    @property
    def amount(self):
        """Gets the amount of this AutomaticAutomatic.  # noqa: E501

        Valor da transação com 2 casas decimais.  # noqa: E501

        :return: The amount of this AutomaticAutomatic.  # noqa: E501
        :rtype: str
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this AutomaticAutomatic.

        Valor da transação com 2 casas decimais.  # noqa: E501

        :param amount: The amount of this AutomaticAutomatic.  # noqa: E501
        :type: str
        """
    ...
    def transaction_limit(self):
        """Gets the transaction_limit of this AutomaticAutomatic.  # noqa: E501

        Valor da transação com 2 casas decimais.  # noqa: E501

        :return: The transaction_limit of this AutomaticAutomatic.  # noqa: E501
        :rtype: str
        """
    ...
    def transaction_limit(self, transaction_limit):
        """Sets the transaction_limit of this AutomaticAutomatic.

        Valor da transação com 2 casas decimais.  # noqa: E501

        :param transaction_limit: The transaction_limit of this AutomaticAutomatic.  # noqa: E501
        :type: str
        """
    ...
    @property
    def period(self):
        """Gets the period of this AutomaticAutomatic.  # noqa: E501

        Define a periodicidade permitida para realização de transações - DIARIO - SEMANAL - MENSAL - ANUAL   # noqa: E501

        :return: The period of this AutomaticAutomatic.  # noqa: E501
        :rtype: str
        """
        return self._period
    ...
    def period(self, period):
        """Sets the period of this AutomaticAutomatic.

        Define a periodicidade permitida para realização de transações - DIARIO - SEMANAL - MENSAL - ANUAL   # noqa: E501

        :param period: The period of this AutomaticAutomatic.  # noqa: E501
        :type: str
        """
        if period is None:
            raise ValueError("Invalid value for `period`, must not be `None`")  # noqa: E501
        allowed_values = ["DIARIO", "SEMANAL", "MENSAL", "ANUAL"]  # noqa: E501
    ...
    def day_of_month(self):
        """Gets the day_of_month of this AutomaticAutomatic.  # noqa: E501

        Dia fixo do mês que está prevista a transação.  [Restrição] Campo deve ser enviado quando o campo `/data/recurringConfiguration/automatic/period` for igual a MENSAL ou ANUAL.   # noqa: E501

        :return: The day_of_month of this AutomaticAutomatic.  # noqa: E501
        :rtype: int
        """
    ...
    def day_of_month(self, day_of_month):
        """Sets the day_of_month of this AutomaticAutomatic.

        Dia fixo do mês que está prevista a transação.  [Restrição] Campo deve ser enviado quando o campo `/data/recurringConfiguration/automatic/period` for igual a MENSAL ou ANUAL.   # noqa: E501

        :param day_of_month: The day_of_month of this AutomaticAutomatic.  # noqa: E501
        :type: int
        """
    ...
    def day_of_week(self):
        """Gets the day_of_week of this AutomaticAutomatic.  # noqa: E501

        Dia da semana que está prevista a transação. - SEGUNDA_FEIRA - TERCA_FEIRA - QUARTA_FEIRA - QUINTA_FEIRA - SEXTA_FEIRA  [Restrição] Campo deve ser enviado quando o campo `/data/recurringConfiguration/automatic/period` for igual a SEMANAL.   # noqa: E501

        :return: The day_of_week of this AutomaticAutomatic.  # noqa: E501
        :rtype: str
        """
    ...
    def day_of_week(self, day_of_week):
        """Sets the day_of_week of this AutomaticAutomatic.

        Dia da semana que está prevista a transação. - SEGUNDA_FEIRA - TERCA_FEIRA - QUARTA_FEIRA - QUINTA_FEIRA - SEXTA_FEIRA  [Restrição] Campo deve ser enviado quando o campo `/data/recurringConfiguration/automatic/period` for igual a SEMANAL.   # noqa: E501

        :param day_of_week: The day_of_week of this AutomaticAutomatic.  # noqa: E501
        :type: str
        """
        allowed_values = ["SEGUNDA_FEIRA", "TERCA_FEIRA", "QUARTA_FEIRA", "QUINTA_FEIRA", "SEXTA_FEIRA"]  # noqa: E501
    ...
    @property
    def month(self):
        """Gets the month of this AutomaticAutomatic.  # noqa: E501

        Mês previstos para ocorrer transações. - JANEIRO - FEVEREIRO - MARCO - ABRIL - MAIO - JUNHO - JULHO - AGOSTO - SETEMBRO - OUTUBRO - NOVEMBRO - DEZEMBRO  [Restrição] Campo deve ser enviado quando o campo `/data/recurringConfiguration/automatic/period` for igual a ANUAL   # noqa: E501

        :return: The month of this AutomaticAutomatic.  # noqa: E501
        :rtype: str
        """
        return self._month
    ...
    def month(self, month):
        """Sets the month of this AutomaticAutomatic.

        Mês previstos para ocorrer transações. - JANEIRO - FEVEREIRO - MARCO - ABRIL - MAIO - JUNHO - JULHO - AGOSTO - SETEMBRO - OUTUBRO - NOVEMBRO - DEZEMBRO  [Restrição] Campo deve ser enviado quando o campo `/data/recurringConfiguration/automatic/period` for igual a ANUAL   # noqa: E501

        :param month: The month of this AutomaticAutomatic.  # noqa: E501
        :type: str
        """
        allowed_values = ["JANEIRO", "FEVEREIRO", "MARCO", "ABRIL", "MAIO", "JUNHO", "JULHO", "AGOSTO", "SETEMBRO", "OUTUBRO", "NOVEMBRO", "DEZEMBRO"]  # noqa: E501
    ...
    @property
    def contract_debtor(self):
        """Gets the contract_debtor of this AutomaticAutomatic.  # noqa: E501


        :return: The contract_debtor of this AutomaticAutomatic.  # noqa: E501
        :rtype: ContractDebtor
        """
        return self._contract_debtor

    @contract_debtor.setter
    def contract_debtor(self, contract_debtor):
        """Sets the contract_debtor of this AutomaticAutomatic.


        :param contract_debtor: The contract_debtor of this AutomaticAutomatic.  # noqa: E501
        :type: ContractDebtor
        """
        if contract_debtor is None:
            raise ValueError("Invalid value for `contract_debtor`, must not be `None`")  # noqa: E501

        self._contract_debtor = contract_debtor

    @property
    def immediate_payment(self):
        """Gets the immediate_payment of this AutomaticAutomatic.  # noqa: E501


        :return: The immediate_payment of this AutomaticAutomatic.  # noqa: E501
        :rtype: ImmediatePayment
        """
        return self._immediate_payment

    @immediate_payment.setter
    def immediate_payment(self, immediate_payment):
        """Sets the immediate_payment of this AutomaticAutomatic.


        :param immediate_payment: The immediate_payment of this AutomaticAutomatic.  # noqa: E501
        :type: ImmediatePayment
        """

        self._immediate_payment = immediate_payment
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AutomaticAutomatic, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AutomaticAutomatic):
            return False
