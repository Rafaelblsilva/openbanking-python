...
class ResponseErrorCreateConsent(object):
    ...
    """
    swagger_types = {
        'errors': 'list[ResponseErrorCreateConsentErrors]',
        'meta': 'Meta'
    }
    ...
    def __init__(self, errors=None, meta=None):  # noqa: E501
        """ResponseErrorCreateConsent - a model defined in Swagger"""  # noqa: E501
        self._errors = None
        self._meta = None
    ...
    @property
    def errors(self):
        """Gets the errors of this ResponseErrorCreateConsent.  # noqa: E501


        :return: The errors of this ResponseErrorCreateConsent.  # noqa: E501
        :rtype: list[ResponseErrorCreateConsentErrors]
        """
        return self._errors

    @errors.setter
    def errors(self, errors):
        """Sets the errors of this ResponseErrorCreateConsent.


        :param errors: The errors of this ResponseErrorCreateConsent.  # noqa: E501
        :type: list[ResponseErrorCreateConsentErrors]
        """
        if errors is None:
    ...
    @property
    def meta(self):
        """Gets the meta of this ResponseErrorCreateConsent.  # noqa: E501


        :return: The meta of this ResponseErrorCreateConsent.  # noqa: E501
        :rtype: Meta
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this ResponseErrorCreateConsent.


        :param meta: The meta of this ResponseErrorCreateConsent.  # noqa: E501
        :type: Meta
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseErrorCreateConsent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseErrorCreateConsent):
            return False
