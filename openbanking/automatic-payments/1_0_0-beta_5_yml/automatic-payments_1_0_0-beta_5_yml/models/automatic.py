...
class Automatic(object):
    ...
    def __init__(self, automatic=None):  # noqa: E501
        """Automatic - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def automatic(self):
        """Gets the automatic of this Automatic.  # noqa: E501


        :return: The automatic of this Automatic.  # noqa: E501
        :rtype: AutomaticAutomatic
        """
        return self._automatic

    @automatic.setter
    def automatic(self, automatic):
        """Sets the automatic of this Automatic.


        :param automatic: The automatic of this Automatic.  # noqa: E501
        :type: AutomaticAutomatic
        """
        if automatic is None:
            raise ValueError("Invalid value for `automatic`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Automatic):
            return False
