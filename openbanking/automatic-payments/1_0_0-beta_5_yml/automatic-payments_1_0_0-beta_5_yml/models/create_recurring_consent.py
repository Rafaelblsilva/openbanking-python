...
class CreateRecurringConsent(object):
    ...
    """
    swagger_types = {
        'data': 'CreateRecurringConsentData'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """CreateRecurringConsent - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this CreateRecurringConsent.  # noqa: E501


        :return: The data of this CreateRecurringConsent.  # noqa: E501
        :rtype: CreateRecurringConsentData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this CreateRecurringConsent.


        :param data: The data of this CreateRecurringConsent.  # noqa: E501
        :type: CreateRecurringConsentData
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateRecurringConsent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRecurringConsent):
            return False
