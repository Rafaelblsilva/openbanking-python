...
class SweepingSweeping(object):
    ...
    def __init__(self, total_allowed_amount=None, transaction_limit=None, periodic_limits=None):  # noqa: E501
        """SweepingSweeping - a model defined in Swagger"""  # noqa: E501
        self._total_allowed_amount = None
        self._transaction_limit = None
        self._periodic_limits = None
        self.discriminator = None
        if total_allowed_amount is not None:
            self.total_allowed_amount = total_allowed_amount
        if transaction_limit is not None:
            self.transaction_limit = transaction_limit
        if periodic_limits is not None:
            self.periodic_limits = periodic_limits

    @property
    def total_allowed_amount(self):
        """Gets the total_allowed_amount of this SweepingSweeping.  # noqa: E501

        Valor máximo a ser atingido pelo somatório de todas as transações que utilizam o consentimento autorizado pelo cliente. Caso o valor seja superado, a detentora de conta deve negar a transação solicitada pela iniciadora.  # noqa: E501

        :return: The total_allowed_amount of this SweepingSweeping.  # noqa: E501
        :rtype: str
        """
        return self._total_allowed_amount

    @total_allowed_amount.setter
    def total_allowed_amount(self, total_allowed_amount):
        """Sets the total_allowed_amount of this SweepingSweeping.

        Valor máximo a ser atingido pelo somatório de todas as transações que utilizam o consentimento autorizado pelo cliente. Caso o valor seja superado, a detentora de conta deve negar a transação solicitada pela iniciadora.  # noqa: E501

        :param total_allowed_amount: The total_allowed_amount of this SweepingSweeping.  # noqa: E501
        :type: str
        """

        self._total_allowed_amount = total_allowed_amount

    @property
    def transaction_limit(self):
        """Gets the transaction_limit of this SweepingSweeping.  # noqa: E501

        Valor máximo para cada transação de pagamento associada a esse consentimento. Caso valor do pagamento seja maior que esse limite, a detentora de contas deve rejeitar a transação de pagamento.  # noqa: E501

        :return: The transaction_limit of this SweepingSweeping.  # noqa: E501
        :rtype: str
        """
    ...
    def transaction_limit(self, transaction_limit):
        """Sets the transaction_limit of this SweepingSweeping.

        Valor máximo para cada transação de pagamento associada a esse consentimento. Caso valor do pagamento seja maior que esse limite, a detentora de contas deve rejeitar a transação de pagamento.  # noqa: E501

        :param transaction_limit: The transaction_limit of this SweepingSweeping.  # noqa: E501
        :type: str
        """
    ...
    def periodic_limits(self):
        """Gets the periodic_limits of this SweepingSweeping.  # noqa: E501


        :return: The periodic_limits of this SweepingSweeping.  # noqa: E501
        :rtype: PeriodicLimits
        """
        return self._periodic_limits

    @periodic_limits.setter
    def periodic_limits(self, periodic_limits):
        """Sets the periodic_limits of this SweepingSweeping.


        :param periodic_limits: The periodic_limits of this SweepingSweeping.  # noqa: E501
        :type: PeriodicLimits
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SweepingSweeping, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SweepingSweeping):
            return False
