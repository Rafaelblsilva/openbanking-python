...
class PixPaymentCancellationCancelledBy(object):
    ...
    """
    swagger_types = {
        'document': 'PixPaymentCancellationCancelledByDocument'
    }
    ...
    def __init__(self, document=None):  # noqa: E501
        """PixPaymentCancellationCancelledBy - a model defined in Swagger"""  # noqa: E501
        self._document = None
    ...
    @property
    def document(self):
        """Gets the document of this PixPaymentCancellationCancelledBy.  # noqa: E501


        :return: The document of this PixPaymentCancellationCancelledBy.  # noqa: E501
        :rtype: PixPaymentCancellationCancelledByDocument
        """
        return self._document

    @document.setter
    def document(self, document):
        """Sets the document of this PixPaymentCancellationCancelledBy.


        :param document: The document of this PixPaymentCancellationCancelledBy.  # noqa: E501
        :type: PixPaymentCancellationCancelledByDocument
        """
        if document is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PixPaymentCancellationCancelledBy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PixPaymentCancellationCancelledBy):
            return False
