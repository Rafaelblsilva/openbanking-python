...
class ResponsePostRecurringConsentDataRevocation(object):
    ...
    swagger_types = {
        ...
        'revoked_from': 'str',
        'revoked_at': 'datetime',
        'reason': 'ResponsePostRecurringConsentDataRevocationReason'
    }
    ...
    def __init__(self, revoked_by=None, revoked_from=None, revoked_at=None, reason=None):  # noqa: E501
        """ResponsePostRecurringConsentDataRevocation - a model defined in Swagger"""  # noqa: E501
        self._revoked_by = None
        self._revoked_from = None
        self._revoked_at = None
        self._reason = None
        self.discriminator = None
        self.revoked_by = revoked_by
        self.revoked_from = revoked_from
    ...
    @property
    def revoked_by(self):
        """Gets the revoked_by of this ResponsePostRecurringConsentDataRevocation.  # noqa: E501

        Quem iniciou a solicitação de revogação   - INICIADORA - USUARIO - DETENTORA   # noqa: E501

        :return: The revoked_by of this ResponsePostRecurringConsentDataRevocation.  # noqa: E501
        :rtype: str
        """
    ...
    def revoked_by(self, revoked_by):
        """Sets the revoked_by of this ResponsePostRecurringConsentDataRevocation.

        Quem iniciou a solicitação de revogação   - INICIADORA - USUARIO - DETENTORA   # noqa: E501

        :param revoked_by: The revoked_by of this ResponsePostRecurringConsentDataRevocation.  # noqa: E501
        :type: str
        """
        if revoked_by is None:
            raise ValueError("Invalid value for `revoked_by`, must not be `None`")  # noqa: E501
        allowed_values = ["INICIADORA", "USUARIO", "DETENTORA"]  # noqa: E501
        if revoked_by not in allowed_values:
            raise ValueError(
                "Invalid value for `revoked_by` ({0}), must be one of {1}"  # noqa: E501
                .format(revoked_by, allowed_values)
            )

        self._revoked_by = revoked_by

    @property
    def revoked_from(self):
        """Gets the revoked_from of this ResponsePostRecurringConsentDataRevocation.  # noqa: E501

        Canal onde iniciou-se o processo de revogação    - INICIADORA   - DETENTORA     # noqa: E501

        :return: The revoked_from of this ResponsePostRecurringConsentDataRevocation.  # noqa: E501
        :rtype: str
        """
        return self._revoked_from

    @revoked_from.setter
    def revoked_from(self, revoked_from):
        """Sets the revoked_from of this ResponsePostRecurringConsentDataRevocation.

        Canal onde iniciou-se o processo de revogação    - INICIADORA   - DETENTORA     # noqa: E501

        :param revoked_from: The revoked_from of this ResponsePostRecurringConsentDataRevocation.  # noqa: E501
        :type: str
        """
        if revoked_from is None:
            raise ValueError("Invalid value for `revoked_from`, must not be `None`")  # noqa: E501
        allowed_values = ["INICIADORA", "DETENTORA"]  # noqa: E501
        if revoked_from not in allowed_values:
            raise ValueError(
                "Invalid value for `revoked_from` ({0}), must be one of {1}"  # noqa: E501
                .format(revoked_from, allowed_values)
            )

        self._revoked_from = revoked_from

    @property
    def revoked_at(self):
        """Gets the revoked_at of this ResponsePostRecurringConsentDataRevocation.  # noqa: E501

        Data e hora em que o consentimento foi revogado  # noqa: E501

        :return: The revoked_at of this ResponsePostRecurringConsentDataRevocation.  # noqa: E501
        :rtype: datetime
        """
    ...
    def revoked_at(self, revoked_at):
        """Sets the revoked_at of this ResponsePostRecurringConsentDataRevocation.

        Data e hora em que o consentimento foi revogado  # noqa: E501

        :param revoked_at: The revoked_at of this ResponsePostRecurringConsentDataRevocation.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def reason(self):
        """Gets the reason of this ResponsePostRecurringConsentDataRevocation.  # noqa: E501


        :return: The reason of this ResponsePostRecurringConsentDataRevocation.  # noqa: E501
        :rtype: ResponsePostRecurringConsentDataRevocationReason
        """
        return self._reason

    @reason.setter
    def reason(self, reason):
        """Sets the reason of this ResponsePostRecurringConsentDataRevocation.


        :param reason: The reason of this ResponsePostRecurringConsentDataRevocation.  # noqa: E501
        :type: ResponsePostRecurringConsentDataRevocationReason
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponsePostRecurringConsentDataRevocation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponsePostRecurringConsentDataRevocation):
            return False
