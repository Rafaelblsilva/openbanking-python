...
class PostCreditorAccount(object):
    ...
    def __init__(self, ispb=None, issuer=None, number=None, account_type=None):  # noqa: E501
        """PostCreditorAccount - a model defined in Swagger"""  # noqa: E501
        self._ispb = None
        self._issuer = None
        self._number = None
    ...
    @property
    def ispb(self):
        """Gets the ispb of this PostCreditorAccount.  # noqa: E501
        ...
        :return: The ispb of this PostCreditorAccount.  # noqa: E501
        :rtype: str
        """
        return self._ispb
    ...
    @ispb.setter
    def ispb(self, ispb):
        """Sets the ispb of this PostCreditorAccount.

        Deve ser preenchido com o ISPB (Identificador do Sistema de Pagamentos Brasileiros) do participante do SPI (Sistema de pagamentos instantâneos) somente com números.   # noqa: E501

        :param ispb: The ispb of this PostCreditorAccount.  # noqa: E501
        :type: str
        """
        if ispb is None:
    ...
    @property
    def issuer(self):
        """Gets the issuer of this PostCreditorAccount.  # noqa: E501
        ...
        :return: The issuer of this PostCreditorAccount.  # noqa: E501
        :rtype: str
        """
        return self._issuer
    ...
    def issuer(self, issuer):
        """Sets the issuer of this PostCreditorAccount.

        Código da Agência emissora da conta sem dígito.  (Agência é a dependência destinada ao atendimento aos clientes, ao público em geral e aos associados de cooperativas de crédito,  no exercício de atividades da instituição, não podendo ser móvel ou transitória).  [Restrição] Preenchimento obrigatório para os seguintes tipos de conta: CACC (CONTA_DEPOSITO_A_VISTA) e SVGS (CONTA_POUPANCA).   # noqa: E501

        :param issuer: The issuer of this PostCreditorAccount.  # noqa: E501
        :type: str
        """
        if issuer is None:
    ...
    @property
    def number(self):
        """Gets the number of this PostCreditorAccount.  # noqa: E501
        ...
        :return: The number of this PostCreditorAccount.  # noqa: E501
        :rtype: str
        """
        return self._number
    ...
    def number(self, number):
        """Sets the number of this PostCreditorAccount.

        Deve ser preenchido com o número da conta transacional do usuário pagador, com dígito verificador (se este existir),  se houver valor alfanumérico, este deve ser convertido para 0.   # noqa: E501

        :param number: The number of this PostCreditorAccount.  # noqa: E501
        :type: str
        """
        if number is None:
    ...
    def account_type(self):
        """Gets the account_type of this PostCreditorAccount.  # noqa: E501


        :return: The account_type of this PostCreditorAccount.  # noqa: E501
    ...
    def account_type(self, account_type):
        """Sets the account_type of this PostCreditorAccount.


        :param account_type: The account_type of this PostCreditorAccount.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PostCreditorAccount, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PostCreditorAccount):
            return False
