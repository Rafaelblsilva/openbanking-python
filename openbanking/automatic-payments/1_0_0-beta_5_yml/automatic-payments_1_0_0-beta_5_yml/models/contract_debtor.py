...
class ContractDebtor(object):
    ...
    swagger_types = {
        'name': 'str',
        'document': 'ContractDebtorDocument'
    }
    ...
    def __init__(self, name=None, document=None):  # noqa: E501
        """ContractDebtor - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._document = None
    ...
    @property
    def name(self):
        """Gets the name of this ContractDebtor.  # noqa: E501

        Em caso de pessoa natural deve ser informado o nome completo do titular devedor do contrato.  # noqa: E501

        :return: The name of this ContractDebtor.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ContractDebtor.

        Em caso de pessoa natural deve ser informado o nome completo do titular devedor do contrato.  # noqa: E501

        :param name: The name of this ContractDebtor.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def document(self):
        """Gets the document of this ContractDebtor.  # noqa: E501


        :return: The document of this ContractDebtor.  # noqa: E501
        :rtype: ContractDebtorDocument
        """
        return self._document

    @document.setter
    def document(self, document):
        """Sets the document of this ContractDebtor.


        :param document: The document of this ContractDebtor.  # noqa: E501
        :type: ContractDebtorDocument
        """
        if document is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContractDebtor, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContractDebtor):
            return False
