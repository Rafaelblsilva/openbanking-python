...
class Sweeping(object):
    ...
    def __init__(self, sweeping=None):  # noqa: E501
        """Sweeping - a model defined in Swagger"""  # noqa: E501
        self._sweeping = None
    ...
    @property
    def sweeping(self):
        """Gets the sweeping of this Sweeping.  # noqa: E501


        :return: The sweeping of this Sweeping.  # noqa: E501
        :rtype: SweepingSweeping
        """
        return self._sweeping

    @sweeping.setter
    def sweeping(self, sweeping):
        """Sets the sweeping of this Sweeping.


        :param sweeping: The sweeping of this Sweeping.  # noqa: E501
        :type: SweepingSweeping
        """
        if sweeping is None:
            raise ValueError("Invalid value for `sweeping`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Sweeping):
            return False
