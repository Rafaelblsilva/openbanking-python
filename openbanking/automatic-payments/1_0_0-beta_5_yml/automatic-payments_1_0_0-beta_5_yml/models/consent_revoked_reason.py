...
class ConsentRevokedReason(object):
    ...
    def __init__(self, code=None, detail=None):  # noqa: E501
        """ConsentRevokedReason - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._detail = None
    ...
    @property
    def code(self):
        """Gets the code of this ConsentRevokedReason.  # noqa: E501

        Código indicador do motivo de revogação. - REVOGADO_RECEBEDOR - REVOGADO_USUARIO - NAO_INFORMADO   # noqa: E501

        :return: The code of this ConsentRevokedReason.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this ConsentRevokedReason.

        Código indicador do motivo de revogação. - REVOGADO_RECEBEDOR - REVOGADO_USUARIO - NAO_INFORMADO   # noqa: E501

        :param code: The code of this ConsentRevokedReason.  # noqa: E501
        :type: str
        """
        if code is None:
            raise ValueError("Invalid value for `code`, must not be `None`")  # noqa: E501
        allowed_values = ["REVOGADO_RECEBEDOR", "REVOGADO_USUARIO", "NAO_INFORMADO"]  # noqa: E501
    ...
    @property
    def detail(self):
        """Gets the detail of this ConsentRevokedReason.  # noqa: E501
        ...
        :return: The detail of this ConsentRevokedReason.  # noqa: E501
        :rtype: str
        """
        return self._detail
    ...
    def detail(self, detail):
        """Sets the detail of this ConsentRevokedReason.

        Detalhe sobre o motivo de revogação indicado no campo `/data/revocation/reason/code`. - NAO_INFORMADO: Não informada pela detentora de conta; - REVOGADO_USUARIO: O usuário pagador revogou a recorrência do consentimento; - REVOGADO_RECEBEDOR: O usuário recebedor revogou a recorrência do consentimento.   # noqa: E501

        :param detail: The detail of this ConsentRevokedReason.  # noqa: E501
        :type: str
        """
        if detail is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConsentRevokedReason, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConsentRevokedReason):
            return False
