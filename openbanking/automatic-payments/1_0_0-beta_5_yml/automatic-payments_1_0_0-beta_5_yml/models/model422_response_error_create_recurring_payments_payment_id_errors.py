...
class Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors(object):
    ...
    def __init__(self, code=None, title=None, detail=None):  # noqa: E501
        """Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._title = None
        self._detail = None
    ...
    @property
    def code(self):
        """Gets the code of this Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors.  # noqa: E501

        - PAGAMENTO_NAO_PERMITE_CANCELAMENTO: Pagamento está com um status que não permite cancelamento - CANCELAMENTO_FORA_PERIODO_PERMITIDO: O usuário solicitou o cancelamento fora da janela de tempo permitido.   # noqa: E501

        :return: The code of this Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors.

        - PAGAMENTO_NAO_PERMITE_CANCELAMENTO: Pagamento está com um status que não permite cancelamento - CANCELAMENTO_FORA_PERIODO_PERMITIDO: O usuário solicitou o cancelamento fora da janela de tempo permitido.   # noqa: E501

        :param code: The code of this Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors.  # noqa: E501
        :type: str
        """
        if code is None:
            raise ValueError("Invalid value for `code`, must not be `None`")  # noqa: E501
        allowed_values = ["PAGAMENTO_NAO_PERMITE_CANCELAMENTO", "CANCELAMENTO_FORA_PERIODO_PERMITIDO"]  # noqa: E501
    ...
    @property
    def title(self):
        """Gets the title of this Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors.  # noqa: E501

        - PAGAMENTO_NAO_PERMITE_CANCELAMENTO: Pagamento está com um status que não permite cancelamento - CANCELAMENTO_FORA_PERIODO_PERMITIDO: O usuário solicitou o cancelamento fora da janela de tempo permitido.   # noqa: E501

        :return: The title of this Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors.

        - PAGAMENTO_NAO_PERMITE_CANCELAMENTO: Pagamento está com um status que não permite cancelamento - CANCELAMENTO_FORA_PERIODO_PERMITIDO: O usuário solicitou o cancelamento fora da janela de tempo permitido.   # noqa: E501

        :param title: The title of this Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors.  # noqa: E501
        :type: str
        """
        if title is None:
    ...
    @property
    def detail(self):
        """Gets the detail of this Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors.  # noqa: E501

        - PAGAMENTO_NAO_PERMITE_CANCELAMENTO: Pagamento está com um status que não permite cancelamento - CANCELAMENTO_FORA_PERIODO_PERMITIDO: O usuário solicitou o cancelamento fora da janela de tempo permitido.   # noqa: E501

        :return: The detail of this Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors.  # noqa: E501
        :rtype: str
        """
        return self._detail
    ...
    def detail(self, detail):
        """Sets the detail of this Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors.

        - PAGAMENTO_NAO_PERMITE_CANCELAMENTO: Pagamento está com um status que não permite cancelamento - CANCELAMENTO_FORA_PERIODO_PERMITIDO: O usuário solicitou o cancelamento fora da janela de tempo permitido.   # noqa: E501

        :param detail: The detail of this Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors.  # noqa: E501
        :type: str
        """
        if detail is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrors):
            return False
