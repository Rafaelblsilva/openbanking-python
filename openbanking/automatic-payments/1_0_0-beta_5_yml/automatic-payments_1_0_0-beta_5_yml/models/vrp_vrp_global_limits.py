...
class VrpVrpGlobalLimits(object):
    ...
    def __init__(self, quantity_limit=None, transaction_limit=None):  # noqa: E501
        """VrpVrpGlobalLimits - a model defined in Swagger"""  # noqa: E501
    ...
    def quantity_limit(self):
        """Gets the quantity_limit of this VrpVrpGlobalLimits.  # noqa: E501

        Quantidade máxima de ocorrência  de pagamentos, após atingir este valor, o consentimento deve ir para o status \"CONSUMED\"  # noqa: E501

        :return: The quantity_limit of this VrpVrpGlobalLimits.  # noqa: E501
        :rtype: int
        """
    ...
    def quantity_limit(self, quantity_limit):
        """Sets the quantity_limit of this VrpVrpGlobalLimits.

        Quantidade máxima de ocorrência  de pagamentos, após atingir este valor, o consentimento deve ir para o status \"CONSUMED\"  # noqa: E501

        :param quantity_limit: The quantity_limit of this VrpVrpGlobalLimits.  # noqa: E501
        :type: int
        """
    ...
    def transaction_limit(self):
        """Gets the transaction_limit of this VrpVrpGlobalLimits.  # noqa: E501

        Valor transacional máximo para pagamentos sob este consentimento, após atingir este valor, o consentimento deve ir para o status \"CONSUMED\".  # noqa: E501

        :return: The transaction_limit of this VrpVrpGlobalLimits.  # noqa: E501
        :rtype: str
        """
    ...
    def transaction_limit(self, transaction_limit):
        """Sets the transaction_limit of this VrpVrpGlobalLimits.

        Valor transacional máximo para pagamentos sob este consentimento, após atingir este valor, o consentimento deve ir para o status \"CONSUMED\".  # noqa: E501

        :param transaction_limit: The transaction_limit of this VrpVrpGlobalLimits.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VrpVrpGlobalLimits, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VrpVrpGlobalLimits):
            return False
