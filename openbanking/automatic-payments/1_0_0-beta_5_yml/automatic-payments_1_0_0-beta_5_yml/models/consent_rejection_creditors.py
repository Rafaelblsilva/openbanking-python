...
class ConsentRejectionCreditors(object):
    ...
    def __init__(self, name=None):  # noqa: E501
        """ConsentRejectionCreditors - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this ConsentRejectionCreditors.  # noqa: E501
        ...
        :return: The name of this ConsentRejectionCreditors.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ConsentRejectionCreditors.

        Em caso de pessoa natural deve ser informado o nome completo do titular da conta do recebedor.   Em caso de pessoa jurídica deve ser informada a razão social ou o nome fantasia da conta do recebedor.   # noqa: E501

        :param name: The name of this ConsentRejectionCreditors.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConsentRejectionCreditors, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConsentRejectionCreditors):
            return False
