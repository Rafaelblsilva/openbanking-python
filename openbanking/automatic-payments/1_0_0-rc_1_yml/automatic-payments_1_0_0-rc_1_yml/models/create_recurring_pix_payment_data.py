...
class CreateRecurringPixPaymentData(object):
    ...
    swagger_types = {
        ...
        'risk_signals': 'RiskSignalsPayments',
    ...
    def __init__(self, recurring_consent_id=None, end_to_end_id=None, _date=None, payment=None, creditor_account=None, remittance_information=None, cnpj_initiator=None, ibge_town_code=None, authorisation_flow=None, risk_signals=None, local_instrument=None, proxy=None, transaction_identification=None, document=None):  # noqa: E501
        """CreateRecurringPixPaymentData - a model defined in Swagger"""  # noqa: E501
    ...
    def recurring_consent_id(self):
        """Gets the recurring_consent_id of this CreateRecurringPixPaymentData.  # noqa: E501

        Identificador único do consentimento de longa duração criado para a iniciação de pagamento solicitada. Deverá ser um URN - Uniform Resource Name.  Um URN, conforme definido na [RFC8141](https://tools.ietf.org/html/rfc8141) é um Uniform Resource  Identifier - URI - que é atribuído sob o URI scheme \"urn\" e um namespace URN específico, com a intenção de que o URN  seja um identificador de recurso persistente e independente da localização.  Considerando a string urn:bancoex:C1DD33123 como exemplo para `recurringConsentId` temos: - o namespace(urn) - o identificador associado ao namespace da instituição transmissora (bancoex) - o identificador específico dentro do namespace (C1DD33123). Informações mais detalhadas sobre a construção de namespaces devem ser consultadas na [RFC8141](https://tools.ietf.org/html/rfc8141).  [Restrição] Este campo é de preenchimento obrigatório quando o valor do campo authorisationFlow for igual a FIDO_FLOW.   # noqa: E501

        :return: The recurring_consent_id of this CreateRecurringPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def recurring_consent_id(self, recurring_consent_id):
        """Sets the recurring_consent_id of this CreateRecurringPixPaymentData.

        Identificador único do consentimento de longa duração criado para a iniciação de pagamento solicitada. Deverá ser um URN - Uniform Resource Name.  Um URN, conforme definido na [RFC8141](https://tools.ietf.org/html/rfc8141) é um Uniform Resource  Identifier - URI - que é atribuído sob o URI scheme \"urn\" e um namespace URN específico, com a intenção de que o URN  seja um identificador de recurso persistente e independente da localização.  Considerando a string urn:bancoex:C1DD33123 como exemplo para `recurringConsentId` temos: - o namespace(urn) - o identificador associado ao namespace da instituição transmissora (bancoex) - o identificador específico dentro do namespace (C1DD33123). Informações mais detalhadas sobre a construção de namespaces devem ser consultadas na [RFC8141](https://tools.ietf.org/html/rfc8141).  [Restrição] Este campo é de preenchimento obrigatório quando o valor do campo authorisationFlow for igual a FIDO_FLOW.   # noqa: E501

        :param recurring_consent_id: The recurring_consent_id of this CreateRecurringPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    def end_to_end_id(self):
        """Gets the end_to_end_id of this CreateRecurringPixPaymentData.  # noqa: E501


        :return: The end_to_end_id of this CreateRecurringPixPaymentData.  # noqa: E501
        :rtype: EndToEndIdPost
        """
        return self._end_to_end_id

    @end_to_end_id.setter
    def end_to_end_id(self, end_to_end_id):
        """Sets the end_to_end_id of this CreateRecurringPixPaymentData.


        :param end_to_end_id: The end_to_end_id of this CreateRecurringPixPaymentData.  # noqa: E501
        :type: EndToEndIdPost
        """
    ...
    @property
    def _date(self):
        """Gets the _date of this CreateRecurringPixPaymentData.  # noqa: E501

        Data em que o pagamento será realizado.  # noqa: E501

        :return: The _date of this CreateRecurringPixPaymentData.  # noqa: E501
        :rtype: date
        """
        return self.__date
    ...
    def _date(self, _date):
        """Sets the _date of this CreateRecurringPixPaymentData.

        Data em que o pagamento será realizado.  # noqa: E501

        :param _date: The _date of this CreateRecurringPixPaymentData.  # noqa: E501
        :type: date
        """
        if _date is None:
    ...
    @property
    def payment(self):
        """Gets the payment of this CreateRecurringPixPaymentData.  # noqa: E501


        :return: The payment of this CreateRecurringPixPaymentData.  # noqa: E501
        :rtype: PaymentPix
        """
    ...
    def payment(self, payment):
        """Sets the payment of this CreateRecurringPixPaymentData.


        :param payment: The payment of this CreateRecurringPixPaymentData.  # noqa: E501
        :type: PaymentPix
        """
        if payment is None:
    ...
    def creditor_account(self):
        """Gets the creditor_account of this CreateRecurringPixPaymentData.  # noqa: E501


        :return: The creditor_account of this CreateRecurringPixPaymentData.  # noqa: E501
    ...
    def creditor_account(self, creditor_account):
        """Sets the creditor_account of this CreateRecurringPixPaymentData.


        :param creditor_account: The creditor_account of this CreateRecurringPixPaymentData.  # noqa: E501
    ...
    def remittance_information(self):
        """Gets the remittance_information of this CreateRecurringPixPaymentData.  # noqa: E501
        ...
        :return: The remittance_information of this CreateRecurringPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def remittance_information(self, remittance_information):
        """Sets the remittance_information of this CreateRecurringPixPaymentData.

        Deve ser preenchido sempre que o usuário pagador inserir alguma informação adicional em um pagamento, a ser enviada ao recebedor.   # noqa: E501

        :param remittance_information: The remittance_information of this CreateRecurringPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    def cnpj_initiator(self):
        """Gets the cnpj_initiator of this CreateRecurringPixPaymentData.  # noqa: E501

        CNPJ do Iniciador de Pagamento devidamente habilitado para a prestação de Serviço de Iniciação no Pix.  # noqa: E501

        :return: The cnpj_initiator of this CreateRecurringPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def cnpj_initiator(self, cnpj_initiator):
        """Sets the cnpj_initiator of this CreateRecurringPixPaymentData.

        CNPJ do Iniciador de Pagamento devidamente habilitado para a prestação de Serviço de Iniciação no Pix.  # noqa: E501

        :param cnpj_initiator: The cnpj_initiator of this CreateRecurringPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    def ibge_town_code(self):
        """Gets the ibge_town_code of this CreateRecurringPixPaymentData.  # noqa: E501

        O campo ibgeTownCode no arranjo Pix tem o mesmo comportamento que o campo codMun descrito no item 1.6.6 do manual do Pix.  Caso a informação referente ao município não seja enviada, o PSP do recebedor assumirá que não existem feriados estaduais e municipais no período em questão;   # noqa: E501

        :return: The ibge_town_code of this CreateRecurringPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def ibge_town_code(self, ibge_town_code):
        """Sets the ibge_town_code of this CreateRecurringPixPaymentData.

        O campo ibgeTownCode no arranjo Pix tem o mesmo comportamento que o campo codMun descrito no item 1.6.6 do manual do Pix.  Caso a informação referente ao município não seja enviada, o PSP do recebedor assumirá que não existem feriados estaduais e municipais no período em questão;   # noqa: E501

        :param ibge_town_code: The ibge_town_code of this CreateRecurringPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    def authorisation_flow(self):
        """Gets the authorisation_flow of this CreateRecurringPixPaymentData.  # noqa: E501
        ...
        :return: The authorisation_flow of this CreateRecurringPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def authorisation_flow(self, authorisation_flow):
        """Sets the authorisation_flow of this CreateRecurringPixPaymentData.

        Campo condicional utilizado para identificar o fluxo de autorização em que o pagamento foi solicitado.  [Restrição] Se CIBA ou FIDO, preenchimento obrigatório. Caso o campo não esteja presente no payload, subentende-se que o fluxo de autorização utilizado é o HYBRID_FLOW.   # noqa: E501

        :param authorisation_flow: The authorisation_flow of this CreateRecurringPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    def risk_signals(self):
        """Gets the risk_signals of this CreateRecurringPixPaymentData.  # noqa: E501


        :return: The risk_signals of this CreateRecurringPixPaymentData.  # noqa: E501
        :rtype: RiskSignalsPayments
        """
        return self._risk_signals

    @risk_signals.setter
    def risk_signals(self, risk_signals):
        """Sets the risk_signals of this CreateRecurringPixPaymentData.


        :param risk_signals: The risk_signals of this CreateRecurringPixPaymentData.  # noqa: E501
        :type: RiskSignalsPayments
        """
    ...
    def local_instrument(self):
        """Gets the local_instrument of this CreateRecurringPixPaymentData.  # noqa: E501
        ...
        :return: The local_instrument of this CreateRecurringPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def local_instrument(self, local_instrument):
        """Sets the local_instrument of this CreateRecurringPixPaymentData.

        Especifica a forma de iniciação do pagamento - MANU - Inserção manual de dados da conta transacional - DICT - Inserção manual de chave Pix - INIC - Indica que o recebedor (creditor) contratou o Iniciador de Pagamentos especificamente para realizar iniciações de pagamento em que o beneficiário é previamente conhecido   # noqa: E501

        :param local_instrument: The local_instrument of this CreateRecurringPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def proxy(self):
        """Gets the proxy of this CreateRecurringPixPaymentData.  # noqa: E501
        ...
        :return: The proxy of this CreateRecurringPixPaymentData.  # noqa: E501
        :rtype: str
        """
        return self._proxy
    ...
    def proxy(self, proxy):
        """Sets the proxy of this CreateRecurringPixPaymentData.

        Chave cadastrada no DICT pertencente ao recebedor. Os tipos de chaves podem ser: telefone, e-mail, cpf/cnpj ou chave aleatória.  No caso de telefone celular deve ser informado no padrão E.1641. Para e-mail deve ter o formato xxxxxxxx@xxxxxxx.xxx(.xx) e no máximo 77 caracteres.  No caso de CPF deverá ser informado com 11 números, sem pontos ou traços. Para o caso de CNPJ deverá ser informado com 14 números, sem pontos ou traços.  No caso de chave aleatória deve ser informado o UUID gerado pelo DICT, conforme formato especificado na [RFC4122](https://tools.ietf.org/html/rfc4122).  Se informado, a detentora da conta deve validar o proxy no DICT quando localInstrument for igual a DICT e validar o campo creditorAccount.  Esta validação é opcional caso o localInstrument for igual a INIC.  [Restrição] Se localInstrument for igual a DICT, o campo proxy deve ser preenchido.   # noqa: E501

        :param proxy: The proxy of this CreateRecurringPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    def transaction_identification(self):
        """Gets the transaction_identification of this CreateRecurringPixPaymentData.  # noqa: E501

        Trata-se de um identificador de transação que deve ser retransmitido intacto pelo PSP do pagador ao gerar a ordem de pagamento.  Essa informação permitirá ao recebedor identificar e correlacionar a transferência, quando recebida, com a apresentação das instruções ao pagador.  Os caracteres permitidos no contexto do Pix para o campo txid (EMV 62-05) são:Letras minúsculas, de 'a' a 'z' Letras maiúsculas, de 'A' a 'z' Dígitos decimais, de '0' a '9'.  [Restrição] Preenchimento condicional de acordo com o conteúdo do campo localInstument: - MANU - O campo transactionIdentification não deve ser preenchido; - DICT - O campo transactionIdentification não deve ser preenchido; - INIC - O campo transactionIdentification deve ser preenchido obrigatoriamente e deve conter até 25 caracteres alfanuméricos ([a-z|A-Z|0-9]).   # noqa: E501

        :return: The transaction_identification of this CreateRecurringPixPaymentData.  # noqa: E501
        :rtype: str
        """
    ...
    def transaction_identification(self, transaction_identification):
        """Sets the transaction_identification of this CreateRecurringPixPaymentData.

        Trata-se de um identificador de transação que deve ser retransmitido intacto pelo PSP do pagador ao gerar a ordem de pagamento.  Essa informação permitirá ao recebedor identificar e correlacionar a transferência, quando recebida, com a apresentação das instruções ao pagador.  Os caracteres permitidos no contexto do Pix para o campo txid (EMV 62-05) são:Letras minúsculas, de 'a' a 'z' Letras maiúsculas, de 'A' a 'z' Dígitos decimais, de '0' a '9'.  [Restrição] Preenchimento condicional de acordo com o conteúdo do campo localInstument: - MANU - O campo transactionIdentification não deve ser preenchido; - DICT - O campo transactionIdentification não deve ser preenchido; - INIC - O campo transactionIdentification deve ser preenchido obrigatoriamente e deve conter até 25 caracteres alfanuméricos ([a-z|A-Z|0-9]).   # noqa: E501

        :param transaction_identification: The transaction_identification of this CreateRecurringPixPaymentData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def document(self):
        """Gets the document of this CreateRecurringPixPaymentData.  # noqa: E501


        :return: The document of this CreateRecurringPixPaymentData.  # noqa: E501
    ...
    def document(self, document):
        """Sets the document of this CreateRecurringPixPaymentData.


        :param document: The document of this CreateRecurringPixPaymentData.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateRecurringPixPaymentData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRecurringPixPaymentData):
            return False
