...
class ResponseRecurringConsentPatchDataRejection(object):
    ...
    def __init__(self, rejected_by=None, rejected_from=None, rejected_at=None, reason=None):  # noqa: E501
        """ResponseRecurringConsentPatchDataRejection - a model defined in Swagger"""  # noqa: E501
        self._rejected_by = None
        self._rejected_from = None
        self._rejected_at = None
        self._reason = None
        self.discriminator = None
        self.rejected_by = rejected_by
        self.rejected_from = rejected_from
    ...
    def rejected_by(self):
        """Gets the rejected_by of this ResponseRecurringConsentPatchDataRejection.  # noqa: E501

        Quem iniciou a solicitação de rejeição - INICIADORA - USUARIO - DETENTORA   # noqa: E501

        :return: The rejected_by of this ResponseRecurringConsentPatchDataRejection.  # noqa: E501
        :rtype: str
        """
    ...
    def rejected_by(self, rejected_by):
        """Sets the rejected_by of this ResponseRecurringConsentPatchDataRejection.

        Quem iniciou a solicitação de rejeição - INICIADORA - USUARIO - DETENTORA   # noqa: E501

        :param rejected_by: The rejected_by of this ResponseRecurringConsentPatchDataRejection.  # noqa: E501
        :type: str
        """
        ...
        if rejected_by not in allowed_values:
            raise ValueError(
                "Invalid value for `rejected_by` ({0}), must be one of {1}"  # noqa: E501
                .format(rejected_by, allowed_values)
            )

        self._rejected_by = rejected_by

    @property
    def rejected_from(self):
        """Gets the rejected_from of this ResponseRecurringConsentPatchDataRejection.  # noqa: E501

        Canal onde iniciou-se o processo de rejeição  - INICIADORA - DETENTORA   # noqa: E501

        :return: The rejected_from of this ResponseRecurringConsentPatchDataRejection.  # noqa: E501
        :rtype: str
        """
        return self._rejected_from

    @rejected_from.setter
    def rejected_from(self, rejected_from):
        """Sets the rejected_from of this ResponseRecurringConsentPatchDataRejection.

        Canal onde iniciou-se o processo de rejeição  - INICIADORA - DETENTORA   # noqa: E501

        :param rejected_from: The rejected_from of this ResponseRecurringConsentPatchDataRejection.  # noqa: E501
        :type: str
        """
        if rejected_from is None:
            raise ValueError("Invalid value for `rejected_from`, must not be `None`")  # noqa: E501
        allowed_values = ["INICIADORA", "DETENTORA"]  # noqa: E501
        if rejected_from not in allowed_values:
            raise ValueError(
                "Invalid value for `rejected_from` ({0}), must be one of {1}"  # noqa: E501
                .format(rejected_from, allowed_values)
            )

        self._rejected_from = rejected_from

    @property
    def rejected_at(self):
        """Gets the rejected_at of this ResponseRecurringConsentPatchDataRejection.  # noqa: E501

        Data e hora em que o consentimento foi rejeitado  # noqa: E501

        :return: The rejected_at of this ResponseRecurringConsentPatchDataRejection.  # noqa: E501
        :rtype: datetime
        """
    ...
    def rejected_at(self, rejected_at):
        """Sets the rejected_at of this ResponseRecurringConsentPatchDataRejection.

        Data e hora em que o consentimento foi rejeitado  # noqa: E501

        :param rejected_at: The rejected_at of this ResponseRecurringConsentPatchDataRejection.  # noqa: E501
        :type: datetime
        """
        if rejected_at is None:
            raise ValueError("Invalid value for `rejected_at`, must not be `None`")  # noqa: E501

        self._rejected_at = rejected_at

    @property
    def reason(self):
        """Gets the reason of this ResponseRecurringConsentPatchDataRejection.  # noqa: E501


        :return: The reason of this ResponseRecurringConsentPatchDataRejection.  # noqa: E501
    ...
    def reason(self, reason):
        """Sets the reason of this ResponseRecurringConsentPatchDataRejection.


        :param reason: The reason of this ResponseRecurringConsentPatchDataRejection.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseRecurringConsentPatchDataRejection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseRecurringConsentPatchDataRejection):
            return False
