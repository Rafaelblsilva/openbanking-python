...
class ResponseRecurringPaymentsDataRead(object):
    ...
    def __init__(self, recurring_payment_id=None, recurring_consent_id=None, end_to_end_id=None, _date=None, creation_date_time=None, status_update_date_time=None, ibge_town_code=None, status=None, rejection_reason=None, cnpj_initiator=None, payment=None, remittance_information=None, creditor_account=None, debtor_account=None, cancellation=None, authorisation_flow=None, transaction_identification=None, document=None):  # noqa: E501
        """ResponseRecurringPaymentsDataRead - a model defined in Swagger"""  # noqa: E501
    ...
    def recurring_payment_id(self):
        """Gets the recurring_payment_id of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        ...
        :return: The recurring_payment_id of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :rtype: str
        """
    ...
    def recurring_payment_id(self, recurring_payment_id):
        """Sets the recurring_payment_id of this ResponseRecurringPaymentsDataRead.

        Código ou identificador único informado pela instituição detentora da conta para representar a iniciação de pagamento. O `recurringPaymentId` deve ser diferente do `endToEndId`.  Este é o identificador que deverá ser utilizado na consulta ao status da iniciação de pagamento efetuada.   # noqa: E501

        :param recurring_payment_id: The recurring_payment_id of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :type: str
        """
    ...
    def recurring_consent_id(self):
        """Gets the recurring_consent_id of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        ...
        :return: The recurring_consent_id of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :rtype: str
        """
    ...
    def recurring_consent_id(self, recurring_consent_id):
        """Sets the recurring_consent_id of this ResponseRecurringPaymentsDataRead.

        Identificador único do consentimento criado para a iniciação de pagamento solicitada. Deverá ser um URN - Uniform Resource Name. Um URN, conforme definido na [RFC8141](https://tools.ietf.org/html/rfc8141) é um Uniform Resource Identifier - URI - que é atribuído sob o URI scheme \"urn\" e um namespace URN específico, com a intenção de que o URN seja um identificador de recurso persistente e independente da localização. Considerando a string urn:bancoex:C1DD33123 como exemplo para `recurringConsentId` temos: - o namespace(urn) - o identificador associado ao namespace da instituição transmissora (bancoex) - o identificador específico dentro do namespace (C1DD33123). Informações mais detalhadas sobre a construção de namespaces devem ser consultadas na [RFC8141](https://tools.ietf.org/html/rfc8141).  [Restrição] Este campo é de preenchimento obrigatório quando o valor do campo authorisationFlow for igual a FIDO_FLOW.   # noqa: E501

        :param recurring_consent_id: The recurring_consent_id of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :type: str
        """
    ...
    def end_to_end_id(self):
        """Gets the end_to_end_id of this ResponseRecurringPaymentsDataRead.  # noqa: E501


        :return: The end_to_end_id of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :rtype: EndToEndId
        """
    ...
    def end_to_end_id(self, end_to_end_id):
        """Sets the end_to_end_id of this ResponseRecurringPaymentsDataRead.


        :param end_to_end_id: The end_to_end_id of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :type: EndToEndId
        """
    ...
    @property
    def _date(self):
        """Gets the _date of this ResponseRecurringPaymentsDataRead.  # noqa: E501

        Data em que o pagamento será realizado.  # noqa: E501

        :return: The _date of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :rtype: str
        """
        return self.__date
    ...
    def _date(self, _date):
        """Sets the _date of this ResponseRecurringPaymentsDataRead.

        Data em que o pagamento será realizado.  # noqa: E501

        :param _date: The _date of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :type: str
        """
        if _date is None:
    ...
    def creation_date_time(self):
        """Gets the creation_date_time of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        ...
        :return: The creation_date_time of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :rtype: datetime
        """
    ...
    def creation_date_time(self, creation_date_time):
        """Sets the creation_date_time of this ResponseRecurringPaymentsDataRead.

        Data e hora em que o pagamento foi criado.  Uma string com data e hora conforme especificação [RFC-3339](https://datatracker.ietf.org/doc/html/rfc3339),  sempre com a utilização de timezone UTC(UTC time format).   # noqa: E501

        :param creation_date_time: The creation_date_time of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :type: datetime
        """
    ...
    def status_update_date_time(self):
        """Gets the status_update_date_time of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        ...
        :return: The status_update_date_time of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :rtype: datetime
        """
    ...
    def status_update_date_time(self, status_update_date_time):
        """Sets the status_update_date_time of this ResponseRecurringPaymentsDataRead.

        Data e hora em que o pagamento teve o status atualizado.  Uma string com data e hora conforme especificação [RFC-3339](https://datatracker.ietf.org/doc/html/rfc3339),  sempre com a utilização de timezone UTC(UTC time format).   # noqa: E501

        :param status_update_date_time: The status_update_date_time of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :type: datetime
        """
    ...
    def ibge_town_code(self):
        """Gets the ibge_town_code of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        ...
        :return: The ibge_town_code of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :rtype: str
        """
    ...
    def ibge_town_code(self, ibge_town_code):
        """Sets the ibge_town_code of this ResponseRecurringPaymentsDataRead.

        O campo ibgeTownCode no arranjo Pix tem o mesmo comportamento que o campo codMun descrito no item 1.6.6 do manual do Pix.  1. Caso a informação referente ao município não seja enviada, o PSP do recebedor assumirá que não existem feriados estaduais e municipais no período em questão;   # noqa: E501

        :param ibge_town_code: The ibge_town_code of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this ResponseRecurringPaymentsDataRead.  # noqa: E501


        :return: The status of this ResponseRecurringPaymentsDataRead.  # noqa: E501
    ...
    def status(self, status):
        """Sets the status of this ResponseRecurringPaymentsDataRead.


        :param status: The status of this ResponseRecurringPaymentsDataRead.  # noqa: E501
    ...
    def rejection_reason(self):
        """Gets the rejection_reason of this ResponseRecurringPaymentsDataRead.  # noqa: E501


        :return: The rejection_reason of this ResponseRecurringPaymentsDataRead.  # noqa: E501
    ...
    def rejection_reason(self, rejection_reason):
        """Sets the rejection_reason of this ResponseRecurringPaymentsDataRead.


        :param rejection_reason: The rejection_reason of this ResponseRecurringPaymentsDataRead.  # noqa: E501
    ...
    def cnpj_initiator(self):
        """Gets the cnpj_initiator of this ResponseRecurringPaymentsDataRead.  # noqa: E501

        CNPJ do Iniciador de Pagamento devidamente habilitado para a prestação de Serviço de Iniciação no Pix.  # noqa: E501

        :return: The cnpj_initiator of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :rtype: str
        """
    ...
    def cnpj_initiator(self, cnpj_initiator):
        """Sets the cnpj_initiator of this ResponseRecurringPaymentsDataRead.

        CNPJ do Iniciador de Pagamento devidamente habilitado para a prestação de Serviço de Iniciação no Pix.  # noqa: E501

        :param cnpj_initiator: The cnpj_initiator of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :type: str
        """
    ...
    @property
    def payment(self):
        """Gets the payment of this ResponseRecurringPaymentsDataRead.  # noqa: E501


        :return: The payment of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :rtype: PaymentPix
        """
    ...
    def payment(self, payment):
        """Sets the payment of this ResponseRecurringPaymentsDataRead.


        :param payment: The payment of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :type: PaymentPix
        """
        if payment is None:
    ...
    def remittance_information(self):
        """Gets the remittance_information of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        ...
        :return: The remittance_information of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :rtype: str
        """
    ...
    def remittance_information(self, remittance_information):
        """Sets the remittance_information of this ResponseRecurringPaymentsDataRead.

        Deve ser preenchido sempre que o usuário pagador inserir alguma informação adicional em um pagamento, a ser enviada ao recebedor.   # noqa: E501

        :param remittance_information: The remittance_information of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :type: str
        """
    ...
    def creditor_account(self):
        """Gets the creditor_account of this ResponseRecurringPaymentsDataRead.  # noqa: E501


        :return: The creditor_account of this ResponseRecurringPaymentsDataRead.  # noqa: E501
    ...
    def creditor_account(self, creditor_account):
        """Sets the creditor_account of this ResponseRecurringPaymentsDataRead.


        :param creditor_account: The creditor_account of this ResponseRecurringPaymentsDataRead.  # noqa: E501
    ...
    def debtor_account(self):
        """Gets the debtor_account of this ResponseRecurringPaymentsDataRead.  # noqa: E501


        :return: The debtor_account of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :rtype: DebtorAccount
        """
    ...
    def debtor_account(self, debtor_account):
        """Sets the debtor_account of this ResponseRecurringPaymentsDataRead.


        :param debtor_account: The debtor_account of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :type: DebtorAccount
        """
    ...
    def cancellation(self):
        """Gets the cancellation of this ResponseRecurringPaymentsDataRead.  # noqa: E501


        :return: The cancellation of this ResponseRecurringPaymentsDataRead.  # noqa: E501
    ...
    def cancellation(self, cancellation):
        """Sets the cancellation of this ResponseRecurringPaymentsDataRead.


        :param cancellation: The cancellation of this ResponseRecurringPaymentsDataRead.  # noqa: E501
    ...
    def authorisation_flow(self):
        """Gets the authorisation_flow of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        ...
        :return: The authorisation_flow of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :rtype: str
        """
    ...
    def authorisation_flow(self, authorisation_flow):
        """Sets the authorisation_flow of this ResponseRecurringPaymentsDataRead.

        Campo condicional utilizado para identificar o fluxo de autorização em que o pagamento foi solicitado.  [Restrição] Se CIBA ou FIDO, preenchimento obrigatório. Caso o campo não esteja presente no payload, subentende-se que o fluxo de autorização utilizado é o HYBRID_FLOW.   # noqa: E501

        :param authorisation_flow: The authorisation_flow of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :type: str
        """
    ...
    def transaction_identification(self):
        """Gets the transaction_identification of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        ...
        :return: The transaction_identification of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :rtype: str
        """
    ...
    def transaction_identification(self, transaction_identification):
        """Sets the transaction_identification of this ResponseRecurringPaymentsDataRead.

        Trata-se de um identificador de transação que deve ser retransmitido intacto pelo PSP do pagador ao gerar a ordem de pagamento.  Essa informação permitirá ao recebedor identificar e correlacionar a transferência, quando recebida, com a apresentação das instruções ao pagador.  Os caracteres permitidos no contexto do Pix para o campo txid (EMV 62-05) são:Letras minúsculas, de 'a' a 'z' Letras maiúsculas, de 'A' a 'z' Dígitos decimais, de '0' a '9'.   # noqa: E501

        :param transaction_identification: The transaction_identification of this ResponseRecurringPaymentsDataRead.  # noqa: E501
        :type: str
        """
    ...
    @property
    def document(self):
        """Gets the document of this ResponseRecurringPaymentsDataRead.  # noqa: E501


        :return: The document of this ResponseRecurringPaymentsDataRead.  # noqa: E501
    ...
    def document(self, document):
        """Sets the document of this ResponseRecurringPaymentsDataRead.


        :param document: The document of this ResponseRecurringPaymentsDataRead.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseRecurringPaymentsDataRead, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseRecurringPaymentsDataRead):
            return False
