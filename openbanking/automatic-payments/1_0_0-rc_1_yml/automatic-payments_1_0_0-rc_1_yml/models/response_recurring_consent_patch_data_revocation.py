...
class ResponseRecurringConsentPatchDataRevocation(object):
    ...
    def __init__(self, revoked_by=None, revoked_from=None, revoked_at=None, reason=None):  # noqa: E501
        """ResponseRecurringConsentPatchDataRevocation - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def revoked_by(self):
        """Gets the revoked_by of this ResponseRecurringConsentPatchDataRevocation.  # noqa: E501

        Quem iniciou a solicitação de revogação   - INICIADORA - USUARIO - DETENTORA   # noqa: E501

        :return: The revoked_by of this ResponseRecurringConsentPatchDataRevocation.  # noqa: E501
        :rtype: str
        """
    ...
    def revoked_by(self, revoked_by):
        """Sets the revoked_by of this ResponseRecurringConsentPatchDataRevocation.

        Quem iniciou a solicitação de revogação   - INICIADORA - USUARIO - DETENTORA   # noqa: E501

        :param revoked_by: The revoked_by of this ResponseRecurringConsentPatchDataRevocation.  # noqa: E501
        :type: str
        """
    ...
    def revoked_from(self):
        """Gets the revoked_from of this ResponseRecurringConsentPatchDataRevocation.  # noqa: E501

        Canal onde iniciou-se o processo de revogação    - INICIADORA   - DETENTORA     # noqa: E501

        :return: The revoked_from of this ResponseRecurringConsentPatchDataRevocation.  # noqa: E501
        :rtype: str
        """
    ...
    def revoked_from(self, revoked_from):
        """Sets the revoked_from of this ResponseRecurringConsentPatchDataRevocation.

        Canal onde iniciou-se o processo de revogação    - INICIADORA   - DETENTORA     # noqa: E501

        :param revoked_from: The revoked_from of this ResponseRecurringConsentPatchDataRevocation.  # noqa: E501
        :type: str
        """
    ...
    @property
    def revoked_at(self):
        """Gets the revoked_at of this ResponseRecurringConsentPatchDataRevocation.  # noqa: E501

        Data e hora em que o consentimento foi revogado  # noqa: E501

        :return: The revoked_at of this ResponseRecurringConsentPatchDataRevocation.  # noqa: E501
        :rtype: datetime
        """
    ...
    def revoked_at(self, revoked_at):
        """Sets the revoked_at of this ResponseRecurringConsentPatchDataRevocation.

        Data e hora em que o consentimento foi revogado  # noqa: E501

        :param revoked_at: The revoked_at of this ResponseRecurringConsentPatchDataRevocation.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def reason(self):
        """Gets the reason of this ResponseRecurringConsentPatchDataRevocation.  # noqa: E501


        :return: The reason of this ResponseRecurringConsentPatchDataRevocation.  # noqa: E501
    ...
    def reason(self, reason):
        """Sets the reason of this ResponseRecurringConsentPatchDataRevocation.


        :param reason: The reason of this ResponseRecurringConsentPatchDataRevocation.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseRecurringConsentPatchDataRevocation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseRecurringConsentPatchDataRevocation):
            return False
