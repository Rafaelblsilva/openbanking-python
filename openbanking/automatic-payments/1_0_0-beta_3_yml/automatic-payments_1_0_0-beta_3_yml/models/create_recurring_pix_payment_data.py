...
class CreateRecurringPixPaymentData(object):
    ...
    def __init__(self, recurring_consent_id=None, end_to_end_id=None, _date=None, payment=None, creditor_account=None, remittance_information=None, cnpj_initiator=None, ibge_town_code=None, authorisation_flow=None, risk_signals=None, local_instrument=None, proxy=None, transaction_identification=None):  # noqa: E501
