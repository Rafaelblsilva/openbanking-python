...
class ConsentsDebtorAccount(object):
    ...
    swagger_types = {
        ...
        'issuer': 'str',
        'number': 'str',
        'account_type': 'EnumAccountTypeConsents',
        'ibge_town_code': 'str',
    ...
    def __init__(self, ispb=None, issuer=None, number=None, account_type=None, ibge_town_code=None, overdraft_limit=None):  # noqa: E501
        """ConsentsDebtorAccount - a model defined in Swagger"""  # noqa: E501
        self._ispb = None
        self._issuer = None
        self._number = None
    ...
    @property
    def ispb(self):
        """Gets the ispb of this ConsentsDebtorAccount.  # noqa: E501
        ...
        :return: The ispb of this ConsentsDebtorAccount.  # noqa: E501
        :rtype: str
        """
        return self._ispb
    ...
    @ispb.setter
    def ispb(self, ispb):
        """Sets the ispb of this ConsentsDebtorAccount.

        Deve ser preenchido com o ISPB (Identificador do Sistema de Pagamentos Brasileiros) do participante do SPI (Sistema de pagamentos instantâneos) somente com números.   # noqa: E501

        :param ispb: The ispb of this ConsentsDebtorAccount.  # noqa: E501
        :type: str
        """
        if ispb is None:
    ...
    @property
    def issuer(self):
        """Gets the issuer of this ConsentsDebtorAccount.  # noqa: E501
        ...
        :return: The issuer of this ConsentsDebtorAccount.  # noqa: E501
        :rtype: str
        """
        return self._issuer
    ...
    def issuer(self, issuer):
        """Sets the issuer of this ConsentsDebtorAccount.

        Código da Agência emissora da conta sem dígito.  (Agência é a dependência destinada ao atendimento aos clientes, ao público em geral e aos associados de cooperativas de crédito,  no exercício de atividades da instituição, não podendo ser móvel ou transitória).  [Restrição] Preenchimento obrigatório para os seguintes tipos de conta: CACC (CONTA_DEPOSITO_A_VISTA) e SVGS (CONTA_POUPANCA).   # noqa: E501

        :param issuer: The issuer of this ConsentsDebtorAccount.  # noqa: E501
        :type: str
        """
        if issuer is None:
    ...
    @property
    def number(self):
        """Gets the number of this ConsentsDebtorAccount.  # noqa: E501
        ...
        :return: The number of this ConsentsDebtorAccount.  # noqa: E501
        :rtype: str
        """
        return self._number
    ...
    def number(self, number):
        """Sets the number of this ConsentsDebtorAccount.

        Deve ser preenchido com o número da conta transacional do usuário pagador, com dígito verificador (se este existir), se houver valor alfanumérico, este deve ser convertido para 0.   # noqa: E501

        :param number: The number of this ConsentsDebtorAccount.  # noqa: E501
        :type: str
        """
        if number is None:
    ...
    def account_type(self):
        """Gets the account_type of this ConsentsDebtorAccount.  # noqa: E501


        :return: The account_type of this ConsentsDebtorAccount.  # noqa: E501
        :rtype: EnumAccountTypeConsents
        """
        return self._account_type

    @account_type.setter
    def account_type(self, account_type):
        """Sets the account_type of this ConsentsDebtorAccount.


        :param account_type: The account_type of this ConsentsDebtorAccount.  # noqa: E501
        :type: EnumAccountTypeConsents
        """
    ...
    def ibge_town_code(self):
        """Gets the ibge_town_code of this ConsentsDebtorAccount.  # noqa: E501
        ...
        :return: The ibge_town_code of this ConsentsDebtorAccount.  # noqa: E501
        :rtype: str
        """
    ...
    def ibge_town_code(self, ibge_town_code):
        """Sets the ibge_town_code of this ConsentsDebtorAccount.

        O campo ibgeTownCode no arranjo Pix, tem o mesmo comportamento que o campo codMun descrito no item 1.6.6 do manual do Pix, conforme segue: 1. Caso a informação referente ao município não seja enviada, o PSP do recebedor assumirá que não existem feriados estaduais e municipais no período em questão;   # noqa: E501

        :param ibge_town_code: The ibge_town_code of this ConsentsDebtorAccount.  # noqa: E501
        :type: str
        """
    ...
    def overdraft_limit(self):
        """Gets the overdraft_limit of this ConsentsDebtorAccount.  # noqa: E501

        Indica se o usuário pagador autorizou a utilização de limite na sua conta para realização de pagamentos  # noqa: E501

        :return: The overdraft_limit of this ConsentsDebtorAccount.  # noqa: E501
        :rtype: bool
        """
    ...
    def overdraft_limit(self, overdraft_limit):
        """Sets the overdraft_limit of this ConsentsDebtorAccount.

        Indica se o usuário pagador autorizou a utilização de limite na sua conta para realização de pagamentos  # noqa: E501

        :param overdraft_limit: The overdraft_limit of this ConsentsDebtorAccount.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConsentsDebtorAccount, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConsentsDebtorAccount):
            return False
