...
class RecurringConfiguration(object):
    ...
    """
    swagger_types = {
        'recurring_configuration': 'OneOfRecurringConfigurationRecurringConfiguration'
    }
    ...
    def __init__(self, recurring_configuration=None):  # noqa: E501
        """RecurringConfiguration - a model defined in Swagger"""  # noqa: E501
        self._recurring_configuration = None
        self.discriminator = None
        if recurring_configuration is not None:
            self.recurring_configuration = recurring_configuration

    @property
    def recurring_configuration(self):
        """Gets the recurring_configuration of this RecurringConfiguration.  # noqa: E501


        :return: The recurring_configuration of this RecurringConfiguration.  # noqa: E501
        :rtype: OneOfRecurringConfigurationRecurringConfiguration
        """
    ...
    def recurring_configuration(self, recurring_configuration):
        """Sets the recurring_configuration of this RecurringConfiguration.


        :param recurring_configuration: The recurring_configuration of this RecurringConfiguration.  # noqa: E501
        :type: OneOfRecurringConfigurationRecurringConfiguration
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RecurringConfiguration, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecurringConfiguration):
            return False
