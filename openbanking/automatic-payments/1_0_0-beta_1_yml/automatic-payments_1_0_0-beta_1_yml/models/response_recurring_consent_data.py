...
class ResponseRecurringConsentData(object):
    ...
    swagger_types = {
        ...
        'rejection': 'Rejection',
        'revocation': 'ResponseRecurringConsentDataRevocation',
    ...
    def revocation(self):
        ...
        :rtype: ResponseRecurringConsentDataRevocation
        """
    ...
    def revocation(self, revocation):
        ...
        :type: ResponseRecurringConsentDataRevocation
        """
    ...
    def ibge_town_code(self):
        """Gets the ibge_town_code of this ResponseRecurringConsentData.  # noqa: E501
        ...
        :return: The ibge_town_code of this ResponseRecurringConsentData.  # noqa: E501
        :rtype: str
        """
    ...
    def ibge_town_code(self, ibge_town_code):
        """Sets the ibge_town_code of this ResponseRecurringConsentData.

        Campo utilizado pela iniciadora para cálculo do dia útil de liquidação do pagamento (vide especificação do endToEndId) baseado no munícipio de cadastro do usuário pagador no detentor.  [Restrições] - Campo obrigatório que deverá ser retornado quando o consentimento estiver ou passar pelo status AUTHORISED; - Campo obrigatório quando o oneOf utilizado do recurringConfiguration for “automatic”.   # noqa: E501

        :param ibge_town_code: The ibge_town_code of this ResponseRecurringConsentData.  # noqa: E501
        :type: str
        """
