...
class ResponseRecurringPixDataInner(object):
    ...
    def __init__(self, recurring_payment_id=None, recurring_consent_id=None, end_to_end_id=None, _date=None, creation_date_time=None, status_update_date_time=None, status=None, rejection_reason=None, payment=None, remittance_information=None, transaction_identification=None):  # noqa: E501
