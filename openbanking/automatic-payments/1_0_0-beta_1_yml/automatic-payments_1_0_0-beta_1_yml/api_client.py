...
from automatic-payments_1_0_0-beta_1_yml.configuration import Configuration
import automatic-payments_1_0_0-beta_1_yml.models
from automatic-payments_1_0_0-beta_1_yml import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(automatic-payments_1_0_0-beta_1_yml.models, klass)
