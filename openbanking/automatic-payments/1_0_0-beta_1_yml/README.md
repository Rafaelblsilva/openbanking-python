# automatic-payments-1-0-0-beta-1-yml
...
api_instance = automatic-payments_1_0_0-beta_1_yml.RecurringConsentsApi(automatic-payments_1_0_0-beta_1_yml.ApiClient(configuration))
...
# create an instance of the API class
api_instance = automatic-payments_1_0_0-beta_1_yml.RecurringConsentsApi(automatic-payments_1_0_0-beta_1_yml.ApiClient(configuration))
body = automatic-payments_1_0_0-beta_1_yml.PatchRecurringConsent() # PatchRecurringConsent | Payload para criação do consentimento para iniciação do pagamento.
authorization = 'authorization_example' # str | Cabeçalho HTTP padrão. Permite que as credenciais sejam fornecidas dependendo do tipo de recurso solicitado
x_fapi_interaction_id = 'x_fapi_interaction_id_example' # str | Um UUID [RFC4122](https://tools.ietf.org/html/rfc4122) usado como um ID de correlação. A detentora deve obrigatoriamente retornar o campo com o mesmo valor recebido da iniciadora.
...
# create an instance of the API class
api_instance = automatic-payments_1_0_0-beta_1_yml.RecurringConsentsApi(automatic-payments_1_0_0-beta_1_yml.ApiClient(configuration))
body = automatic-payments_1_0_0-beta_1_yml.CreateRecurringConsent() # CreateRecurringConsent | Payload para criação do consentimento para iniciação do pagamento.
authorization = 'authorization_example' # str | Cabeçalho HTTP padrão. Permite que as credenciais sejam fornecidas dependendo do tipo de recurso solicitado
x_fapi_interaction_id = 'x_fapi_interaction_id_example' # str | Um UUID [RFC4122](https://tools.ietf.org/html/rfc4122) usado como um ID de correlação. A detentora deve obrigatoriamente retornar o campo com o mesmo valor recebido da iniciadora.
x_idempotency_key = 'x_idempotency_key_example' # str | Cabeçalho HTTP personalizado. Identificador de solicitação exclusivo para suportar a idempotência.
x_customer_user_agent = 'x_customer_user_agent_example' # str | Indica o user-agent que o usuário utiliza. (optional)
...
## Documentation For Models
 ...
 - [OneOfRecurringConfigurationRecurringConfiguration](docs/OneOfRecurringConfigurationRecurringConfiguration.md)
 ...
 - [ResponseRecurringConsentDataRevocation](docs/ResponseRecurringConsentDataRevocation.md)
 - [ResponseRecurringConsentDataRevocationReason](docs/ResponseRecurringConsentDataRevocationReason.md)
 ...
 - [RiskSignalsAutomatic](docs/RiskSignalsAutomatic.md)
 - [RiskSignalsManual](docs/RiskSignalsManual.md)
 - [RiskSignalsManualGeolocation](docs/RiskSignalsManualGeolocation.md)
 - [RiskSignalsManualIntegrity](docs/RiskSignalsManualIntegrity.md)
 - [RiskSignalsManualScreenDimensions](docs/RiskSignalsManualScreenDimensions.md)
