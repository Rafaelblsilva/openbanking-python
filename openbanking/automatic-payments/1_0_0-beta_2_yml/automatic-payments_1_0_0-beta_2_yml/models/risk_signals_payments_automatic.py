...
class RiskSignalsPaymentsAutomatic(object):
    ...
    def pix_key_registration_date_time(self):
        ...
        Data e hora de cadastro da chave Pix do recebedor na iniciadora  # noqa: E501
    ...
    def pix_key_registration_date_time(self, pix_key_registration_date_time):
        ...
        :type: datetime
        """
        if pix_key_registration_date_time is None:
            raise ValueError("Invalid value for `pix_key_registration_date_time`, must not be `None`")  # noqa: E501
