...
class ResponseRecurringConsentData(object):
    ...
    def __init__(self, recurring_consent_id=None, status_update_date_time=None, logged_user=None, business_entity=None, status=None, creditors=None, start_date_time=None, creation_date_time=None, expiration_date_time=None, additional_information=None, debtor_account=None, rejection=None, revocation=None, recurring_configuration=None, ibge_town_code=None, risk_signals=None):  # noqa: E501
