...
class BankFixedIncomesProductMovement(object):
    ...
    def type_additional_info(self):
        """Gets the type_additional_info of this BankFixedIncomesProductMovement.  # noqa: E501
        ...
        :return: The type_additional_info of this BankFixedIncomesProductMovement.  # noqa: E501
        :rtype: str
        """
    ...
    def type_additional_info(self, type_additional_info):
        """Sets the type_additional_info of this BankFixedIncomesProductMovement.

        Informação adicional do tipo de movimentação, para preenchimento no caso de movimentações não delimitadas no domínio.  [Restrição] Campo de preenchimento obrigatório pelas participantes quando houver 'Outros' no campo Motivo da movimentação.   # noqa: E501

        :param type_additional_info: The type_additional_info of this BankFixedIncomesProductMovement.  # noqa: E501
        :type: str
        """
