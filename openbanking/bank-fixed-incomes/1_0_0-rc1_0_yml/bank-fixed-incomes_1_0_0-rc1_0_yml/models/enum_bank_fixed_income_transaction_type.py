...
class EnumBankFixedIncomeTransactionType(object):
    ...
    PAGAMENTO_JUROS_AMORTIZACAO = "PAGAMENTO_JUROS_AMORTIZACAO"
    ...
    def __init__(self):  # noqa: E501
        """EnumBankFixedIncomeTransactionType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumBankFixedIncomeTransactionType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumBankFixedIncomeTransactionType):
            return False
