# bank-fixed-incomes_1_0_0-rc1_0_yml.TransactionsApi

All URIs are relative to *https://api.banco.com.br/open-banking/bank-fixed-incomes/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**bankt_fixed_incomes_get_investments_investment_id_transactions**](TransactionsApi.md#bankt_fixed_incomes_get_investments_investment_id_transactions) | **GET** /investments/{investmentId}/transactions | Obtém as movimentações históricas (últimos 12 meses) da operação de Fundos de Investimento identificada por investmentId.

# **bankt_fixed_incomes_get_investments_investment_id_transactions**
> ResponseBankFixedIncomesTransactions bankt_fixed_incomes_get_investments_investment_id_transactions(investment_id, authorization, x_fapi_interaction_id, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_customer_user_agent=x_customer_user_agent, page=page, page_size=page_size, pagination_key=pagination_key, from_transaction_date=from_transaction_date, to_transaction_date=to_transaction_date)
...
api_instance = bank-fixed-incomes_1_0_0-rc1_0_yml.TransactionsApi(bank-fixed-incomes_1_0_0-rc1_0_yml.ApiClient(configuration))
...
[**ResponseBankFixedIncomesTransactions**](ResponseBankFixedIncomesTransactions.md)
