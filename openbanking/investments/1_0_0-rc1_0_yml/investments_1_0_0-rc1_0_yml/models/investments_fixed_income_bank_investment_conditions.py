...
class InvestmentsFixedIncomeBankInvestmentConditions(object):
    ...
    swagger_types = {
        ...
        'expiration_period': 'InvestmentsFixedIncomeBankInvestmentConditionspropertiesgracePeriod',
        'grace_period': 'str'
    }
    ...
    def expiration_period(self):
        ...
        :rtype: InvestmentsFixedIncomeBankInvestmentConditionspropertiesgracePeriod
        """
    ...
    def expiration_period(self, expiration_period):
        ...
        :type: InvestmentsFixedIncomeBankInvestmentConditionspropertiesgracePeriod
        """
    ...
    def grace_period(self):
        ...
        Faixa de valores para prazos de vencimento e carência.    # noqa: E501
    ...
    def grace_period(self, grace_period):
        ...
        allowed_values = ["1_360", "361_1080", "1081+"]  # noqa: E501
        if grace_period not in allowed_values:
            raise ValueError(
                "Invalid value for `grace_period` ({0}), must be one of {1}"  # noqa: E501
                .format(grace_period, allowed_values)
            )
