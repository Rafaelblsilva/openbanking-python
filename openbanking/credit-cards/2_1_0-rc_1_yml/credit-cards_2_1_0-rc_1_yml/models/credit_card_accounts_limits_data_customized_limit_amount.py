...
class CreditCardAccountsLimitsDataCustomizedLimitAmount(object):
    ...
    def __init__(self, amount=None, currency=None):  # noqa: E501
        """CreditCardAccountsLimitsDataCustomizedLimitAmount - a model defined in Swagger"""  # noqa: E501
        self._amount = None
        self._currency = None
    ...
    @property
    def amount(self):
        """Gets the amount of this CreditCardAccountsLimitsDataCustomizedLimitAmount.  # noqa: E501

        Valor total do limite informado expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais.   # noqa: E501

        :return: The amount of this CreditCardAccountsLimitsDataCustomizedLimitAmount.  # noqa: E501
        :rtype: str
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this CreditCardAccountsLimitsDataCustomizedLimitAmount.

        Valor total do limite informado expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais.   # noqa: E501

        :param amount: The amount of this CreditCardAccountsLimitsDataCustomizedLimitAmount.  # noqa: E501
        :type: str
        """
        if amount is None:
    ...
    @property
    def currency(self):
        """Gets the currency of this CreditCardAccountsLimitsDataCustomizedLimitAmount.  # noqa: E501

        Moeda referente ao limite informado, segundo modelo ISO-4217. p.ex. 'BRL.' Todos os limite informados estão representados com a moeda vigente do Brasil.   # noqa: E501

        :return: The currency of this CreditCardAccountsLimitsDataCustomizedLimitAmount.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this CreditCardAccountsLimitsDataCustomizedLimitAmount.

        Moeda referente ao limite informado, segundo modelo ISO-4217. p.ex. 'BRL.' Todos os limite informados estão representados com a moeda vigente do Brasil.   # noqa: E501

        :param currency: The currency of this CreditCardAccountsLimitsDataCustomizedLimitAmount.  # noqa: E501
        :type: str
        """
        if currency is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreditCardAccountsLimitsDataCustomizedLimitAmount, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreditCardAccountsLimitsDataCustomizedLimitAmount):
            return False
