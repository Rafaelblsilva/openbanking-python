...
class CreditCardAccountsTransaction(object):
    ...
    def __init__(self, transaction_id=None, identification_number=None, line_name=None, transaction_name=None, bill_id=None, credit_debit_type=None, transaction_type=None, transactional_additional_info=None, payment_type=None, fee_type=None, fee_type_additional_info=None, other_credits_type=None, other_credits_additional_info=None, charge_identificator=None, charge_number=None, brazilian_amount=None, amount=None, currency=None, transaction_date=None, bill_post_date=None, payee_mcc=None):  # noqa: E501
    ...
    @property
    def line_name(self):
        """Gets the line_name of this CreditCardAccountsTransaction.  # noqa: E501


        :return: The line_name of this CreditCardAccountsTransaction.  # noqa: E501
    ...
    def line_name(self, line_name):
        """Sets the line_name of this CreditCardAccountsTransaction.


        :param line_name: The line_name of this CreditCardAccountsTransaction.  # noqa: E501
    ...
    def transactional_additional_info(self, transactional_additional_info):
        ...
        :type: str
        """
        if transactional_additional_info is None:
            raise ValueError("Invalid value for `transactional_additional_info`, must not be `None`")  # noqa: E501
    ...
    def fee_type_additional_info(self, fee_type_additional_info):
        ...
        :type: str
        """
        if fee_type_additional_info is None:
            raise ValueError("Invalid value for `fee_type_additional_info`, must not be `None`")  # noqa: E501
    ...
    def other_credits_type(self, other_credits_type):
        ...
        """
        if other_credits_type is None:
            raise ValueError("Invalid value for `other_credits_type`, must not be `None`")  # noqa: E501
    ...
    def other_credits_additional_info(self):
        ...
        Campo livre, de preenchimento obrigatório quando selecionado tipo de crédito \"OUTROS\"  # noqa: E501
    ...
    def other_credits_additional_info(self, other_credits_additional_info):
        ...
        :type: str
        """
        if other_credits_additional_info is None:
            raise ValueError("Invalid value for `other_credits_additional_info`, must not be `None`")  # noqa: E501
    ...
    def charge_number(self):
        ...
        Quantidade de parcelas  # noqa: E501
    ...
    def charge_number(self, charge_number):
        ...
        if charge_number is None:
            raise ValueError("Invalid value for `charge_number`, must not be `None`")  # noqa: E501
    ...
    def brazilian_amount(self):
        ...
        Valor da transação expresso em valor monetário com 4 casas decimais, em moeda corrente do Brasil  # noqa: E501
    ...
    def amount(self):
        ...
        Valor da transação efetuada no exterior e convertida em moeda nacional com 4 casas decimais. Expresso em valor monetário com 4 casas decimais  # noqa: E501
    ...
    @property
    def currency(self):
        """Gets the currency of this CreditCardAccountsTransaction.  # noqa: E501

        Moeda referente ao valor da transação, se a operação foi efetuada em moeda  estrangeira, segundo modelo ISO-4217. Todos os valores informados estão representados com a moeda vigente do Brasil   # noqa: E501

        :return: The currency of this CreditCardAccountsTransaction.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this CreditCardAccountsTransaction.

        Moeda referente ao valor da transação, se a operação foi efetuada em moeda  estrangeira, segundo modelo ISO-4217. Todos os valores informados estão representados com a moeda vigente do Brasil   # noqa: E501

        :param currency: The currency of this CreditCardAccountsTransaction.  # noqa: E501
        :type: str
        """
        if currency is None:
    ...
    def payee_mcc(self, payee_mcc):
        ...
        :type: float
        """
        if payee_mcc is None:
            raise ValueError("Invalid value for `payee_mcc`, must not be `None`")  # noqa: E501
