...
class CreditCardApi(object):
    ...
    def credit_cards_get_accounts_credit_card_account_id_bills(self, authorization, credit_card_account_id, **kwargs):  # noqa: E501
        ...
        Método para obter a lista de faturas da conta de pagamento pós-paga identificada por creditCardAccountId mantida pelo cliente na instituição transmissora.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def credit_cards_get_accounts_credit_card_account_id_bills_with_http_info(self, authorization, credit_card_account_id, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'credit_card_account_id', 'x_fapi_auth_date', 'x_fapi_customer_ip_address', 'x_fapi_interaction_id', 'x_customer_user_agent', 'page', 'page_size', 'from_due_date', 'to_due_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def credit_cards_get_accounts_credit_card_account_id_bills_bill_id_transactions(self, authorization, credit_card_account_id, bill_id, **kwargs):  # noqa: E501
        ...
        Método para obter a lista de transações da conta de pagamento pós-paga identificada por creditCardAccountId e billId mantida pelo cliente na instituição transmissora.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param int page: Número da página que está sendo requisitada (o valor da primeira página é 1).
        :param int page_size: Quantidade total de registros por páginas.
        :param date from_transaction_date: Data inicial de filtragem.
        :param date to_transaction_date: Data final de filtragem.
    ...
    def credit_cards_get_accounts_credit_card_account_id_bills_bill_id_transactions_with_http_info(self, authorization, credit_card_account_id, bill_id, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'credit_card_account_id', 'bill_id', 'x_fapi_auth_date', 'x_fapi_customer_ip_address', 'x_fapi_interaction_id', 'x_customer_user_agent', 'page', 'page_size', 'from_transaction_date', 'to_transaction_date', 'transaction_type', 'payee_mcc']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def credit_cards_get_accounts_credit_card_account_id_transactions(self, authorization, credit_card_account_id, **kwargs):  # noqa: E501
        ...
        Método para obter a lista de transações da conta de pagamento pós-paga identificada por creditCardAccountId mantida pelo cliente na instituição transmissora.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def credit_cards_get_accounts_credit_card_account_id_transactions_with_http_info(self, authorization, credit_card_account_id, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'credit_card_account_id', 'x_fapi_auth_date', 'x_fapi_customer_ip_address', 'x_fapi_interaction_id', 'x_customer_user_agent', 'page', 'page_size', 'from_transaction_date', 'to_transaction_date', 'transaction_type', 'payee_mcc']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
