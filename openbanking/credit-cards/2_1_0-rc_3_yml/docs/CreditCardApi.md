# credit-cards_2_1_0-rc_3_yml.CreditCardApi
...
import time
import credit-cards_2_1_0-rc_3_yml
from credit-cards_2_1_0-rc_3_yml.rest import ApiException
from pprint import pprint

# Configure OAuth2 access token for authorization: OAuth2Security
configuration = credit-cards_2_1_0-rc_3_yml.Configuration()
configuration.access_token = 'YOUR_ACCESS_TOKEN'

# create an instance of the API class
api_instance = credit-cards_2_1_0-rc_3_yml.CreditCardApi(credit-cards_2_1_0-rc_3_yml.ApiClient(configuration))
...
transaction_type = credit-cards_2_1_0-rc_3_yml.EnumCreditCardTransactionType() # EnumCreditCardTransactionType | Traz os tipos de Transação (optional)
