...
*CreditCardApi* | [**credit_cards_get_accounts_credit_card_account_id_transactions_current**](docs/CreditCardApi.md#credit_cards_get_accounts_credit_card_account_id_transactions_current) | **GET** /accounts/{creditCardAccountId}/transactions-current | Obtém a lista de transações da conta identificada por creditCardAccountId.
