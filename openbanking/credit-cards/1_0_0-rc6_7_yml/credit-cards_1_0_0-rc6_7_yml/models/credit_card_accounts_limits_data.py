...
class CreditCardAccountsLimitsData(object):
    ...
    swagger_types = {
        ...
        'line_name': 'EnumCreditCardAccountsLineName',
    ...
    attribute_map = {
        ...
        'limit_amount_currency': 'limitAmountCurrency',
        'limit_amount': 'limitAmount',
        'used_amount_currency': 'usedAmountCurrency',
        'used_amount': 'usedAmount',
        'available_amount_currency': 'availableAmountCurrency',
        'available_amount': 'availableAmount'
    }

    def __init__(self, credit_line_limit_type=None, consolidation_type=None, identification_number=None, line_name=None, line_name_additional_info=None, is_limit_flexible=None, limit_amount_currency=None, limit_amount=None, used_amount_currency=None, used_amount=None, available_amount_currency=None, available_amount=None):  # noqa: E501
        ...
        self._limit_amount_currency = None
        self._limit_amount = None
        self._used_amount_currency = None
        ...
        self.limit_amount_currency = limit_amount_currency
        self.limit_amount = limit_amount
        self.used_amount_currency = used_amount_currency
    ...
    def identification_number(self):
        ...
        Número de identificação do cartão: corresponde aos 4 últimos dígitos do cartão para PF, ou então, preencher com um identificador para PJ, com as caracteristicas definidas para os IDs no Open Banking.   # noqa: E501
    ...
    def line_name(self):
        ...
        :rtype: EnumCreditCardAccountsLineName
        """
    ...
    @property
    def limit_amount_currency(self):
        """Gets the limit_amount_currency of this CreditCardAccountsLimitsData.  # noqa: E501

        Moeda referente ao limite informado, segundo modelo ISO-4217. p.ex. 'BRL.' Todos os limite informados estão representados com a moeda vigente do do Brasil.   # noqa: E501

        :return: The limit_amount_currency of this CreditCardAccountsLimitsData.  # noqa: E501
        :rtype: str
        """
        return self._limit_amount_currency

    @limit_amount_currency.setter
    def limit_amount_currency(self, limit_amount_currency):
        """Sets the limit_amount_currency of this CreditCardAccountsLimitsData.

        Moeda referente ao limite informado, segundo modelo ISO-4217. p.ex. 'BRL.' Todos os limite informados estão representados com a moeda vigente do do Brasil.   # noqa: E501

        :param limit_amount_currency: The limit_amount_currency of this CreditCardAccountsLimitsData.  # noqa: E501
        :type: str
        """
        if limit_amount_currency is None:
            raise ValueError("Invalid value for `limit_amount_currency`, must not be `None`")  # noqa: E501

        self._limit_amount_currency = limit_amount_currency

    @property
    def limit_amount(self):
        """Gets the limit_amount of this CreditCardAccountsLimitsData.  # noqa: E501

        Valor total do limite informado Expresso em valor monetário com 4 casas decimais.  # noqa: E501
    ...
    def limit_amount(self, limit_amount):
        ...
        if limit_amount is None:
            raise ValueError("Invalid value for `limit_amount`, must not be `None`")  # noqa: E501

        self._limit_amount = limit_amount

    @property
    def used_amount_currency(self):
        """Gets the used_amount_currency of this CreditCardAccountsLimitsData.  # noqa: E501

        Moeda referente ao limite informado, segundo modelo ISO-4217. p.ex. 'BRL.' Todos os saldos informados estão representados com a moeda vigente do Brasil.   # noqa: E501

        :return: The used_amount_currency of this CreditCardAccountsLimitsData.  # noqa: E501
        :rtype: str
        """
        return self._used_amount_currency

    @used_amount_currency.setter
    def used_amount_currency(self, used_amount_currency):
        """Sets the used_amount_currency of this CreditCardAccountsLimitsData.

        Moeda referente ao limite informado, segundo modelo ISO-4217. p.ex. 'BRL.' Todos os saldos informados estão representados com a moeda vigente do Brasil.   # noqa: E501

        :param used_amount_currency: The used_amount_currency of this CreditCardAccountsLimitsData.  # noqa: E501
        :type: str
        """
        if used_amount_currency is None:
            raise ValueError("Invalid value for `used_amount_currency`, must not be `None`")  # noqa: E501

        self._used_amount_currency = used_amount_currency

    @property
    def used_amount(self):
        """Gets the used_amount of this CreditCardAccountsLimitsData.  # noqa: E501

        Valor utilizado do limite informado Expresso em valor monetário com 4 casas decimais.  # noqa: E501
    ...
    def available_amount_currency(self):
        """Gets the available_amount_currency of this CreditCardAccountsLimitsData.  # noqa: E501

        Moeda referente ao limite informado, segundo modelo ISO-4217. p.ex. 'BRL.' Todos os saldos informados estão representados com a moeda vigente do Brasil.   # noqa: E501

        :return: The available_amount_currency of this CreditCardAccountsLimitsData.  # noqa: E501
        :rtype: str
        """
    ...
    def available_amount_currency(self, available_amount_currency):
        """Sets the available_amount_currency of this CreditCardAccountsLimitsData.

        Moeda referente ao limite informado, segundo modelo ISO-4217. p.ex. 'BRL.' Todos os saldos informados estão representados com a moeda vigente do Brasil.   # noqa: E501

        :param available_amount_currency: The available_amount_currency of this CreditCardAccountsLimitsData.  # noqa: E501
        :type: str
        """
    ...
    def available_amount(self):
        ...
        Valor disponível do limite informado Expresso em valor monetário com 4 casas decimais.  # noqa: E501
