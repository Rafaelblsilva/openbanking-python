...
class ResponseCreditCardAccountsTransactions(object):
    ...
    """
    swagger_types = {
        'data': 'list[CreditCardAccountsTransaction]',
    ...
    def __init__(self, data=None, links=None, meta=None):  # noqa: E501
        """ResponseCreditCardAccountsTransactions - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
        self._meta = None
    ...
    @property
    def data(self):
        """Gets the data of this ResponseCreditCardAccountsTransactions.  # noqa: E501


        :return: The data of this ResponseCreditCardAccountsTransactions.  # noqa: E501
        :rtype: list[CreditCardAccountsTransaction]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ResponseCreditCardAccountsTransactions.


        :param data: The data of this ResponseCreditCardAccountsTransactions.  # noqa: E501
        :type: list[CreditCardAccountsTransaction]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this ResponseCreditCardAccountsTransactions.  # noqa: E501


        :return: The links of this ResponseCreditCardAccountsTransactions.  # noqa: E501
    ...
    def links(self, links):
        """Sets the links of this ResponseCreditCardAccountsTransactions.


        :param links: The links of this ResponseCreditCardAccountsTransactions.  # noqa: E501
    ...
    @property
    def meta(self):
        """Gets the meta of this ResponseCreditCardAccountsTransactions.  # noqa: E501


        :return: The meta of this ResponseCreditCardAccountsTransactions.  # noqa: E501
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this ResponseCreditCardAccountsTransactions.


        :param meta: The meta of this ResponseCreditCardAccountsTransactions.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseCreditCardAccountsTransactions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseCreditCardAccountsTransactions):
            return False
