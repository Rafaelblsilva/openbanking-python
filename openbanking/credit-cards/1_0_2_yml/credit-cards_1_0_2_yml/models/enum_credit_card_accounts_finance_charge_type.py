...
class EnumCreditCardAccountsFinanceChargeType(object):
    ...
    allowed enum values
    """
    JUROS_REMUNERATORIOS_ATRASO_PAGAMENTO_FATURA = "JUROS_REMUNERATORIOS_ATRASO_PAGAMENTO_FATURA"
    ...
    def __init__(self):  # noqa: E501
        """EnumCreditCardAccountsFinanceChargeType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumCreditCardAccountsFinanceChargeType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumCreditCardAccountsFinanceChargeType):
            return False
