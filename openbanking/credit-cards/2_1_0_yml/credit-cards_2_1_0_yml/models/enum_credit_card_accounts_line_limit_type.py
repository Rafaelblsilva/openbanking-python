...
class EnumCreditCardAccountsLineLimitType(object):
    ...
    MODALIDADE_OPERACAO = "LIMITE_CREDITO_MODALIDADE_OPERACAO"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """EnumCreditCardAccountsLineLimitType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumCreditCardAccountsLineLimitType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumCreditCardAccountsLineLimitType):
            return False
