...
class CreditCardsLimitAmount(object):
    ...
    def __init__(self, amount=None, currency=None, limit_amount_reason=None):  # noqa: E501
        """CreditCardsLimitAmount - a model defined in Swagger"""  # noqa: E501
        self._amount = None
        self._currency = None
        self._limit_amount_reason = None
        self.discriminator = None
        self.amount = amount
        self.currency = currency
        if limit_amount_reason is not None:
            self.limit_amount_reason = limit_amount_reason

    @property
    def amount(self):
        """Gets the amount of this CreditCardsLimitAmount.  # noqa: E501

        Valor total do limite informado expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais.  [Restrição] O campo é obrigatório caso isLimitFlexible for igual a false.   # noqa: E501

        :return: The amount of this CreditCardsLimitAmount.  # noqa: E501
        :rtype: str
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this CreditCardsLimitAmount.

        Valor total do limite informado expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais.  [Restrição] O campo é obrigatório caso isLimitFlexible for igual a false.   # noqa: E501

        :param amount: The amount of this CreditCardsLimitAmount.  # noqa: E501
        :type: str
        """
        if amount is None:
    ...
    @property
    def currency(self):
        """Gets the currency of this CreditCardsLimitAmount.  # noqa: E501

        Moeda referente ao limite informado, segundo modelo ISO-4217. p.ex. 'BRL.' Todos os limite informados estão representados com a moeda vigente do Brasil.  [Restrição] O campo é obrigatório caso isLimitFlexible for igual a false.   # noqa: E501

        :return: The currency of this CreditCardsLimitAmount.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this CreditCardsLimitAmount.

        Moeda referente ao limite informado, segundo modelo ISO-4217. p.ex. 'BRL.' Todos os limite informados estão representados com a moeda vigente do Brasil.  [Restrição] O campo é obrigatório caso isLimitFlexible for igual a false.   # noqa: E501

        :param currency: The currency of this CreditCardsLimitAmount.  # noqa: E501
        :type: str
        """
        if currency is None:
    ...
    @property
    def limit_amount_reason(self):
        """Gets the limit_amount_reason of this CreditCardsLimitAmount.  # noqa: E501

        Razão pela qual o valor total do limite informado está igual a zero.  [Restrição] Campo de preenchimento obrigatório quando limitAmount for igual a 0.00.   # noqa: E501

        :return: The limit_amount_reason of this CreditCardsLimitAmount.  # noqa: E501
        :rtype: str
        """
        return self._limit_amount_reason

    @limit_amount_reason.setter
    def limit_amount_reason(self, limit_amount_reason):
        """Sets the limit_amount_reason of this CreditCardsLimitAmount.

        Razão pela qual o valor total do limite informado está igual a zero.  [Restrição] Campo de preenchimento obrigatório quando limitAmount for igual a 0.00.   # noqa: E501

        :param limit_amount_reason: The limit_amount_reason of this CreditCardsLimitAmount.  # noqa: E501
        :type: str
        """

        self._limit_amount_reason = limit_amount_reason
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreditCardsLimitAmount, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreditCardsLimitAmount):
            return False
