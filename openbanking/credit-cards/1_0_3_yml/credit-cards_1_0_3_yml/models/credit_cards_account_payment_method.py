...
class CreditCardsAccountPaymentMethod(object):
    ...
    def identification_number(self):
        ...
        Número de identificação do cartão: corresponde aos 4 últimos dígitos do cartão para pessoa natural, ou então, preencher com um identificador para pessoa jurídica, com as características definidas para os IDs no Open Banking.   # noqa: E501
