...
class EnumContractAmortizationScheduled(object):
    ...
    PRICE = "PRICE"
    SAM = "SAM"
    SEM_SISTEMA_AMORTIZACAO = "SEM_SISTEMA_AMORTIZACAO"
    OUTROS = "OUTROS"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """EnumContractAmortizationScheduled - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumContractAmortizationScheduled, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumContractAmortizationScheduled):
            return False
