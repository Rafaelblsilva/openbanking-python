...
class LoansReleasesOverParcel(object):
    ...
    """
    swagger_types = {
        'fees': 'list[LoansFeeOverParcel]',
        'charges': 'list[LoansChargeOverParcel]'
    }
    ...
    def __init__(self, fees=None, charges=None):  # noqa: E501
        """LoansReleasesOverParcel - a model defined in Swagger"""  # noqa: E501
        self._fees = None
        self._charges = None
    ...
    @property
    def fees(self):
        """Gets the fees of this LoansReleasesOverParcel.  # noqa: E501

        Lista das tarifas que foram pagas fora da parcela, só para pagamento avulso.  # noqa: E501

        :return: The fees of this LoansReleasesOverParcel.  # noqa: E501
        :rtype: list[LoansFeeOverParcel]
        """
        return self._fees

    @fees.setter
    def fees(self, fees):
        """Sets the fees of this LoansReleasesOverParcel.

        Lista das tarifas que foram pagas fora da parcela, só para pagamento avulso.  # noqa: E501

        :param fees: The fees of this LoansReleasesOverParcel.  # noqa: E501
        :type: list[LoansFeeOverParcel]
        """
        if fees is None:
    ...
    @property
    def charges(self):
        """Gets the charges of this LoansReleasesOverParcel.  # noqa: E501

        Lista dos encargos que foram pagos fora da parcela.  # noqa: E501

        :return: The charges of this LoansReleasesOverParcel.  # noqa: E501
        :rtype: list[LoansChargeOverParcel]
        """
        return self._charges

    @charges.setter
    def charges(self, charges):
        """Sets the charges of this LoansReleasesOverParcel.

        Lista dos encargos que foram pagos fora da parcela.  # noqa: E501

        :param charges: The charges of this LoansReleasesOverParcel.  # noqa: E501
        :type: list[LoansChargeOverParcel]
        """
        if charges is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LoansReleasesOverParcel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoansReleasesOverParcel):
            return False
