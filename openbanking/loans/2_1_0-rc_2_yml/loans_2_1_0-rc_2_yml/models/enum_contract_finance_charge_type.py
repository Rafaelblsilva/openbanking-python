...
class EnumContractFinanceChargeType(object):
    ...
    allowed enum values
    """
    JUROS_REMUNERATORIOS_POR_ATRASO = "JUROS_REMUNERATORIOS_POR_ATRASO"
    MULTA_ATRASO_PAGAMENTO = "MULTA_ATRASO_PAGAMENTO"
    JUROS_MORA_ATRASO = "JUROS_MORA_ATRASO"
    IOF_CONTRATACAO = "IOF_CONTRATACAO"
    IOF_POR_ATRASO = "IOF_POR_ATRASO"
    SEM_ENCARGO = "SEM_ENCARGO"
    OUTROS = "OUTROS"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """EnumContractFinanceChargeType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumContractFinanceChargeType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumContractFinanceChargeType):
            return False
