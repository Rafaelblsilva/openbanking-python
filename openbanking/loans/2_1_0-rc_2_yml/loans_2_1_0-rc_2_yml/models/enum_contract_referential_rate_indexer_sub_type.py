...
class EnumContractReferentialRateIndexerSubType(object):
    ...
    allowed enum values
    """
    SEM_SUB_TIPO_INDEXADOR = "SEM_SUB_TIPO_INDEXADOR"
    ...
    def __init__(self):  # noqa: E501
        """EnumContractReferentialRateIndexerSubType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumContractReferentialRateIndexerSubType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumContractReferentialRateIndexerSubType):
            return False
