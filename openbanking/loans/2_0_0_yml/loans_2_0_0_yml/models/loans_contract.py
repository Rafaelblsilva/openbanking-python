...
class LoansContract(object):
    ...
    def disbursement_dates(self):
        """Gets the disbursement_dates of this LoansContract.  # noqa: E501

        Lista que traz as Datas de Desembolso do valor contratado.   # noqa: E501

        :return: The disbursement_dates of this LoansContract.  # noqa: E501
        :rtype: list[date]
        """
    ...
    def disbursement_dates(self, disbursement_dates):
        """Sets the disbursement_dates of this LoansContract.

        Lista que traz as Datas de Desembolso do valor contratado.   # noqa: E501

        :param disbursement_dates: The disbursement_dates of this LoansContract.  # noqa: E501
        :type: list[date]
        """
    ...
    def due_date(self):
        ...
        Data de vencimento Final da operação. Especificação RFC-3339. Informação deve ser enviada caso ela exista.   # noqa: E501
    ...
    def first_instalment_due_date(self):
        ...
        Data de vencimento primeira parcela do principal. Informação deve ser enviada caso ela exista.   # noqa: E501
    ...
    def cnpj_consignee(self):
        ...
        CNPJ do consignante (CNPJ corresponde ao número de inscrição no Cadastro de Pessoa Jurídica).   Deve-se ter apenas os números do CNPJ, sem máscara.   [Restrição] Informação adicional específica para quando o productSubType for igual a CREDITO_PESSOAL_COM_CONSIGNACAO   # noqa: E501
    ...
    def interest_rates(self):
        ...
        Objeto que traz o conjunto de informações necessárias para demonstrar a composição das taxas de juros remuneratórios da Modalidade de crédito.   # noqa: E501
    ...
    def contracted_fees(self):
        ...
        Lista que traz o conjunto de informações necessárias para demonstrar a composição das taxas de juros remuneratórios da Modalidade de crédito  # noqa: E501
