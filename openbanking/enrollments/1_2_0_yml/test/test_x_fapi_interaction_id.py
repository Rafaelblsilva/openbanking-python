...
from enrollments_1_2_0_yml.models.x_fapi_interaction_id import XFapiInteractionId  # noqa: E501
...
class TestXFapiInteractionId(unittest.TestCase):
    ...
    def testXFapiInteractionId(self):
        ...
        # model = enrollments_1_2_0_yml.models.x_fapi_interaction_id.XFapiInteractionId()  # noqa: E501
        pass
