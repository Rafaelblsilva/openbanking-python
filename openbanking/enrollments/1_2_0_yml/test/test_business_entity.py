...
from enrollments_1_2_0_yml.models.business_entity import BusinessEntity  # noqa: E501
...
class TestBusinessEntity(unittest.TestCase):
    ...
    def testBusinessEntity(self):
        ...
        # model = enrollments_1_2_0_yml.models.business_entity.BusinessEntity()  # noqa: E501
        pass
