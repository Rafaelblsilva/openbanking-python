...
from enrollments_1_2_0_yml.models.consent_authorization_data import ConsentAuthorizationData  # noqa: E501
...
class TestConsentAuthorizationData(unittest.TestCase):
    ...
    def testConsentAuthorizationData(self):
        ...
        # model = enrollments_1_2_0_yml.models.consent_authorization_data.ConsentAuthorizationData()  # noqa: E501
        pass
