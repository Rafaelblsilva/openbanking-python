...
from enrollments_1_0_0-beta_1_yml.models.response_error_errors import ResponseErrorErrors  # noqa: E501
...
class TestResponseErrorErrors(unittest.TestCase):
    ...
    def testResponseErrorErrors(self):
        ...
        # model = enrollments_1_0_0-beta_1_yml.models.response_error_errors.ResponseErrorErrors()  # noqa: E501
        pass
