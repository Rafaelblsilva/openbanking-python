...
from enrollments_1_0_0_yml.models.response_error import ResponseError  # noqa: E501
...
class TestResponseError(unittest.TestCase):
    ...
    def testResponseError(self):
        ...
        # model = enrollments_1_0_0_yml.models.response_error.ResponseError()  # noqa: E501
        pass
