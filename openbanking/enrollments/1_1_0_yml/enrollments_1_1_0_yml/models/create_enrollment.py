...
class CreateEnrollment(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """CreateEnrollment - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this CreateEnrollment.  # noqa: E501


        :return: The data of this CreateEnrollment.  # noqa: E501
        :rtype: CreateEnrollmentData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this CreateEnrollment.


        :param data: The data of this CreateEnrollment.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateEnrollment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateEnrollment):
            return False
