...
class EnumEnrollmentPermission(object):
    ...
    allowed enum values
    """
    PAYMENTS_INITIATE = "PAYMENTS_INITIATE"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """EnumEnrollmentPermission - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumEnrollmentPermission, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumEnrollmentPermission):
            return False
