...
class RiskSignals(object):
    ...
    @property
    def data(self):
        """Gets the data of this RiskSignals.  # noqa: E501


        :return: The data of this RiskSignals.  # noqa: E501
        :rtype: RiskSignalsData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this RiskSignals.


        :param data: The data of this RiskSignals.  # noqa: E501
