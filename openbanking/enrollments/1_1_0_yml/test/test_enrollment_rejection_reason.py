...
from enrollments_1_1_0_yml.models.enrollment_rejection_reason import EnrollmentRejectionReason  # noqa: E501
...
class TestEnrollmentRejectionReason(unittest.TestCase):
    ...
    def testEnrollmentRejectionReason(self):
        ...
        # model = enrollments_1_1_0_yml.models.enrollment_rejection_reason.EnrollmentRejectionReason()  # noqa: E501
        pass
