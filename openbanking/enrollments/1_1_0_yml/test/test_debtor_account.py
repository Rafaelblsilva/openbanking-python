...
from enrollments_1_1_0_yml.models.debtor_account import DebtorAccount  # noqa: E501
...
class TestDebtorAccount(unittest.TestCase):
    ...
    def testDebtorAccount(self):
        ...
        # model = enrollments_1_1_0_yml.models.debtor_account.DebtorAccount()  # noqa: E501
        pass
