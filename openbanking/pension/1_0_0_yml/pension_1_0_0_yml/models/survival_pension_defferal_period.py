...
class SurvivalPensionDefferalPeriod(object):
    ...
    def __init__(self, interest_rate=None, update_index=None, other_minimum_performance_garantees=None, reversal_financial_results=None, minimum_premiums=None, premium_payment_methods=None, permission_extraordinary_contributions=None, permission_scheduled_financial_payments=None, grace_period=None, redemption_payment_term=None, portability_payment_term=None, investment_funds=None):  # noqa: E501
        ...
        if premium_payment_methods is not None:
    ...
    def other_minimum_performance_garantees(self, other_minimum_performance_garantees):
        ...
        :type: str
        """
        if other_minimum_performance_garantees is None:
            raise ValueError("Invalid value for `other_minimum_performance_garantees`, must not be `None`")  # noqa: E501
    ...
    def reversal_financial_results(self, reversal_financial_results):
        ...
        :type: str
        """
        if reversal_financial_results is None:
            raise ValueError("Invalid value for `reversal_financial_results`, must not be `None`")  # noqa: E501
    ...
    def premium_payment_methods(self, premium_payment_methods):
        ...
        :type: list[str]
        """
        allowed_values = ["CARTAO_CREDITO", "DEBITO_CONTA", "DEBITO_CONTA_POUPANCA", "BOLETO_BANCARIO", "PIX", "CARTAO_DEBITO", "REGRA_PARCEIRO", "CONSIGNACAO_FOLHA_PAGAMENTO", "PONTOS_PROGRAMA_BENEFICIO", "TED_DOC", "OUTROS", "NA"]  # noqa: E501
    ...
    def redemption_payment_term(self, redemption_payment_term):
        ...
        :type: int
        """
        if redemption_payment_term is None:
            raise ValueError("Invalid value for `redemption_payment_term`, must not be `None`")  # noqa: E501
    ...
    def portability_payment_term(self, portability_payment_term):
        ...
        :type: float
        """
        if portability_payment_term is None:
            raise ValueError("Invalid value for `portability_payment_term`, must not be `None`")  # noqa: E501
