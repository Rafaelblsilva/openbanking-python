...
class SurvivalPensionDefferalPeriod(object):
    ...
    def permission_scheduled_financial_payments(self, permission_scheduled_financial_payments):
        ...
        :type: bool
        """
        if permission_scheduled_financial_payments is None:
            raise ValueError("Invalid value for `permission_scheduled_financial_payments`, must not be `None`")  # noqa: E501
