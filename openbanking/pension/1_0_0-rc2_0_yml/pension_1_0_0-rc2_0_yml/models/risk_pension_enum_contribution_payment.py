...
class RiskPensionEnumContributionPayment(object):
    ...
    def contribution_payment_method(self):
        ...
        Forma de pagamento da contribuição.  - CARTAO_CREDITO  - DEBITO_CONTA  - DEBITO_CONTA_POUPANCA  - BOLETO_BANCARIO  - PIX  - TED_DOC  - CONSIGNACAO_FOLHA_PAGAMENTO  - PONTOS_PROGRAMA_BENEFICIO  - OUTROS   # noqa: E501
    ...
    def contribution_payment_method(self, contribution_payment_method):
        ...
        allowed_values = ["CARTAO_CREDITO", "DEBITO_CONTA", "DEBITO_CONTA_POUPANCA", "BOLETO_BANCARIO", "PIX", "TED_DOC", "CONSIGNACAO_FOLHA_PAGAMENTO", "PONTOS_PROGRAMA_BENEFICIO", "OUTROS"]  # noqa: E501
    ...
    def contribution_periodicity(self):
        ...
        Periodicidade de pagamento da contribuição. - MENSAL - UNICA - ANUAL - TRIMESTRAL - SEMESTRAL - BIMESTRAL - OUTROS   # noqa: E501
    ...
    def contribution_periodicity(self, contribution_periodicity):
        ...
        allowed_values = ["MENSAL", "UNICA", "ANUAL", "TRIMESTRAL", "SEMESTRAL", "BIMESTRAL", "OUTROS"]  # noqa: E501
