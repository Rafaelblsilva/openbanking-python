...
class GetRiskPensionContractDataParticipant(object):
    ...
    def __init__(self, brand=None, name=None, cnpj_number=None, url_complementary_list=None):  # noqa: E501
        """GetRiskPensionContractDataParticipant - a model defined in Swagger"""  # noqa: E501
        self._brand = None
        self._name = None
    ...
    @property
    def brand(self):
        """Gets the brand of this GetRiskPensionContractDataParticipant.  # noqa: E501
        ...
        :return: The brand of this GetRiskPensionContractDataParticipant.  # noqa: E501
        :rtype: str
        """
        return self._brand
    ...
    def brand(self, brand):
        """Sets the brand of this GetRiskPensionContractDataParticipant.

        Nome da marca reportada pelo participante do Open Finance. O conceito a que se refere a 'marca' é em essência uma promessa da empresa em fornecer uma série específica de atributos, benefícios e serviços uniformes aos clientes.  # noqa: E501

        :param brand: The brand of this GetRiskPensionContractDataParticipant.  # noqa: E501
        :type: str
        """
        if brand is None:
    ...
    @property
    def name(self):
        """Gets the name of this GetRiskPensionContractDataParticipant.  # noqa: E501

        Nome do participante do Open Finance.  # noqa: E501

        :return: The name of this GetRiskPensionContractDataParticipant.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GetRiskPensionContractDataParticipant.

        Nome do participante do Open Finance.  # noqa: E501

        :param name: The name of this GetRiskPensionContractDataParticipant.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def cnpj_number(self):
        """Gets the cnpj_number of this GetRiskPensionContractDataParticipant.  # noqa: E501


        :return: The cnpj_number of this GetRiskPensionContractDataParticipant.  # noqa: E501
        :rtype: CnpjNumber
        """
    ...
    def cnpj_number(self, cnpj_number):
        """Sets the cnpj_number of this GetRiskPensionContractDataParticipant.


        :param cnpj_number: The cnpj_number of this GetRiskPensionContractDataParticipant.  # noqa: E501
        :type: CnpjNumber
        """
    ...
    def url_complementary_list(self):
        """Gets the url_complementary_list of this GetRiskPensionContractDataParticipant.  # noqa: E501
        ...
        :return: The url_complementary_list of this GetRiskPensionContractDataParticipant.  # noqa: E501
        :rtype: str
        """
    ...
    def url_complementary_list(self, url_complementary_list):
        """Sets the url_complementary_list of this GetRiskPensionContractDataParticipant.

        Espera-se que valor de retorno, após acesso ao link ‘urlComplementaryList’, deve ser array de objeto com a estrutura abaixo:  - ‘name’ com o valor contido no campo ‘LegalEntityName’ conforme cadastro no diretório;  - ‘cnpjNumber’ com o valor contido no campo CNPJ (‘RegistrationNumber’) correspondente a esta instituição;  - Ambos do tipo string;  - Ambos obrigatórios.   # noqa: E501

        :param url_complementary_list: The url_complementary_list of this GetRiskPensionContractDataParticipant.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetRiskPensionContractDataParticipant, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetRiskPensionContractDataParticipant):
            return False
