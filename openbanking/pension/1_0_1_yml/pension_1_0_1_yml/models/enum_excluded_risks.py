...
class EnumExcludedRisks(object):
    ...
    OPERACOES_GUERRA = "OPERACOES_GUERRA"
    ...
    def __init__(self):  # noqa: E501
        """EnumExcludedRisks - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumExcludedRisks, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumExcludedRisks):
            return False
