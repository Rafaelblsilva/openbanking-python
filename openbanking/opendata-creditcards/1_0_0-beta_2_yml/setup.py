...
NAME = "opendata-creditcards-1-0-0-beta-2-yml"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="API OpenData Credit Cards do Open Finance Brasil",
    author_email="",
    url="",
    keywords=["Swagger", "API OpenData Credit Cards do Open Finance Brasil"],
