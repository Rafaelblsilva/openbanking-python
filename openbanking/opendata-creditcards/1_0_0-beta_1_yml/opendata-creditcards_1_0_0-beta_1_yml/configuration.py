...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host = "http://api.banco.com.br/open-banking/opendata-creditcards/v1"
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("opendata-creditcards_1_0_0-beta_1_yml")
