...
class TreasureTitlesIndexerAdditionalInfo(object):
    ...
    def __init__(self):  # noqa: E501
        """TreasureTitlesIndexerAdditionalInfo - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TreasureTitlesIndexerAdditionalInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TreasureTitlesIndexerAdditionalInfo):
            return False
