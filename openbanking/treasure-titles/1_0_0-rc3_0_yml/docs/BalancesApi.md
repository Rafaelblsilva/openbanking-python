# treasure-titles_1_0_0-rc3_0_yml.BalancesApi

All URIs are relative to *https://api.banco.com.br/open-banking/treasure-titles/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**treasure_titles_get_investments_investment_id_balances**](BalancesApi.md#treasure_titles_get_investments_investment_id_balances) | **GET** /investments/{investmentId}/balances | Obtém a posição da operação de Títulos do Tesouro Direto identificada por investmentId.

# **treasure_titles_get_investments_investment_id_balances**
> ResponseTreasureTitlesBalances treasure_titles_get_investments_investment_id_balances(investment_id, authorization, x_fapi_interaction_id, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_customer_user_agent=x_customer_user_agent)
...
[**ResponseTreasureTitlesBalances**](ResponseTreasureTitlesBalances.md)
