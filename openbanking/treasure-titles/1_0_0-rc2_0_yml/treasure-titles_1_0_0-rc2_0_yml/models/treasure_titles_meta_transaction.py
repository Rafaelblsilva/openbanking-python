...
class TreasureTitlesMetaTransaction(object):
    ...
    def __init__(self, request_date_time=None):  # noqa: E501
        """TreasureTitlesMetaTransaction - a model defined in Swagger"""  # noqa: E501
    ...
    def request_date_time(self):
        """Gets the request_date_time of this TreasureTitlesMetaTransaction.  # noqa: E501

        Data e hora da consulta, conforme especificação RFC-3339, formato UTC.  # noqa: E501

        :return: The request_date_time of this TreasureTitlesMetaTransaction.  # noqa: E501
        :rtype: datetime
        """
    ...
    def request_date_time(self, request_date_time):
        """Sets the request_date_time of this TreasureTitlesMetaTransaction.

        Data e hora da consulta, conforme especificação RFC-3339, formato UTC.  # noqa: E501

        :param request_date_time: The request_date_time of this TreasureTitlesMetaTransaction.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TreasureTitlesMetaTransaction, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TreasureTitlesMetaTransaction):
            return False
