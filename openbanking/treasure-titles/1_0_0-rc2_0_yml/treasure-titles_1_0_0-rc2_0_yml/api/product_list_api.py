...
class ProductListApi(object):
    ...
    def treasure_titles_get_investments(self, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.treasure_titles_get_investments(authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: ResponseTreasureTitlesListProduct
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.treasure_titles_get_investments_with_http_info(authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
        else:
            (data) = self.treasure_titles_get_investments_with_http_info(authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
            return data

    def treasure_titles_get_investments_with_http_info(self, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        """Obtém a lista de operações de Títulos do Tesouro Direto mantidas pelo cliente na instituição transmissora e para as quais ele tenha fornecido consentimento.  # noqa: E501

        Obtém a lista de operações de Títulos do Tesouro Direto mantidas pelo cliente na instituição transmissora e para as quais ele tenha fornecido consentimento.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.treasure_titles_get_investments_with_http_info(authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method treasure_titles_get_investments" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('authorization' not in params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `treasure_titles_get_investments`")  # noqa: E501
        ...
        if ('x_fapi_interaction_id' not in params or
            ...
            raise ValueError("Missing the required parameter `x_fapi_interaction_id` when calling `treasure_titles_get_investments`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponseTreasureTitlesListProduct',  # noqa: E501
