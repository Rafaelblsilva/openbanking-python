...
class TransactionsApi(object):
    ...
    def treasure_titles_get_investments_investment_id_transactions(self, investment_id, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        """Obtém as movimentações da operação (últimos 12 meses) de Títulos do Tesouro Direto identificada por investmentId.  # noqa: E501

        Obtém as movimentações da operação (últimos 12 meses) de Títulos do Tesouro Direto identificada por investmentId.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.treasure_titles_get_investments_investment_id_transactions(investment_id, authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.treasure_titles_get_investments_investment_id_transactions_with_http_info(investment_id, authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
        else:
            (data) = self.treasure_titles_get_investments_investment_id_transactions_with_http_info(investment_id, authorization, x_fapi_interaction_id, **kwargs)  # noqa: E501
            return data

    def treasure_titles_get_investments_investment_id_transactions_with_http_info(self, investment_id, authorization, x_fapi_interaction_id, **kwargs):  # noqa: E501
        """Obtém as movimentações da operação (últimos 12 meses) de Títulos do Tesouro Direto identificada por investmentId.  # noqa: E501

        Obtém as movimentações da operação (últimos 12 meses) de Títulos do Tesouro Direto identificada por investmentId.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.treasure_titles_get_investments_investment_id_transactions_with_http_info(investment_id, authorization, x_fapi_interaction_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method treasure_titles_get_investments_investment_id_transactions" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('investment_id' not in params or
            ...
            raise ValueError("Missing the required parameter `investment_id` when calling `treasure_titles_get_investments_investment_id_transactions`")  # noqa: E501
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `treasure_titles_get_investments_investment_id_transactions`")  # noqa: E501
        ...
        if ('x_fapi_interaction_id' not in params or
            ...
            raise ValueError("Missing the required parameter `x_fapi_interaction_id` when calling `treasure_titles_get_investments_investment_id_transactions`")  # noqa: E501
