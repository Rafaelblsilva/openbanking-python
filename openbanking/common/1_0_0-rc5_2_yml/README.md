...
api_instance = common_1_0_0-rc5_2_yml.DiscoveryApi(common_1_0_0-rc5_2_yml.ApiClient(configuration))
...
------------ | ------------- | ------------- | -------------
*DiscoveryApi* | [**get_outage**](docs/DiscoveryApi.md#get_outage) | **GET** /outages | Obtêm a lista de indisponibilidade agendada para os serviços.
*DiscoveryApi* | [**get_status**](docs/DiscoveryApi.md#get_status) | **GET** /status | Obtem a descrição e detalhes referente aos códigos de status retornados pelas APIs.
