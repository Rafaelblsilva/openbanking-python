...
class DiscoveryApi(object):
    ...
    def get_outstage(self, **kwargs):  # noqa: E501
        """a descrição referente ao código de status retornado pelas APIs  # noqa: E501

        a descrição referente ao código de status retornado pelas APIs  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_outstage(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: ResponseDiscoveryOutstageList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_outstage_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_outstage_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_outstage_with_http_info(self, **kwargs):  # noqa: E501
        """a descrição referente ao código de status retornado pelas APIs  # noqa: E501

        a descrição referente ao código de status retornado pelas APIs  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_outstage_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponseDiscoveryOutstageList',  # noqa: E501
