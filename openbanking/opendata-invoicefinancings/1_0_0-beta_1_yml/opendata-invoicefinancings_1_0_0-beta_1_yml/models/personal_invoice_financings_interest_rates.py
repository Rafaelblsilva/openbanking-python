...
class PersonalInvoiceFinancingsInterestRates(object):
    ...
    def referential_rate_indexer(self):
        """Gets the referential_rate_indexer of this PersonalInvoiceFinancingsInterestRates.  # noqa: E501
        ...
        :return: The referential_rate_indexer of this PersonalInvoiceFinancingsInterestRates.  # noqa: E501
        :rtype: str
        """
    ...
    def referential_rate_indexer(self, referential_rate_indexer):
        """Sets the referential_rate_indexer of this PersonalInvoiceFinancingsInterestRates.

        Tipos de taxas referenciais ou indexadores, conforme Anexo 5: Taxa referencial ou Indexador (Indx), do Documento 3040  # noqa: E501

        :param referential_rate_indexer: The referential_rate_indexer of this PersonalInvoiceFinancingsInterestRates.  # noqa: E501
        :type: str
        """
    ...
    @property
    def rate(self):
        """Gets the rate of this PersonalInvoiceFinancingsInterestRates.  # noqa: E501
        ...
        :return: The rate of this PersonalInvoiceFinancingsInterestRates.  # noqa: E501
        :rtype: str
        """
        return self._rate
    ...
    @rate.setter
    def rate(self, rate):
        """Sets the rate of this PersonalInvoiceFinancingsInterestRates.

        Percentual que incide sobre a composição das taxas de juros remuneratórios. (representa uma porcentagem Ex: 0.15 (O valor ao lado representa 15%. O valor '1 'representa 100%) A apuração pode acontecer com até 4 casas decimais. O preenchimento deve respeitar as 4 casas decimais, mesmo que venham preenchidas com zeros (representação de porcentagem p.ex: 0.1500. Este valor representa 15%. O valor 1 representa 100%)   # noqa: E501

        :param rate: The rate of this PersonalInvoiceFinancingsInterestRates.  # noqa: E501
        :type: str
        """
        if rate is None:
